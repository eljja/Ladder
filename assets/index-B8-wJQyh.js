...
#define LOW_PRECISION`),t}function qf(r){let t="SHADOWMAP_TYPE_BASIC";return r.shadowMapType===Oo?t="SHADOWMAP_TYPE_PCF":r.shadowMapType===Il?t="SHADOWMAP_TYPE_PCF_SOFT":r.shadowMapType===nn&&(t="SHADOWMAP_TYPE_VSM"),t}function $f(r){let t="ENVMAP_TYPE_CUBE";if(r.envMap)switch(r.envMapMode){case ui:case di:t="ENVMAP_TYPE_CUBE";break;case Cr:t="ENVMAP_TYPE_CUBE_UV";break}return t}function Zf(r){let t="ENVMAP_MODE_REFLECTION";if(r.envMap)switch(r.envMapMode){case di:t="ENVMAP_MODE_REFRACTION";break}return t}function Kf(r){let t="ENVMAP_BLENDING_NONE";if(r.envMap)switch(r.combine){case Bo:t="ENVMAP_BLENDING_MULTIPLY";break;case jl:t="ENVMAP_BLENDING_MIX";break;case Ql:t="ENVMAP_BLENDING_ADD";break}return t}function Jf(r){const t=r.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),112)),texelHeight:n,maxMip:e}}function jf(r,t,e,n){const i=r.getContext(),s=e.defines;let a=e.vertexShader,o=e.fragmentShader;const l=qf(e),c=$f(e),h=Zf(e),u=Kf(e),d=Jf(e),m=zf(e),g=Gf(s),v=i.createProgram();let p,f,w=e.glslVersion?"#version "+e.glslVersion+`
...
//# sourceMappingURL=index-B8-wJQyh.js.map
