...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:gn,depthTest:!1,depthWrite:!1})}function Ja(){return new Mn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:ia(),fragmentShader:`
...
`].filter(Ai).join(`
`)),a=Xs(a),a=lo(a,e),a=co(a,e),o=Xs(o),o=lo(o,e),o=co(o,e),a=ho(a),o=ho(o),e.isRawShaderMaterial!==!0&&(A=`#version 300 es
...
//# sourceMappingURL=index-DAKiJPOb.js.map
