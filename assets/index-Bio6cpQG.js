...
`)+`
`+u);const E=b+f+o,S=b+u+a,O=oo(r,r.VERTEX_SHADER,E),R=oo(r,r.FRAGMENT_SHADER,S);r.attachShader(_,O),r.attachShader(_,R),e.index0AttributeName!==void 0?r.bindAttribLocation(_,0,e.index0AttributeName):e.morphTargets===!0&&r.bindAttribLocation(_,0,"position"),r.linkProgram(_);function w(L){if(i.debug.checkShaderErrors){const k=r.getProgramInfoLog(_).trim(),G=r.getShaderInfoLog(O).trim(),Z=r.getShaderInfoLog(R).trim();let J=!0,$=!0;if(r.getProgramParameter(_,r.LINK_STATUS)===!1)if(J=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(r,_,O,R);else{const et=co(r,O,"vertex"),W=co(r,R,"fragment");console.error("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(_,r.VALIDATE_STATUS)+`
...
//# sourceMappingURL=index-Bio6cpQG.js.map
