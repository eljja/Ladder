...
`)+`
`+f);const E=A+p+a,S=A+f+o,R=_o(i,i.VERTEX_SHADER,E),b=_o(i,i.FRAGMENT_SHADER,S);i.attachShader(v,R),i.attachShader(v,b),e.index0AttributeName!==void 0?i.bindAttribLocation(v,0,e.index0AttributeName):e.morphTargets===!0&&i.bindAttribLocation(v,0,"position"),i.linkProgram(v);function w(D){if(r.debug.checkShaderErrors){const k=i.getProgramInfoLog(v).trim(),V=i.getShaderInfoLog(R).trim(),K=i.getShaderInfoLog(b).trim();let j=!0,Z=!0;if(i.getProgramParameter(v,i.LINK_STATUS)===!1)if(j=!1,typeof r.debug.onShaderError=="function")r.debug.onShaderError(i,v,R,b);else{const nt=xo(i,R,"vertex"),W=xo(i,b,"fragment");console.error("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(v,i.VALIDATE_STATUS)+`
...
}`;function gp(r,t,e){let n=new pa;const i=new wt,s=new wt,a=new ae,o=new dp({depthPacking:lc}),l=new fp,c={},h=e.maxTextureSize,u={[Sn]:Ee,[Ee]:Sn,[Ge]:Ge},d=new yn({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new wt},radius:{value:4}},vertexShader:pp,fragmentShader:mp}),m=d.clone();m.defines.HORIZONTAL_PASS=1;const g=new we;g.setAttribute("position",new Me(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const v=new de(g,d),p=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Oo;let f=this.type;this.render=function(b,w,I){if(p.enabled===!1||p.autoUpdate===!1&&p.needsUpdate===!1||b.length===0)return;const y=r.getRenderTarget(),M=r.getActiveCubeFace(),D=r.getActiveMipmapLevel(),k=r.state;k.setBlending(vn),k.buffers.color.setClear(1,1,1,1),k.buffers.depth.setTest(!0),k.setScissorTest(!1);const V=f!==en&&this.type===en,K=f===en&&this.type!==en;for(let j=0,Z=b.length;j<Z;j++){const nt=b[j],W=nt.shadow;if(W===void 0){console.warn("THREE.WebGLShadowMap:",nt,"has no shadow.");continue}if(W.autoUpdate===!1&&W.needsUpdate===!1)continue;i.copy(W.mapSize);const ct=W.getFrameExtents();if(i.multiply(ct),s.copy(W.mapSize),(i.x>h||i.y>h)&&(i.x>h&&(s.x=Math.floor(h/ct.x),i.x=s.x*ct.x,W.mapSize.x=s.x),i.y>h&&(s.y=Math.floor(h/ct.y),i.y=s.y*ct.y,W.mapSize.y=s.y)),W.map===null||V===!0||K===!0){const C=this.type!==en?{minFilter:ke,magFilter:ke}:{};W.map!==null&&W.map.dispose(),W.map=new zn(i.x,i.y,C),W.map.texture.name=nt.name+".shadowMap",W.camera.updateProjectionMatrix()}r.setRenderTarget(W.map),r.clear();const L=W.getViewportCount();for(let C=0;C<L;C++){const rt=W.getViewport(C);a.set(s.x*rt.x,s.y*rt.y,s.x*rt.z,s.y*rt.w),k.viewport(a),W.updateMatrices(nt,C),n=W.getFrustum(),S(w,I,W.camera,nt,this.type)}W.isPointLightShadow!==!0&&this.type===en&&A(W,I),W.needsUpdate=!1}f=this.type,p.needsUpdate=!1,r.setRenderTarget(y,M,D)};function A(b,w){const I=t.update(v);d.defines.VSM_SAMPLES!==b.blurSamples&&(d.defines.VSM_SAMPLES=b.blurSamples,m.defines.VSM_SAMPLES=b.blurSamples,d.needsUpdate=!0,m.needsUpdate=!0),b.mapPass===null&&(b.mapPass=new zn(i.x,i.y)),d.uniforms.shadow_pass.value=b.map.texture,d.uniforms.resolution.value=b.mapSize,d.uniforms.radius.value=b.radius,r.setRenderTarget(b.mapPass),r.clear(),r.renderBufferDirect(w,null,I,d,v,null),m.uniforms.shadow_pass.value=b.mapPass.texture,m.uniforms.resolution.value=b.mapSize,m.uniforms.radius.value=b.radius,r.setRenderTarget(b.map),r.clear(),r.renderBufferDirect(w,null,I,m,v,null)}function E(b,w,I,y){let M=null;const D=I.isPointLight===!0?b.customDistanceMaterial:b.customDepthMaterial;if(D!==void 0)M=D;else if(M=I.isPointLight===!0?l:o,r.localClippingEnabled&&w.clipShadows===!0&&Array.isArray(w.clippingPlanes)&&w.clippingPlanes.length!==0||w.displacementMap&&w.displacementScale!==0||w.alphaMap&&w.alphaTest>0||w.map&&w.alphaTest>0){const k=M.uuid,V=w.uuid;let K=c[k];K===void 0&&(K={},c[k]=K);let j=K[V];j===void 0&&(j=M.clone(),K[V]=j,w.addEventListener("dispose",R)),M=j}if(M.visible=w.visible,M.wireframe=w.wireframe,y===en?M.side=w.shadowSide!==null?w.shadowSide:w.side:M.side=w.shadowSide!==null?w.shadowSide:u[w.side],M.alphaMap=w.alphaMap,M.alphaTest=w.alphaTest,M.map=w.map,M.clipShadows=w.clipShadows,M.clippingPlanes=w.clippingPlanes,M.clipIntersection=w.clipIntersection,M.displacementMap=w.displacementMap,M.displacementScale=w.displacementScale,M.displacementBias=w.displacementBias,M.wireframeLinewidth=w.wireframeLinewidth,M.linewidth=w.linewidth,I.isPointLight===!0&&M.isMeshDistanceMaterial===!0){const k=r.properties.get(M);k.light=I}return M}function S(b,w,I,y,M){if(b.visible===!1)return;if(b.layers.test(w.layers)&&(b.isMesh||b.isLine||b.isPoints)&&(b.castShadow||b.receiveShadow&&M===en)&&(!b.frustumCulled||n.intersectsObject(b))){b.modelViewMatrix.multiplyMatrices(I.matrixWorldInverse,b.matrixWorld);const V=t.update(b),K=b.material;if(Array.isArray(K)){const j=V.groups;for(let Z=0,nt=j.length;Z<nt;Z++){const W=j[Z],ct=K[W.materialIndex];if(ct&&ct.visible){const L=E(b,ct,y,M);b.onBeforeShadow(r,b,w,I,V,L,W),r.renderBufferDirect(I,null,V,L,b,W),b.onAfterShadow(r,b,w,I,V,L,W)}}}else if(K.visible){const j=E(b,K,y,M);b.onBeforeShadow(r,b,w,I,V,j,null),r.renderBufferDirect(I,null,V,j,b,null),b.onAfterShadow(r,b,w,I,V,j,null)}}const k=b.children;for(let V=0,K=k.length;V<K;V++)S(k[V],w,I,y,M)}function R(b){b.target.removeEventListener("dispose",R);for(const I in c){const y=c[I],M=b.target.uuid;M in y&&(y[M].dispose(),delete y[M])}}}const _p={[vs]:xs,[Ms]:Es,[Ss]:Ts,[ci]:ys,[xs]:vs,[Es]:Ms,[Ts]:Ss,[ys]:ci};function vp(r,t){function e(){let N=!1;const dt=new ae;let X=null;const tt=new ae(0,0,0,0);return{setMask:function(gt){X!==gt&&!N&&(r.colorMask(gt,gt,gt,gt),X=gt)},setLocked:function(gt){N=gt},setClear:function(gt,ft,Ft,se,pe){pe===!0&&(gt*=se,ft*=se,Ft*=se),dt.set(gt,ft,Ft,se),tt.equals(dt)===!1&&(r.clearColor(gt,ft,Ft,se),tt.copy(dt))},reset:function(){N=!1,X=null,tt.set(-1,0,0,0)}}}function n(){let N=!1,dt=!1,X=null,tt=null,gt=null;return{setReversed:function(ft){if(dt!==ft){const Ft=t.get("EXT_clip_control");dt?Ft.clipControlEXT(Ft.LOWER_LEFT_EXT,Ft.ZERO_TO_ONE_EXT):Ft.clipControlEXT(Ft.LOWER_LEFT_EXT,Ft.NEGATIVE_ONE_TO_ONE_EXT);const se=gt;gt=null,this.setClear(se)}dt=ft},getReversed:function(){return dt},setTest:function(ft){ft?$(r.DEPTH_TEST):ot(r.DEPTH_TEST)},setMask:function(ft){X!==ft&&!N&&(r.depthMask(ft),X=ft)},setFunc:function(ft){if(dt&&(ft=_p[ft]),tt!==ft){switch(ft){case vs:r.depthFunc(r.NEVER);break;case xs:r.depthFunc(r.ALWAYS);break;case Ms:r.depthFunc(r.LESS);break;case ci:r.depthFunc(r.LEQUAL);break;case Ss:r.depthFunc(r.EQUAL);break;case ys:r.depthFunc(r.GEQUAL);break;case Es:r.depthFunc(r.GREATER);break;case Ts:r.depthFunc(r.NOTEQUAL);break;default:r.depthFunc(r.LEQUAL)}tt=ft}},setLocked:function(ft){N=ft},setClear:function(ft){gt!==ft&&(dt&&(ft=1-ft),r.clearDepth(ft),gt=ft)},reset:function(){N=!1,X=null,tt=null,gt=null,dt=!1}}}function i(){let N=!1,dt=null,X=null,tt=null,gt=null,ft=null,Ft=null,se=null,pe=null;return{setTest:function(Kt){N||(Kt?$(r.STENCIL_TEST):ot(r.STENCIL_TEST))},setMask:function(Kt){dt!==Kt&&!N&&(r.stencilMask(Kt),dt=Kt)},setFunc:function(Kt,Ue,$e){(X!==Kt||tt!==Ue||gt!==$e)&&(r.stencilFunc(Kt,Ue,$e),X=Kt,tt=Ue,gt=$e)},setOp:function(Kt,Ue,$e){(ft!==Kt||Ft!==Ue||se!==$e)&&(r.stencilOp(Kt,Ue,$e),ft=Kt,Ft=Ue,se=$e)},setLocked:function(Kt){N=Kt},setClear:function(Kt){pe!==Kt&&(r.clearStencil(Kt),pe=Kt)},reset:function(){N=!1,dt=null,X=null,tt=null,gt=null,ft=null,Ft=null,se=null,pe=null}}}const s=new e,a=new n,o=new i,l=new WeakMap,c=new WeakMap;let h={},u={},d=new WeakMap,m=[],g=null,v=!1,p=null,f=null,A=null,E=null,S=null,R=null,b=null,w=new kt(0,0,0),I=0,y=!1,M=null,D=null,k=null,V=null,K=null;const j=r.getParameter(r.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let Z=!1,nt=0;const W=r.getParameter(r.VERSION);W.indexOf("WebGL")!==-1?(nt=parseFloat(/^WebGL (\d)/.exec(W)[1]),Z=nt>=1):W.indexOf("OpenGL ES")!==-1&&(nt=parseFloat(/^OpenGL ES (\d)/.exec(W)[1]),Z=nt>=2);let ct=null,L={};const C=r.getParameter(r.SCISSOR_BOX),rt=r.getParameter(r.VIEWPORT),ht=new ae().fromArray(C),B=new ae().fromArray(rt);function Y(N,dt,X,tt){const gt=new Uint8Array(4),ft=r.createTexture();r.bindTexture(N,ft),r.texParameteri(N,r.TEXTURE_MIN_FILTER,r.NEAREST),r.texParameteri(N,r.TEXTURE_MAG_FILTER,r.NEAREST);for(let Ft=0;Ft<X;Ft++)N===r.TEXTURE_3D||N===r.TEXTURE_2D_ARRAY?r.texImage3D(dt,0,r.RGBA,1,1,tt,0,r.RGBA,r.UNSIGNED_BYTE,gt):r.texImage2D(dt+Ft,0,r.RGBA,1,1,0,r.RGBA,r.UNSIGNED_BYTE,gt);return ft}const it={};it[r.TEXTURE_2D]=Y(r.TEXTURE_2D,r.TEXTURE_2D,1),it[r.TEXTURE_CUBE_MAP]=Y(r.TEXTURE_CUBE_MAP,r.TEXTURE_CUBE_MAP_POSITIVE_X,6),it[r.TEXTURE_2D_ARRAY]=Y(r.TEXTURE_2D_ARRAY,r.TEXTURE_2D_ARRAY,1,1),it[r.TEXTURE_3D]=Y(r.TEXTURE_3D,r.TEXTURE_3D,1,1),s.setClear(0,0,0,1),a.setClear(1),o.setClear(0),$(r.DEPTH_TEST),a.setFunc(ci),Dt(!1),It(Pa),$(r.CULL_FACE),P(vn);function $(N){h[N]!==!0&&(r.enable(N),h[N]=!0)}function ot(N){h[N]!==!1&&(r.disable(N),h[N]=!1)}function mt(N,dt){return u[N]!==dt?(r.bindFramebuffer(N,dt),u[N]=dt,N===r.DRAW_FRAMEBUFFER&&(u[r.FRAMEBUFFER]=dt),N===r.FRAMEBUFFER&&(u[r.DRAW_FRAMEBUFFER]=dt),!0):!1}function St(N,dt){let X=m,tt=!1;if(N){X=d.get(dt),X===void 0&&(X=[],d.set(dt,X));const gt=N.textures;if(X.length!==gt.length||X[0]!==r.COLOR_ATTACHMENT0){for(let ft=0,Ft=gt.length;ft<Ft;ft++)X[ft]=r.COLOR_ATTACHMENT0+ft;X.length=gt.length,tt=!0}}else X[0]!==r.BACK&&(X[0]=r.BACK,tt=!0);tt&&r.drawBuffers(X)}function Lt(N){return g!==N?(r.useProgram(N),g=N,!0):!1}const Ct={[In]:r.FUNC_ADD,[Nl]:r.FUNC_SUBTRACT,[Fl]:r.FUNC_REVERSE_SUBTRACT};Ct[Ol]=r.MIN,Ct[Bl]=r.MAX;const Vt={[zl]:r.ZERO,[Gl]:r.ONE,[Vl]:r.SRC_COLOR,[gs]:r.SRC_ALPHA,[ql]:r.SRC_ALPHA_SATURATE,[Xl]:r.DST_COLOR,[kl]:r.DST_ALPHA,[Hl]:r.ONE_MINUS_SRC_COLOR,[_s]:r.ONE_MINUS_SRC_ALPHA,[Yl]:r.ONE_MINUS_DST_COLOR,[Wl]:r.ONE_MINUS_DST_ALPHA,[$l]:r.CONSTANT_COLOR,[Zl]:r.ONE_MINUS_CONSTANT_COLOR,[Kl]:r.CONSTANT_ALPHA,[Jl]:r.ONE_MINUS_CONSTANT_ALPHA};function P(N,dt,X,tt,gt,ft,Ft,se,pe,Kt){if(N===vn){v===!0&&(ot(r.BLEND),v=!1);return}if(v===!1&&($(r.BLEND),v=!0),N!==Ul){if(N!==p||Kt!==y){if((f!==In||S!==In)&&(r.blendEquation(r.FUNC_ADD),f=In,S=In),Kt)switch(N){case ai:r.blendFuncSeparate(r.ONE,r.ONE_MINUS_SRC_ALPHA,r.ONE,r.ONE_MINUS_SRC_ALPHA);break;case La:r.blendFunc(r.ONE,r.ONE);break;case Da:r.blendFuncSeparate(r.ZERO,r.ONE_MINUS_SRC_COLOR,r.ZERO,r.ONE);break;case Ia:r.blendFuncSeparate(r.ZERO,r.SRC_COLOR,r.ZERO,r.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",N);break}else switch(N){case ai:r.blendFuncSeparate(r.SRC_ALPHA,r.ONE_MINUS_SRC_ALPHA,r.ONE,r.ONE_MINUS_SRC_ALPHA);break;case La:r.blendFunc(r.SRC_ALPHA,r.ONE);break;case Da:r.blendFuncSeparate(r.ZERO,r.ONE_MINUS_SRC_COLOR,r.ZERO,r.ONE);break;case Ia:r.blendFunc(r.ZERO,r.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",N);break}A=null,E=null,R=null,b=null,w.set(0,0,0),I=0,p=N,y=Kt}return}gt=gt||dt,ft=ft||X,Ft=Ft||tt,(dt!==f||gt!==S)&&(r.blendEquationSeparate(Ct[dt],Ct[gt]),f=dt,S=gt),(X!==A||tt!==E||ft!==R||Ft!==b)&&(r.blendFuncSeparate(Vt[X],Vt[tt],Vt[ft],Vt[Ft]),A=X,E=tt,R=ft,b=Ft),(se.equals(w)===!1||pe!==I)&&(r.blendColor(se.r,se.g,se.b,pe),w.copy(se),I=pe),p=N,y=!1}function Qt(N,dt){N.side===Ge?ot(r.CULL_FACE):$(r.CULL_FACE);let X=N.side===Ee;dt&&(X=!X),Dt(X),N.blending===ai&&N.transparent===!1?P(vn):P(N.blending,N.blendEquation,N.blendSrc,N.blendDst,N.blendEquationAlpha,N.blendSrcAlpha,N.blendDstAlpha,N.blendColor,N.blendAlpha,N.premultipliedAlpha),a.setFunc(N.depthFunc),a.setTest(N.depthTest),a.setMask(N.depthWrite),s.setMask(N.colorWrite);const tt=N.stencilWrite;o.setTest(tt),tt&&(o.setMask(N.stencilWriteMask),o.setFunc(N.stencilFunc,N.stencilRef,N.stencilFuncMask),o.setOp(N.stencilFail,N.stencilZFail,N.stencilZPass)),Xt(N.polygonOffset,N.polygonOffsetFactor,N.polygonOffsetUnits),N.alphaToCoverage===!0?$(r.SAMPLE_ALPHA_TO_COVERAGE):ot(r.SAMPLE_ALPHA_TO_COVERAGE)}function Dt(N){M!==N&&(N?r.frontFace(r.CW):r.frontFace(r.CCW),M=N)}function It(N){N!==Ll?($(r.CULL_FACE),N!==D&&(N===Pa?r.cullFace(r.BACK):N===Dl?r.cullFace(r.FRONT):r.cullFace(r.FRONT_AND_BACK))):ot(r.CULL_FACE),D=N}function yt(N){N!==k&&(Z&&r.lineWidth(N),k=N)}function Xt(N,dt,X){N?($(r.POLYGON_OFFSET_FILL),(V!==dt||K!==X)&&(r.polygonOffset(dt,X),V=dt,K=X)):ot(r.POLYGON_OFFSET_FILL)}function Mt(N){N?$(r.SCISSOR_TEST):ot(r.SCISSOR_TEST)}function T(N){N===void 0&&(N=r.TEXTURE0+j-1),ct!==N&&(r.activeTexture(N),ct=N)}function _(N,dt,X){X===void 0&&(ct===null?X=r.TEXTURE0+j-1:X=ct);let tt=L[X];tt===void 0&&(tt={type:void 0,texture:void 0},L[X]=tt),(tt.type!==N||tt.texture!==dt)&&(ct!==X&&(r.activeTexture(X),ct=X),r.bindTexture(N,dt||it[N]),tt.type=N,tt.texture=dt)}function z(){const N=L[ct];N!==void 0&&N.type!==void 0&&(r.bindTexture(N.type,null),N.type=void 0,N.texture=void 0)}function Q(){try{r.compressedTexImage2D.apply(r,arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function et(){try{r.compressedTexImage3D.apply(r,arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function J(){try{r.texSubImage2D.apply(r,arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function Et(){try{r.texSubImage3D.apply(r,arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function ut(){try{r.compressedTexSubImage2D.apply(r,arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function _t(){try{r.compressedTexSubImage3D.apply(r,arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function Ht(){try{r.texStorage2D.apply(r,arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function st(){try{r.texStorage3D.apply(r,arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function vt(){try{r.texImage2D.apply(r,arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function Pt(){try{r.texImage3D.apply(r,arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function Ut(N){ht.equals(N)===!1&&(r.scissor(N.x,N.y,N.z,N.w),ht.copy(N))}function xt(N){B.equals(N)===!1&&(r.viewport(N.x,N.y,N.z,N.w),B.copy(N))}function Wt(N,dt){let X=c.get(dt);X===void 0&&(X=new WeakMap,c.set(dt,X));let tt=X.get(N);tt===void 0&&(tt=r.getUniformBlockIndex(dt,N.name),X.set(N,tt))}function zt(N,dt){const tt=c.get(dt).get(N);l.get(dt)!==tt&&(r.uniformBlockBinding(dt,tt,N.__bindingPointIndex),l.set(dt,tt))}function te(){r.disable(r.BLEND),r.disable(r.CULL_FACE),r.disable(r.DEPTH_TEST),r.disable(r.POLYGON_OFFSET_FILL),r.disable(r.SCISSOR_TEST),r.disable(r.STENCIL_TEST),r.disable(r.SAMPLE_ALPHA_TO_COVERAGE),r.blendEquation(r.FUNC_ADD),r.blendFunc(r.ONE,r.ZERO),r.blendFuncSeparate(r.ONE,r.ZERO,r.ONE,r.ZERO),r.blendColor(0,0,0,0),r.colorMask(!0,!0,!0,!0),r.clearColor(0,0,0,0),r.depthMask(!0),r.depthFunc(r.LESS),a.setReversed(!1),r.clearDepth(1),r.stencilMask(4294967295),r.stencilFunc(r.ALWAYS,0,4294967295),r.stencilOp(r.KEEP,r.KEEP,r.KEEP),r.clearStencil(0),r.cullFace(r.BACK),r.frontFace(r.CCW),r.polygonOffset(0,0),r.activeTexture(r.TEXTURE0),r.bindFramebuffer(r.FRAMEBUFFER,null),r.bindFramebuffer(r.DRAW_FRAMEBUFFER,null),r.bindFramebuffer(r.READ_FRAMEBUFFER,null),r.useProgram(null),r.lineWidth(1),r.scissor(0,0,r.canvas.width,r.canvas.height),r.viewport(0,0,r.canvas.width,r.canvas.height),h={},ct=null,L={},u={},d=new WeakMap,m=[],g=null,v=!1,p=null,f=null,A=null,E=null,S=null,R=null,b=null,w=new kt(0,0,0),I=0,y=!1,M=null,D=null,k=null,V=null,K=null,ht.set(0,0,r.canvas.width,r.canvas.height),B.set(0,0,r.canvas.width,r.canvas.height),s.reset(),a.reset(),o.reset()}return{buffers:{color:s,depth:a,stencil:o},enable:$,disable:ot,bindFramebuffer:mt,drawBuffers:St,useProgram:Lt,setBlending:P,setMaterial:Qt,setFlipSided:Dt,setCullFace:It,setLineWidth:yt,setPolygonOffset:Xt,setScissorTest:Mt,activeTexture:T,bindTexture:_,unbindTexture:z,compressedTexImage2D:Q,compressedTexImage3D:et,texImage2D:vt,texImage3D:Pt,updateUBOMapping:Wt,uniformBlockBinding:zt,texStorage2D:Ht,texStorage3D:st,texSubImage2D:J,texSubImage3D:Et,compressedTexSubImage2D:ut,compressedTexSubImage3D:_t,scissor:Ut,viewport:xt,reset:te}}function wo(r,t,e,n){const i=xp(n);switch(e){case Wo:return r*t;case Yo:return r*t;case qo:return r*t*2;case $o:return r*t/i.components*i.byteLength;case ca:return r*t/i.components*i.byteLength;case Zo:return r*t*2/i.components*i.byteLength;case ha:return r*t*2/i.components*i.byteLength;case Xo:return r*t*3/i.components*i.byteLength;case He:return r*t*4/i.components*i.byteLength;case ua:return r*t*4/i.components*i.byteLength;case _r:case vr:return Math.floor((r+3)/4)*Math.floor((t+3)/4)*8;case xr:case Mr:return Math.floor((r+3)/4)*Math.floor((t+3)/4)*16;case Ps:case Ds:return Math.max(r,16)*Math.max(t,8)/4;case Rs:case Ls:return Math.max(r,8)*Math.max(t,8)/2;case Is:case Us:return Math.floor((r+3)/4)*Math.floor((t+3)/4)*8;case Ns:return Math.floor((r+3)/4)*Math.floor((t+3)/4)*16;case Fs:return Math.floor((r+3)/4)*Math.floor((t+3)/4)*16;case Os:return Math.floor((r+4)/5)*Math.floor((t+3)/4)*16;case Bs:return Math.floor((r+4)/5)*Math.floor((t+4)/5)*16;case zs:return Math.floor((r+5)/6)*Math.floor((t+4)/5)*16;case Gs:return Math.floor((r+5)/6)*Math.floor((t+5)/6)*16;case Vs:return Math.floor((r+7)/8)*Math.floor((t+4)/5)*16;case Hs:return Math.floor((r+7)/8)*Math.floor((t+5)/6)*16;case ks:return Math.floor((r+7)/8)*Math.floor((t+7)/8)*16;case Ws:return Math.floor((r+9)/10)*Math.floor((t+4)/5)*16;case Xs:return Math.floor((r+9)/10)*Math.floor((t+5)/6)*16;case Ys:return Math.floor((r+9)/10)*Math.floor((t+7)/8)*16;case qs:return Math.floor((r+9)/10)*Math.floor((t+9)/10)*16;case $s:return Math.floor((r+11)/12)*Math.floor((t+9)/10)*16;case Zs:return Math.floor((r+11)/12)*Math.floor((t+11)/12)*16;case Sr:case Ks:case Js:return Math.ceil(r/4)*Math.ceil(t/4)*16;case Ko:case js:return Math.ceil(r/4)*Math.ceil(t/4)*8;case Qs:case ta:return Math.ceil(r/4)*Math.ceil(t/4)*16}throw new Error(`Unable to determine texture byte length for ${e} format.`)}function xp(r){switch(r){case on:case Vo:return{byteLength:1,components:1};case Oi:case Ho:case Vi:return{byteLength:2,components:1};case oa:case la:return{byteLength:2,components:4};case Bn:case aa:case nn:return{byteLength:4,components:1};case ko:return{byteLength:4,components:3}}throw new Error(`Unknown texture type ${r}.`)}function Mp(r,t,e,n,i,s,a){const o=t.has("WEBGL_multisampled_render_to_texture")?t.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new wt,h=new WeakMap;let u;const d=new WeakMap;let m=!1;try{m=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function g(T,_){return m?new OffscreenCanvas(T,_):Tr("canvas")}function v(T,_,z){let Q=1;const et=Mt(T);if((et.width>z||et.height>z)&&(Q=z/Math.max(et.width,et.height)),Q<1)if(typeof HTMLImageElement<"u"&&T instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&T instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&T instanceof ImageBitmap||typeof VideoFrame<"u"&&T instanceof VideoFrame){const J=Math.floor(Q*et.width),Et=Math.floor(Q*et.height);u===void 0&&(u=g(J,Et));const ut=_?g(J,Et):u;return ut.width=J,ut.height=Et,ut.getContext("2d").drawImage(T,0,0,J,Et),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+et.width+"x"+et.height+") to ("+J+"x"+Et+")."),ut}else return"data"in T&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+et.width+"x"+et.height+")."),T;return T}function p(T){return T.generateMipmaps}function f(T){r.generateMipmap(T)}function A(T){return T.isWebGLCubeRenderTarget?r.TEXTURE_CUBE_MAP:T.isWebGL3DRenderTarget?r.TEXTURE_3D:T.isWebGLArrayRenderTarget||T.isCompressedArrayTexture?r.TEXTURE_2D_ARRAY:r.TEXTURE_2D}function E(T,_,z,Q,et=!1){if(T!==null){if(r[T]!==void 0)return r[T];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+T+"'")}let J=_;if(_===r.RED&&(z===r.FLOAT&&(J=r.R32F),z===r.HALF_FLOAT&&(J=r.R16F),z===r.UNSIGNED_BYTE&&(J=r.R8)),_===r.RED_INTEGER&&(z===r.UNSIGNED_BYTE&&(J=r.R8UI),z===r.UNSIGNED_SHORT&&(J=r.R16UI),z===r.UNSIGNED_INT&&(J=r.R32UI),z===r.BYTE&&(J=r.R8I),z===r.SHORT&&(J=r.R16I),z===r.INT&&(J=r.R32I)),_===r.RG&&(z===r.FLOAT&&(J=r.RG32F),z===r.HALF_FLOAT&&(J=r.RG16F),z===r.UNSIGNED_BYTE&&(J=r.RG8)),_===r.RG_INTEGER&&(z===r.UNSIGNED_BYTE&&(J=r.RG8UI),z===r.UNSIGNED_SHORT&&(J=r.RG16UI),z===r.UNSIGNED_INT&&(J=r.RG32UI),z===r.BYTE&&(J=r.RG8I),z===r.SHORT&&(J=r.RG16I),z===r.INT&&(J=r.RG32I)),_===r.RGB_INTEGER&&(z===r.UNSIGNED_BYTE&&(J=r.RGB8UI),z===r.UNSIGNED_SHORT&&(J=r.RGB16UI),z===r.UNSIGNED_INT&&(J=r.RGB32UI),z===r.BYTE&&(J=r.RGB8I),z===r.SHORT&&(J=r.RGB16I),z===r.INT&&(J=r.RGB32I)),_===r.RGBA_INTEGER&&(z===r.UNSIGNED_BYTE&&(J=r.RGBA8UI),z===r.UNSIGNED_SHORT&&(J=r.RGBA16UI),z===r.UNSIGNED_INT&&(J=r.RGBA32UI),z===r.BYTE&&(J=r.RGBA8I),z===r.SHORT&&(J=r.RGBA16I),z===r.INT&&(J=r.RGBA32I)),_===r.RGB&&z===r.UNSIGNED_INT_5_9_9_9_REV&&(J=r.RGB9_E5),_===r.RGBA){const Et=et?Cr:Yt.getTransfer(Q);z===r.FLOAT&&(J=r.RGBA32F),z===r.HALF_FLOAT&&(J=r.RGBA16F),z===r.UNSIGNED_BYTE&&(J=Et===Jt?r.SRGB8_ALPHA8:r.RGBA8),z===r.UNSIGNED_SHORT_4_4_4_4&&(J=r.RGBA4),z===r.UNSIGNED_SHORT_5_5_5_1&&(J=r.RGB5_A1)}return(J===r.R16F||J===r.R32F||J===r.RG16F||J===r.RG32F||J===r.RGBA16F||J===r.RGBA32F)&&t.get("EXT_color_buffer_float"),J}function S(T,_){let z;return T?_===null||_===Bn||_===di?z=r.DEPTH24_STENCIL8:_===nn?z=r.DEPTH32F_STENCIL8:_===Oi&&(z=r.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):_===null||_===Bn||_===di?z=r.DEPTH_COMPONENT24:_===nn?z=r.DEPTH_COMPONENT32F:_===Oi&&(z=r.DEPTH_COMPONENT16),z}function R(T,_){return p(T)===!0||T.isFramebufferTexture&&T.minFilter!==ke&&T.minFilter!==Ve?Math.log2(Math.max(_.width,_.height))+1:T.mipmaps!==void 0&&T.mipmaps.length>0?T.mipmaps.length:T.isCompressedTexture&&Array.isArray(T.image)?_.mipmaps.length:1}function b(T){const _=T.target;_.removeEventListener("dispose",b),I(_),_.isVideoTexture&&h.delete(_)}function w(T){const _=T.target;_.removeEventListener("dispose",w),M(_)}function I(T){const _=n.get(T);if(_.__webglInit===void 0)return;const z=T.source,Q=d.get(z);if(Q){const et=Q[_.__cacheKey];et.usedTimes--,et.usedTimes===0&&y(T),Object.keys(Q).length===0&&d.delete(z)}n.remove(T)}function y(T){const _=n.get(T);r.deleteTexture(_.__webglTexture);const z=T.source,Q=d.get(z);delete Q[_.__cacheKey],a.memory.textures--}function M(T){const _=n.get(T);if(T.depthTexture&&(T.depthTexture.dispose(),n.remove(T.depthTexture)),T.isWebGLCubeRenderTarget)for(let Q=0;Q<6;Q++){if(Array.isArray(_.__webglFramebuffer[Q]))for(let et=0;et<_.__webglFramebuffer[Q].length;et++)r.deleteFramebuffer(_.__webglFramebuffer[Q][et]);else r.deleteFramebuffer(_.__webglFramebuffer[Q]);_.__webglDepthbuffer&&r.deleteRenderbuffer(_.__webglDepthbuffer[Q])}else{if(Array.isArray(_.__webglFramebuffer))for(let Q=0;Q<_.__webglFramebuffer.length;Q++)r.deleteFramebuffer(_.__webglFramebuffer[Q]);else r.deleteFramebuffer(_.__webglFramebuffer);if(_.__webglDepthbuffer&&r.deleteRenderbuffer(_.__webglDepthbuffer),_.__webglMultisampledFramebuffer&&r.deleteFramebuffer(_.__webglMultisampledFramebuffer),_.__webglColorRenderbuffer)for(let Q=0;Q<_.__webglColorRenderbuffer.length;Q++)_.__webglColorRenderbuffer[Q]&&r.deleteRenderbuffer(_.__webglColorRenderbuffer[Q]);_.__webglDepthRenderbuffer&&r.deleteRenderbuffer(_.__webglDepthRenderbuffer)}const z=T.textures;for(let Q=0,et=z.length;Q<et;Q++){const J=n.get(z[Q]);J.__webglTexture&&(r.deleteTexture(J.__webglTexture),a.memory.textures--),n.remove(z[Q])}n.remove(T)}let D=0;function k(){D=0}function V(){const T=D;return T>=i.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+T+" texture units while this GPU supports only "+i.maxTextures),D+=1,T}function K(T){const _=[];return _.push(T.wrapS),_.push(T.wrapT),_.push(T.wrapR||0),_.push(T.magFilter),_.push(T.minFilter),_.push(T.anisotropy),_.push(T.internalFormat),_.push(T.format),_.push(T.type),_.push(T.generateMipmaps),_.push(T.premultiplyAlpha),_.push(T.flipY),_.push(T.unpackAlignment),_.push(T.colorSpace),_.join()}function j(T,_){const z=n.get(T);if(T.isVideoTexture&&yt(T),T.isRenderTargetTexture===!1&&T.version>0&&z.__version!==T.version){const Q=T.image;if(Q===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(Q.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{B(z,T,_);return}}e.bindTexture(r.TEXTURE_2D,z.__webglTexture,r.TEXTURE0+_)}function Z(T,_){const z=n.get(T);if(T.version>0&&z.__version!==T.version){B(z,T,_);return}e.bindTexture(r.TEXTURE_2D_ARRAY,z.__webglTexture,r.TEXTURE0+_)}function nt(T,_){const z=n.get(T);if(T.version>0&&z.__version!==T.version){B(z,T,_);return}e.bindTexture(r.TEXTURE_3D,z.__webglTexture,r.TEXTURE0+_)}function W(T,_){const z=n.get(T);if(T.version>0&&z.__version!==T.version){Y(z,T,_);return}e.bindTexture(r.TEXTURE_CUBE_MAP,z.__webglTexture,r.TEXTURE0+_)}const ct={[ws]:r.REPEAT,[Nn]:r.CLAMP_TO_EDGE,[Cs]:r.MIRRORED_REPEAT},L={[ke]:r.NEAREST,[ac]:r.NEAREST_MIPMAP_NEAREST,[Yi]:r.NEAREST_MIPMAP_LINEAR,[Ve]:r.LINEAR,[Dr]:r.LINEAR_MIPMAP_NEAREST,[Fn]:r.LINEAR_MIPMAP_LINEAR},C={[hc]:r.NEVER,[gc]:r.ALWAYS,[uc]:r.LESS,[jo]:r.LEQUAL,[dc]:r.EQUAL,[mc]:r.GEQUAL,[fc]:r.GREATER,[pc]:r.NOTEQUAL};function rt(T,_){if(_.type===nn&&t.has("OES_texture_float_linear")===!1&&(_.magFilter===Ve||_.magFilter===Dr||_.magFilter===Yi||_.magFilter===Fn||_.minFilter===Ve||_.minFilter===Dr||_.minFilter===Yi||_.minFilter===Fn)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),r.texParameteri(T,r.TEXTURE_WRAP_S,ct[_.wrapS]),r.texParameteri(T,r.TEXTURE_WRAP_T,ct[_.wrapT]),(T===r.TEXTURE_3D||T===r.TEXTURE_2D_ARRAY)&&r.texParameteri(T,r.TEXTURE_WRAP_R,ct[_.wrapR]),r.texParameteri(T,r.TEXTURE_MAG_FILTER,L[_.magFilter]),r.texParameteri(T,r.TEXTURE_MIN_FILTER,L[_.minFilter]),_.compareFunction&&(r.texParameteri(T,r.TEXTURE_COMPARE_MODE,r.COMPARE_REF_TO_TEXTURE),r.texParameteri(T,r.TEXTURE_COMPARE_FUNC,C[_.compareFunction])),t.has("EXT_texture_filter_anisotropic")===!0){if(_.magFilter===ke||_.minFilter!==Yi&&_.minFilter!==Fn||_.type===nn&&t.has("OES_texture_float_linear")===!1)return;if(_.anisotropy>1||n.get(_).__currentAnisotropy){const z=t.get("EXT_texture_filter_anisotropic");r.texParameterf(T,z.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(_.anisotropy,i.getMaxAnisotropy())),n.get(_).__currentAnisotropy=_.anisotropy}}}function ht(T,_){let z=!1;T.__webglInit===void 0&&(T.__webglInit=!0,_.addEventListener("dispose",b));const Q=_.source;let et=d.get(Q);et===void 0&&(et={},d.set(Q,et));const J=K(_);if(J!==T.__cacheKey){et[J]===void 0&&(et[J]={texture:r.createTexture(),usedTimes:0},a.memory.textures++,z=!0),et[J].usedTimes++;const Et=et[T.__cacheKey];Et!==void 0&&(et[T.__cacheKey].usedTimes--,Et.usedTimes===0&&y(_)),T.__cacheKey=J,T.__webglTexture=et[J].texture}return z}function B(T,_,z){let Q=r.TEXTURE_2D;(_.isDataArrayTexture||_.isCompressedArrayTexture)&&(Q=r.TEXTURE_2D_ARRAY),_.isData3DTexture&&(Q=r.TEXTURE_3D);const et=ht(T,_),J=_.source;e.bindTexture(Q,T.__webglTexture,r.TEXTURE0+z);const Et=n.get(J);if(J.version!==Et.__version||et===!0){e.activeTexture(r.TEXTURE0+z);const ut=Yt.getPrimaries(Yt.workingColorSpace),_t=_.colorSpace===_n?null:Yt.getPrimaries(_.colorSpace),Ht=_.colorSpace===_n||ut===_t?r.NONE:r.BROWSER_DEFAULT_WEBGL;r.pixelStorei(r.UNPACK_FLIP_Y_WEBGL,_.flipY),r.pixelStorei(r.UNPACK_PREMULTIPLY_ALPHA_WEBGL,_.premultiplyAlpha),r.pixelStorei(r.UNPACK_ALIGNMENT,_.unpackAlignment),r.pixelStorei(r.UNPACK_COLORSPACE_CONVERSION_WEBGL,Ht);let st=v(_.image,!1,i.maxTextureSize);st=Xt(_,st);const vt=s.convert(_.format,_.colorSpace),Pt=s.convert(_.type);let Ut=E(_.internalFormat,vt,Pt,_.colorSpace,_.isVideoTexture);rt(Q,_);let xt;const Wt=_.mipmaps,zt=_.isVideoTexture!==!0,te=Et.__version===void 0||et===!0,N=J.dataReady,dt=R(_,st);if(_.isDepthTexture)Ut=S(_.format===fi,_.type),te&&(zt?e.texStorage2D(r.TEXTURE_2D,1,Ut,st.width,st.height):e.texImage2D(r.TEXTURE_2D,0,Ut,st.width,st.height,0,vt,Pt,null));else if(_.isDataTexture)if(Wt.length>0){zt&&te&&e.texStorage2D(r.TEXTURE_2D,dt,Ut,Wt[0].width,Wt[0].height);for(let X=0,tt=Wt.length;X<tt;X++)xt=Wt[X],zt?N&&e.texSubImage2D(r.TEXTURE_2D,X,0,0,xt.width,xt.height,vt,Pt,xt.data):e.texImage2D(r.TEXTURE_2D,X,Ut,xt.width,xt.height,0,vt,Pt,xt.data);_.generateMipmaps=!1}else zt?(te&&e.texStorage2D(r.TEXTURE_2D,dt,Ut,st.width,st.height),N&&e.texSubImage2D(r.TEXTURE_2D,0,0,0,st.width,st.height,vt,Pt,st.data)):e.texImage2D(r.TEXTURE_2D,0,Ut,st.width,st.height,0,vt,Pt,st.data);else if(_.isCompressedTexture)if(_.isCompressedArrayTexture){zt&&te&&e.texStorage3D(r.TEXTURE_2D_ARRAY,dt,Ut,Wt[0].width,Wt[0].height,st.depth);for(let X=0,tt=Wt.length;X<tt;X++)if(xt=Wt[X],_.format!==He)if(vt!==null)if(zt){if(N)if(_.layerUpdates.size>0){const gt=wo(xt.width,xt.height,_.format,_.type);for(const ft of _.layerUpdates){const Ft=xt.data.subarray(ft*gt/xt.data.BYTES_PER_ELEMENT,(ft+1)*gt/xt.data.BYTES_PER_ELEMENT);e.compressedTexSubImage3D(r.TEXTURE_2D_ARRAY,X,0,0,ft,xt.width,xt.height,1,vt,Ft)}_.clearLayerUpdates()}else e.compressedTexSubImage3D(r.TEXTURE_2D_ARRAY,X,0,0,0,xt.width,xt.height,st.depth,vt,xt.data)}else e.compressedTexImage3D(r.TEXTURE_2D_ARRAY,X,Ut,xt.width,xt.height,st.depth,0,xt.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else zt?N&&e.texSubImage3D(r.TEXTURE_2D_ARRAY,X,0,0,0,xt.width,xt.height,st.depth,vt,Pt,xt.data):e.texImage3D(r.TEXTURE_2D_ARRAY,X,Ut,xt.width,xt.height,st.depth,0,vt,Pt,xt.data)}else{zt&&te&&e.texStorage2D(r.TEXTURE_2D,dt,Ut,Wt[0].width,Wt[0].height);for(let X=0,tt=Wt.length;X<tt;X++)xt=Wt[X],_.format!==He?vt!==null?zt?N&&e.compressedTexSubImage2D(r.TEXTURE_2D,X,0,0,xt.width,xt.height,vt,xt.data):e.compressedTexImage2D(r.TEXTURE_2D,X,Ut,xt.width,xt.height,0,xt.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):zt?N&&e.texSubImage2D(r.TEXTURE_2D,X,0,0,xt.width,xt.height,vt,Pt,xt.data):e.texImage2D(r.TEXTURE_2D,X,Ut,xt.width,xt.height,0,vt,Pt,xt.data)}else if(_.isDataArrayTexture)if(zt){if(te&&e.texStorage3D(r.TEXTURE_2D_ARRAY,dt,Ut,st.width,st.height,st.depth),N)if(_.layerUpdates.size>0){const X=wo(st.width,st.height,_.format,_.type);for(const tt of _.layerUpdates){const gt=st.data.subarray(tt*X/st.data.BYTES_PER_ELEMENT,(tt+1)*X/st.data.BYTES_PER_ELEMENT);e.texSubImage3D(r.TEXTURE_2D_ARRAY,0,0,0,tt,st.width,st.height,1,vt,Pt,gt)}_.clearLayerUpdates()}else e.texSubImage3D(r.TEXTURE_2D_ARRAY,0,0,0,0,st.width,st.height,st.depth,vt,Pt,st.data)}else e.texImage3D(r.TEXTURE_2D_ARRAY,0,Ut,st.width,st.height,st.depth,0,vt,Pt,st.data);else if(_.isData3DTexture)zt?(te&&e.texStorage3D(r.TEXTURE_3D,dt,Ut,st.width,st.height,st.depth),N&&e.texSubImage3D(r.TEXTURE_3D,0,0,0,0,st.width,st.height,st.depth,vt,Pt,st.data)):e.texImage3D(r.TEXTURE_3D,0,Ut,st.width,st.height,st.depth,0,vt,Pt,st.data);else if(_.isFramebufferTexture){if(te)if(zt)e.texStorage2D(r.TEXTURE_2D,dt,Ut,st.width,st.height);else{let X=st.width,tt=st.height;for(let gt=0;gt<dt;gt++)e.texImage2D(r.TEXTURE_2D,gt,Ut,X,tt,0,vt,Pt,null),X>>=1,tt>>=1}}else if(Wt.length>0){if(zt&&te){const X=Mt(Wt[0]);e.texStorage2D(r.TEXTURE_2D,dt,Ut,X.width,X.height)}for(let X=0,tt=Wt.length;X<tt;X++)xt=Wt[X],zt?N&&e.texSubImage2D(r.TEXTURE_2D,X,0,0,vt,Pt,xt):e.texImage2D(r.TEXTURE_2D,X,Ut,vt,Pt,xt);_.generateMipmaps=!1}else if(zt){if(te){const X=Mt(st);e.texStorage2D(r.TEXTURE_2D,dt,Ut,X.width,X.height)}N&&e.texSubImage2D(r.TEXTURE_2D,0,0,0,vt,Pt,st)}else e.texImage2D(r.TEXTURE_2D,0,Ut,vt,Pt,st);p(_)&&f(Q),Et.__version=J.version,_.onUpdate&&_.onUpdate(_)}T.__version=_.version}function Y(T,_,z){if(_.image.length!==6)return;const Q=ht(T,_),et=_.source;e.bindTexture(r.TEXTURE_CUBE_MAP,T.__webglTexture,r.TEXTURE0+z);const J=n.get(et);if(et.version!==J.__version||Q===!0){e.activeTexture(r.TEXTURE0+z);const Et=Yt.getPrimaries(Yt.workingColorSpace),ut=_.colorSpace===_n?null:Yt.getPrimaries(_.colorSpace),_t=_.colorSpace===_n||Et===ut?r.NONE:r.BROWSER_DEFAULT_WEBGL;r.pixelStorei(r.UNPACK_FLIP_Y_WEBGL,_.flipY),r.pixelStorei(r.UNPACK_PREMULTIPLY_ALPHA_WEBGL,_.premultiplyAlpha),r.pixelStorei(r.UNPACK_ALIGNMENT,_.unpackAlignment),r.pixelStorei(r.UNPACK_COLORSPACE_CONVERSION_WEBGL,_t);const Ht=_.isCompressedTexture||_.image[0].isCompressedTexture,st=_.image[0]&&_.image[0].isDataTexture,vt=[];for(let tt=0;tt<6;tt++)!Ht&&!st?vt[tt]=v(_.image[tt],!0,i.maxCubemapSize):vt[tt]=st?_.image[tt].image:_.image[tt],vt[tt]=Xt(_,vt[tt]);const Pt=vt[0],Ut=s.convert(_.format,_.colorSpace),xt=s.convert(_.type),Wt=E(_.internalFormat,Ut,xt,_.colorSpace),zt=_.isVideoTexture!==!0,te=J.__version===void 0||Q===!0,N=et.dataReady;let dt=R(_,Pt);rt(r.TEXTURE_CUBE_MAP,_);let X;if(Ht){zt&&te&&e.texStorage2D(r.TEXTURE_CUBE_MAP,dt,Wt,Pt.width,Pt.height);for(let tt=0;tt<6;tt++){X=vt[tt].mipmaps;for(let gt=0;gt<X.length;gt++){const ft=X[gt];_.format!==He?Ut!==null?zt?N&&e.compressedTexSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+tt,gt,0,0,ft.width,ft.height,Ut,ft.data):e.compressedTexImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+tt,gt,Wt,ft.width,ft.height,0,ft.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):zt?N&&e.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+tt,gt,0,0,ft.width,ft.height,Ut,xt,ft.data):e.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+tt,gt,Wt,ft.width,ft.height,0,Ut,xt,ft.data)}}}else{if(X=_.mipmaps,zt&&te){X.length>0&&dt++;const tt=Mt(vt[0]);e.texStorage2D(r.TEXTURE_CUBE_MAP,dt,Wt,tt.width,tt.height)}for(let tt=0;tt<6;tt++)if(st){zt?N&&e.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+tt,0,0,0,vt[tt].width,vt[tt].height,Ut,xt,vt[tt].data):e.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+tt,0,Wt,vt[tt].width,vt[tt].height,0,Ut,xt,vt[tt].data);for(let gt=0;gt<X.length;gt++){const Ft=X[gt].image[tt].image;zt?N&&e.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+tt,gt+1,0,0,Ft.width,Ft.height,Ut,xt,Ft.data):e.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+tt,gt+1,Wt,Ft.width,Ft.height,0,Ut,xt,Ft.data)}}else{zt?N&&e.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+tt,0,0,0,Ut,xt,vt[tt]):e.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+tt,0,Wt,Ut,xt,vt[tt]);for(let gt=0;gt<X.length;gt++){const ft=X[gt];zt?N&&e.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+tt,gt+1,0,0,Ut,xt,ft.image[tt]):e.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+tt,gt+1,Wt,Ut,xt,ft.image[tt])}}}p(_)&&f(r.TEXTURE_CUBE_MAP),J.__version=et.version,_.onUpdate&&_.onUpdate(_)}T.__version=_.version}function it(T,_,z,Q,et,J){const Et=s.convert(z.format,z.colorSpace),ut=s.convert(z.type),_t=E(z.internalFormat,Et,ut,z.colorSpace),Ht=n.get(_),st=n.get(z);if(st.__renderTarget=_,!Ht.__hasExternalTextures){const vt=Math.max(1,_.width>>J),Pt=Math.max(1,_.height>>J);et===r.TEXTURE_3D||et===r.TEXTURE_2D_ARRAY?e.texImage3D(et,J,_t,vt,Pt,_.depth,0,Et,ut,null):e.texImage2D(et,J,_t,vt,Pt,0,Et,ut,null)}e.bindFramebuffer(r.FRAMEBUFFER,T),It(_)?o.framebufferTexture2DMultisampleEXT(r.FRAMEBUFFER,Q,et,st.__webglTexture,0,Dt(_)):(et===r.TEXTURE_2D||et>=r.TEXTURE_CUBE_MAP_POSITIVE_X&&et<=r.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&r.framebufferTexture2D(r.FRAMEBUFFER,Q,et,st.__webglTexture,J),e.bindFramebuffer(r.FRAMEBUFFER,null)}function $(T,_,z){if(r.bindRenderbuffer(r.RENDERBUFFER,T),_.depthBuffer){const Q=_.depthTexture,et=Q&&Q.isDepthTexture?Q.type:null,J=S(_.stencilBuffer,et),Et=_.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT,ut=Dt(_);It(_)?o.renderbufferStorageMultisampleEXT(r.RENDERBUFFER,ut,J,_.width,_.height):z?r.renderbufferStorageMultisample(r.RENDERBUFFER,ut,J,_.width,_.height):r.renderbufferStorage(r.RENDERBUFFER,J,_.width,_.height),r.framebufferRenderbuffer(r.FRAMEBUFFER,Et,r.RENDERBUFFER,T)}else{const Q=_.textures;for(let et=0;et<Q.length;et++){const J=Q[et],Et=s.convert(J.format,J.colorSpace),ut=s.convert(J.type),_t=E(J.internalFormat,Et,ut,J.colorSpace),Ht=Dt(_);z&&It(_)===!1?r.renderbufferStorageMultisample(r.RENDERBUFFER,Ht,_t,_.width,_.height):It(_)?o.renderbufferStorageMultisampleEXT(r.RENDERBUFFER,Ht,_t,_.width,_.height):r.renderbufferStorage(r.RENDERBUFFER,_t,_.width,_.height)}}r.bindRenderbuffer(r.RENDERBUFFER,null)}function ot(T,_){if(_&&_.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(e.bindFramebuffer(r.FRAMEBUFFER,T),!(_.depthTexture&&_.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const Q=n.get(_.depthTexture);Q.__renderTarget=_,(!Q.__webglTexture||_.depthTexture.image.width!==_.width||_.depthTexture.image.height!==_.height)&&(_.depthTexture.image.width=_.width,_.depthTexture.image.height=_.height,_.depthTexture.needsUpdate=!0),j(_.depthTexture,0);const et=Q.__webglTexture,J=Dt(_);if(_.depthTexture.format===oi)It(_)?o.framebufferTexture2DMultisampleEXT(r.FRAMEBUFFER,r.DEPTH_ATTACHMENT,r.TEXTURE_2D,et,0,J):r.framebufferTexture2D(r.FRAMEBUFFER,r.DEPTH_ATTACHMENT,r.TEXTURE_2D,et,0);else if(_.depthTexture.format===fi)It(_)?o.framebufferTexture2DMultisampleEXT(r.FRAMEBUFFER,r.DEPTH_STENCIL_ATTACHMENT,r.TEXTURE_2D,et,0,J):r.framebufferTexture2D(r.FRAMEBUFFER,r.DEPTH_STENCIL_ATTACHMENT,r.TEXTURE_2D,et,0);else throw new Error("Unknown depthTexture format")}function mt(T){const _=n.get(T),z=T.isWebGLCubeRenderTarget===!0;if(_.__boundDepthTexture!==T.depthTexture){const Q=T.depthTexture;if(_.__depthDisposeCallback&&_.__depthDisposeCallback(),Q){const et=()=>{delete _.__boundDepthTexture,delete _.__depthDisposeCallback,Q.removeEventListener("dispose",et)};Q.addEventListener("dispose",et),_.__depthDisposeCallback=et}_.__boundDepthTexture=Q}if(T.depthTexture&&!_.__autoAllocateDepthBuffer){if(z)throw new Error("target.depthTexture not supported in Cube render targets");ot(_.__webglFramebuffer,T)}else if(z){_.__webglDepthbuffer=[];for(let Q=0;Q<6;Q++)if(e.bindFramebuffer(r.FRAMEBUFFER,_.__webglFramebuffer[Q]),_.__webglDepthbuffer[Q]===void 0)_.__webglDepthbuffer[Q]=r.createRenderbuffer(),$(_.__webglDepthbuffer[Q],T,!1);else{const et=T.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT,J=_.__webglDepthbuffer[Q];r.bindRenderbuffer(r.RENDERBUFFER,J),r.framebufferRenderbuffer(r.FRAMEBUFFER,et,r.RENDERBUFFER,J)}}else if(e.bindFramebuffer(r.FRAMEBUFFER,_.__webglFramebuffer),_.__webglDepthbuffer===void 0)_.__webglDepthbuffer=r.createRenderbuffer(),$(_.__webglDepthbuffer,T,!1);else{const Q=T.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT,et=_.__webglDepthbuffer;r.bindRenderbuffer(r.RENDERBUFFER,et),r.framebufferRenderbuffer(r.FRAMEBUFFER,Q,r.RENDERBUFFER,et)}e.bindFramebuffer(r.FRAMEBUFFER,null)}function St(T,_,z){const Q=n.get(T);_!==void 0&&it(Q.__webglFramebuffer,T,T.texture,r.COLOR_ATTACHMENT0,r.TEXTURE_2D,0),z!==void 0&&mt(T)}function Lt(T){const _=T.texture,z=n.get(T),Q=n.get(_);T.addEventListener("dispose",w);const et=T.textures,J=T.isWebGLCubeRenderTarget===!0,Et=et.length>1;if(Et||(Q.__webglTexture===void 0&&(Q.__webglTexture=r.createTexture()),Q.__version=_.version,a.memory.textures++),J){z.__webglFramebuffer=[];for(let ut=0;ut<6;ut++)if(_.mipmaps&&_.mipmaps.length>0){z.__webglFramebuffer[ut]=[];for(let _t=0;_t<_.mipmaps.length;_t++)z.__webglFramebuffer[ut][_t]=r.createFramebuffer()}else z.__webglFramebuffer[ut]=r.createFramebuffer()}else{if(_.mipmaps&&_.mipmaps.length>0){z.__webglFramebuffer=[];for(let ut=0;ut<_.mipmaps.length;ut++)z.__webglFramebuffer[ut]=r.createFramebuffer()}else z.__webglFramebuffer=r.createFramebuffer();if(Et)for(let ut=0,_t=et.length;ut<_t;ut++){const Ht=n.get(et[ut]);Ht.__webglTexture===void 0&&(Ht.__webglTexture=r.createTexture(),a.memory.textures++)}if(T.samples>0&&It(T)===!1){z.__webglMultisampledFramebuffer=r.createFramebuffer(),z.__webglColorRenderbuffer=[],e.bindFramebuffer(r.FRAMEBUFFER,z.__webglMultisampledFramebuffer);for(let ut=0;ut<et.length;ut++){const _t=et[ut];z.__webglColorRenderbuffer[ut]=r.createRenderbuffer(),r.bindRenderbuffer(r.RENDERBUFFER,z.__webglColorRenderbuffer[ut]);const Ht=s.convert(_t.format,_t.colorSpace),st=s.convert(_t.type),vt=E(_t.internalFormat,Ht,st,_t.colorSpace,T.isXRRenderTarget===!0),Pt=Dt(T);r.renderbufferStorageMultisample(r.RENDERBUFFER,Pt,vt,T.width,T.height),r.framebufferRenderbuffer(r.FRAMEBUFFER,r.COLOR_ATTACHMENT0+ut,r.RENDERBUFFER,z.__webglColorRenderbuffer[ut])}r.bindRenderbuffer(r.RENDERBUFFER,null),T.depthBuffer&&(z.__webglDepthRenderbuffer=r.createRenderbuffer(),$(z.__webglDepthRenderbuffer,T,!0)),e.bindFramebuffer(r.FRAMEBUFFER,null)}}if(J){e.bindTexture(r.TEXTURE_CUBE_MAP,Q.__webglTexture),rt(r.TEXTURE_CUBE_MAP,_);for(let ut=0;ut<6;ut++)if(_.mipmaps&&_.mipmaps.length>0)for(let _t=0;_t<_.mipmaps.length;_t++)it(z.__webglFramebuffer[ut][_t],T,_,r.COLOR_ATTACHMENT0,r.TEXTURE_CUBE_MAP_POSITIVE_X+ut,_t);else it(z.__webglFramebuffer[ut],T,_,r.COLOR_ATTACHMENT0,r.TEXTURE_CUBE_MAP_POSITIVE_X+ut,0);p(_)&&f(r.TEXTURE_CUBE_MAP),e.unbindTexture()}else if(Et){for(let ut=0,_t=et.length;ut<_t;ut++){const Ht=et[ut],st=n.get(Ht);e.bindTexture(r.TEXTURE_2D,st.__webglTexture),rt(r.TEXTURE_2D,Ht),it(z.__webglFramebuffer,T,Ht,r.COLOR_ATTACHMENT0+ut,r.TEXTURE_2D,0),p(Ht)&&f(r.TEXTURE_2D)}e.unbindTexture()}else{let ut=r.TEXTURE_2D;if((T.isWebGL3DRenderTarget||T.isWebGLArrayRenderTarget)&&(ut=T.isWebGL3DRenderTarget?r.TEXTURE_3D:r.TEXTURE_2D_ARRAY),e.bindTexture(ut,Q.__webglTexture),rt(ut,_),_.mipmaps&&_.mipmaps.length>0)for(let _t=0;_t<_.mipmaps.length;_t++)it(z.__webglFramebuffer[_t],T,_,r.COLOR_ATTACHMENT0,ut,_t);else it(z.__webglFramebuffer,T,_,r.COLOR_ATTACHMENT0,ut,0);p(_)&&f(ut),e.unbindTexture()}T.depthBuffer&&mt(T)}function Ct(T){const _=T.textures;for(let z=0,Q=_.length;z<Q;z++){const et=_[z];if(p(et)){const J=A(T),Et=n.get(et).__webglTexture;e.bindTexture(J,Et),f(J),e.unbindTexture()}}}const Vt=[],P=[];function Qt(T){if(T.samples>0){if(It(T)===!1){const _=T.textures,z=T.width,Q=T.height;let et=r.COLOR_BUFFER_BIT;const J=T.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT,Et=n.get(T),ut=_.length>1;if(ut)for(let _t=0;_t<_.length;_t++)e.bindFramebuffer(r.FRAMEBUFFER,Et.__webglMultisampledFramebuffer),r.framebufferRenderbuffer(r.FRAMEBUFFER,r.COLOR_ATTACHMENT0+_t,r.RENDERBUFFER,null),e.bindFramebuffer(r.FRAMEBUFFER,Et.__webglFramebuffer),r.framebufferTexture2D(r.DRAW_FRAMEBUFFER,r.COLOR_ATTACHMENT0+_t,r.TEXTURE_2D,null,0);e.bindFramebuffer(r.READ_FRAMEBUFFER,Et.__webglMultisampledFramebuffer),e.bindFramebuffer(r.DRAW_FRAMEBUFFER,Et.__webglFramebuffer);for(let _t=0;_t<_.length;_t++){if(T.resolveDepthBuffer&&(T.depthBuffer&&(et|=r.DEPTH_BUFFER_BIT),T.stencilBuffer&&T.resolveStencilBuffer&&(et|=r.STENCIL_BUFFER_BIT)),ut){r.framebufferRenderbuffer(r.READ_FRAMEBUFFER,r.COLOR_ATTACHMENT0,r.RENDERBUFFER,Et.__webglColorRenderbuffer[_t]);const Ht=n.get(_[_t]).__webglTexture;r.framebufferTexture2D(r.DRAW_FRAMEBUFFER,r.COLOR_ATTACHMENT0,r.TEXTURE_2D,Ht,0)}r.blitFramebuffer(0,0,z,Q,0,0,z,Q,et,r.NEAREST),l===!0&&(Vt.length=0,P.length=0,Vt.push(r.COLOR_ATTACHMENT0+_t),T.depthBuffer&&T.resolveDepthBuffer===!1&&(Vt.push(J),P.push(J),r.invalidateFramebuffer(r.DRAW_FRAMEBUFFER,P)),r.invalidateFramebuffer(r.READ_FRAMEBUFFER,Vt))}if(e.bindFramebuffer(r.READ_FRAMEBUFFER,null),e.bindFramebuffer(r.DRAW_FRAMEBUFFER,null),ut)for(let _t=0;_t<_.length;_t++){e.bindFramebuffer(r.FRAMEBUFFER,Et.__webglMultisampledFramebuffer),r.framebufferRenderbuffer(r.FRAMEBUFFER,r.COLOR_ATTACHMENT0+_t,r.RENDERBUFFER,Et.__webglColorRenderbuffer[_t]);const Ht=n.get(_[_t]).__webglTexture;e.bindFramebuffer(r.FRAMEBUFFER,Et.__webglFramebuffer),r.framebufferTexture2D(r.DRAW_FRAMEBUFFER,r.COLOR_ATTACHMENT0+_t,r.TEXTURE_2D,Ht,0)}e.bindFramebuffer(r.DRAW_FRAMEBUFFER,Et.__webglMultisampledFramebuffer)}else if(T.depthBuffer&&T.resolveDepthBuffer===!1&&l){const _=T.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT;r.invalidateFramebuffer(r.DRAW_FRAMEBUFFER,[_])}}}function Dt(T){return Math.min(i.maxSamples,T.samples)}function It(T){const _=n.get(T);return T.samples>0&&t.has("WEBGL_multisampled_render_to_texture")===!0&&_.__useRenderToTexture!==!1}function yt(T){const _=a.render.frame;h.get(T)!==_&&(h.set(T,_),T.update())}function Xt(T,_){const z=T.colorSpace,Q=T.format,et=T.type;return T.isCompressedTexture===!0||T.isVideoTexture===!0||z!==mi&&z!==_n&&(Yt.getTransfer(z)===Jt?(Q!==He||et!==on)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",z)),_}function Mt(T){return typeof HTMLImageElement<"u"&&T instanceof HTMLImageElement?(c.width=T.naturalWidth||T.width,c.height=T.naturalHeight||T.height):typeof VideoFrame<"u"&&T instanceof VideoFrame?(c.width=T.displayWidth,c.height=T.displayHeight):(c.width=T.width,c.height=T.height),c}this.allocateTextureUnit=V,this.resetTextureUnits=k,this.setTexture2D=j,this.setTexture2DArray=Z,this.setTexture3D=nt,this.setTextureCube=W,this.rebindTextures=St,this.setupRenderTarget=Lt,this.updateRenderTargetMipmap=Ct,this.updateMultisampleRenderTarget=Qt,this.setupDepthRenderbuffer=mt,this.setupFrameBufferTexture=it,this.useMultisampledRTT=It}function Sp(r,t){function e(n,i=_n){let s;const a=Yt.getTransfer(i);if(n===on)return r.UNSIGNED_BYTE;if(n===oa)return r.UNSIGNED_SHORT_4_4_4_4;if(n===la)return r.UNSIGNED_SHORT_5_5_5_1;if(n===ko)return r.UNSIGNED_INT_5_9_9_9_REV;if(n===Vo)return r.BYTE;if(n===Ho)return r.SHORT;if(n===Oi)return r.UNSIGNED_SHORT;if(n===aa)return r.INT;if(n===Bn)return r.UNSIGNED_INT;if(n===nn)return r.FLOAT;if(n===Vi)return r.HALF_FLOAT;if(n===Wo)return r.ALPHA;if(n===Xo)return r.RGB;if(n===He)return r.RGBA;if(n===Yo)return r.LUMINANCE;if(n===qo)return r.LUMINANCE_ALPHA;if(n===oi)return r.DEPTH_COMPONENT;if(n===fi)return r.DEPTH_STENCIL;if(n===$o)return r.RED;if(n===ca)return r.RED_INTEGER;if(n===Zo)return r.RG;if(n===ha)return r.RG_INTEGER;if(n===ua)return r.RGBA_INTEGER;if(n===_r||n===vr||n===xr||n===Mr)if(a===Jt)if(s=t.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(n===_r)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===vr)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===xr)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===Mr)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=t.get("WEBGL_compressed_texture_s3tc"),s!==null){if(n===_r)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===vr)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===xr)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===Mr)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===Rs||n===Ps||n===Ls||n===Ds)if(s=t.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(n===Rs)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===Ps)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===Ls)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===Ds)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===Is||n===Us||n===Ns)if(s=t.get("WEBGL_compressed_texture_etc"),s!==null){if(n===Is||n===Us)return a===Jt?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(n===Ns)return a===Jt?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(n===Fs||n===Os||n===Bs||n===zs||n===Gs||n===Vs||n===Hs||n===ks||n===Ws||n===Xs||n===Ys||n===qs||n===$s||n===Zs)if(s=t.get("WEBGL_compressed_texture_astc"),s!==null){if(n===Fs)return a===Jt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===Os)return a===Jt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===Bs)return a===Jt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===zs)return a===Jt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===Gs)return a===Jt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===Vs)return a===Jt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===Hs)return a===Jt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===ks)return a===Jt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===Ws)return a===Jt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===Xs)return a===Jt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===Ys)return a===Jt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===qs)return a===Jt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===$s)return a===Jt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===Zs)return a===Jt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===Sr||n===Ks||n===Js)if(s=t.get("EXT_texture_compression_bptc"),s!==null){if(n===Sr)return a===Jt?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===Ks)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===Js)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===Ko||n===js||n===Qs||n===ta)if(s=t.get("EXT_texture_compression_rgtc"),s!==null){if(n===Sr)return s.COMPRESSED_RED_RGTC1_EXT;if(n===js)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===Qs)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===ta)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===di?r.UNSIGNED_INT_24_8:r[n]!==void 0?r[n]:null}return{convert:e}}class yp extends De{constructor(t=[]){super(),this.isArrayCamera=!0,this.cameras=t}}class On extends fe{constructor(){super(),this.isGroup=!0,this.type="Group"}}const Ep={type:"move"};class os{constructor(){this._targetRay=null,this._grip=null,this._hand=null}getHandSpace(){return this._hand===null&&(this._hand=new On,this._hand.matrixAutoUpdate=!1,this._hand.visible=!1,this._hand.joints={},this._hand.inputState={pinching:!1}),this._hand}getTargetRaySpace(){return this._targetRay===null&&(this._targetRay=new On,this._targetRay.matrixAutoUpdate=!1,this._targetRay.visible=!1,this._targetRay.hasLinearVelocity=!1,this._targetRay.linearVelocity=new U,this._targetRay.hasAngularVelocity=!1,this._targetRay.angularVelocity=new U),this._targetRay}getGripSpace(){return this._grip===null&&(this._grip=new On,this._grip.matrixAutoUpdate=!1,this._grip.visible=!1,this._grip.hasLinearVelocity=!1,this._grip.linearVelocity=new U,this._grip.hasAngularVelocity=!1,this._grip.angularVelocity=new U),this._grip}dispatchEvent(t){return this._targetRay!==null&&this._targetRay.dispatchEvent(t),this._grip!==null&&this._grip.dispatchEvent(t),this._hand!==null&&this._hand.dispatchEvent(t),this}connect(t){if(t&&t.hand){const e=this._hand;if(e)for(const n of t.hand.values())this._getHandJoint(e,n)}return this.dispatchEvent({type:"connected",data:t}),this}disconnect(t){return this.dispatchEvent({type:"disconnected",data:t}),this._targetRay!==null&&(this._targetRay.visible=!1),this._grip!==null&&(this._grip.visible=!1),this._hand!==null&&(this._hand.visible=!1),this}update(t,e,n){let i=null,s=null,a=null;const o=this._targetRay,l=this._grip,c=this._hand;if(t&&e.session.visibilityState!=="visible-blurred"){if(c&&t.hand){a=!0;for(const v of t.hand.values()){const p=e.getJointPose(v,n),f=this._getHandJoint(c,v);p!==null&&(f.matrix.fromArray(p.transform.matrix),f.matrix.decompose(f.position,f.rotation,f.scale),f.matrixWorldNeedsUpdate=!0,f.jointRadius=p.radius),f.visible=p!==null}const h=c.joints["index-finger-tip"],u=c.joints["thumb-tip"],d=h.position.distanceTo(u.position),m=.02,g=.005;c.inputState.pinching&&d>m+g?(c.inputState.pinching=!1,this.dispatchEvent({type:"pinchend",handedness:t.handedness,target:this})):!c.inputState.pinching&&d<=m-g&&(c.inputState.pinching=!0,this.dispatchEvent({type:"pinchstart",handedness:t.handedness,target:this}))}else l!==null&&t.gripSpace&&(s=e.getPose(t.gripSpace,n),s!==null&&(l.matrix.fromArray(s.transform.matrix),l.matrix.decompose(l.position,l.rotation,l.scale),l.matrixWorldNeedsUpdate=!0,s.linearVelocity?(l.hasLinearVelocity=!0,l.linearVelocity.copy(s.linearVelocity)):l.hasLinearVelocity=!1,s.angularVelocity?(l.hasAngularVelocity=!0,l.angularVelocity.copy(s.angularVelocity)):l.hasAngularVelocity=!1));o!==null&&(i=e.getPose(t.targetRaySpace,n),i===null&&s!==null&&(i=s),i!==null&&(o.matrix.fromArray(i.transform.matrix),o.matrix.decompose(o.position,o.rotation,o.scale),o.matrixWorldNeedsUpdate=!0,i.linearVelocity?(o.hasLinearVelocity=!0,o.linearVelocity.copy(i.linearVelocity)):o.hasLinearVelocity=!1,i.angularVelocity?(o.hasAngularVelocity=!0,o.angularVelocity.copy(i.angularVelocity)):o.hasAngularVelocity=!1,this.dispatchEvent(Ep)))}return o!==null&&(o.visible=i!==null),l!==null&&(l.visible=s!==null),c!==null&&(c.visible=a!==null),this}_getHandJoint(t,e){if(t.joints[e.jointName]===void 0){const n=new On;n.matrixAutoUpdate=!1,n.visible=!1,t.joints[e.jointName]=n,t.add(n)}return t.joints[e.jointName]}}const Tp=`
void main() {
...
}`;class Ap{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(t,e,n){if(this.texture===null){const i=new Se,s=t.properties.get(i);s.__webglTexture=e.texture,(e.depthNear!=n.depthNear||e.depthFar!=n.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=i}}getMesh(t){if(this.texture!==null&&this.mesh===null){const e=t.cameras[0].viewport,n=new yn({vertexShader:Tp,fragmentShader:bp,uniforms:{depthColor:{value:this.texture},depthWidth:{value:e.z},depthHeight:{value:e.w}}});this.mesh=new de(new Rr(20,20),n)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class wp extends gi{constructor(t,e){super();const n=this;let i=null,s=1,a=null,o="local-floor",l=1,c=null,h=null,u=null,d=null,m=null,g=null;const v=new Ap,p=e.getContextAttributes();let f=null,A=null;const E=[],S=[],R=new wt;let b=null;const w=new De;w.viewport=new ae;const I=new De;I.viewport=new ae;const y=[w,I],M=new yp;let D=null,k=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(B){let Y=E[B];return Y===void 0&&(Y=new os,E[B]=Y),Y.getTargetRaySpace()},this.getControllerGrip=function(B){let Y=E[B];return Y===void 0&&(Y=new os,E[B]=Y),Y.getGripSpace()},this.getHand=function(B){let Y=E[B];return Y===void 0&&(Y=new os,E[B]=Y),Y.getHandSpace()};function V(B){const Y=S.indexOf(B.inputSource);if(Y===-1)return;const it=E[Y];it!==void 0&&(it.update(B.inputSource,B.frame,c||a),it.dispatchEvent({type:B.type,data:B.inputSource}))}function K(){i.removeEventListener("select",V),i.removeEventListener("selectstart",V),i.removeEventListener("selectend",V),i.removeEventListener("squeeze",V),i.removeEventListener("squeezestart",V),i.removeEventListener("squeezeend",V),i.removeEventListener("end",K),i.removeEventListener("inputsourceschange",j);for(let B=0;B<E.length;B++){const Y=S[B];Y!==null&&(S[B]=null,E[B].disconnect(Y))}D=null,k=null,v.reset(),t.setRenderTarget(f),m=null,d=null,u=null,i=null,A=null,ht.stop(),n.isPresenting=!1,t.setPixelRatio(b),t.setSize(R.width,R.height,!1),n.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(B){s=B,n.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(B){o=B,n.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return c||a},this.setReferenceSpace=function(B){c=B},this.getBaseLayer=function(){return d!==null?d:m},this.getBinding=function(){return u},this.getFrame=function(){return g},this.getSession=function(){return i},this.setSession=async function(B){if(i=B,i!==null){if(f=t.getRenderTarget(),i.addEventListener("select",V),i.addEventListener("selectstart",V),i.addEventListener("selectend",V),i.addEventListener("squeeze",V),i.addEventListener("squeezestart",V),i.addEventListener("squeezeend",V),i.addEventListener("end",K),i.addEventListener("inputsourceschange",j),p.xrCompatible!==!0&&await e.makeXRCompatible(),b=t.getPixelRatio(),t.getSize(R),i.renderState.layers===void 0){const Y={antialias:p.antialias,alpha:!0,depth:p.depth,stencil:p.stencil,framebufferScaleFactor:s};m=new XRWebGLLayer(i,e,Y),i.updateRenderState({baseLayer:m}),t.setPixelRatio(1),t.setSize(m.framebufferWidth,m.framebufferHeight,!1),A=new zn(m.framebufferWidth,m.framebufferHeight,{format:He,type:on,colorSpace:t.outputColorSpace,stencilBuffer:p.stencil})}else{let Y=null,it=null,$=null;p.depth&&($=p.stencil?e.DEPTH24_STENCIL8:e.DEPTH_COMPONENT24,Y=p.stencil?fi:oi,it=p.stencil?di:Bn);const ot={colorFormat:e.RGBA8,depthFormat:$,scaleFactor:s};u=new XRWebGLBinding(i,e),d=u.createProjectionLayer(ot),i.updateRenderState({layers:[d]}),t.setPixelRatio(1),t.setSize(d.textureWidth,d.textureHeight,!1),A=new zn(d.textureWidth,d.textureHeight,{format:He,type:on,depthTexture:new ul(d.textureWidth,d.textureHeight,it,void 0,void 0,void 0,void 0,void 0,void 0,Y),stencilBuffer:p.stencil,colorSpace:t.outputColorSpace,samples:p.antialias?4:0,resolveDepthBuffer:d.ignoreDepthValues===!1})}A.isXRRenderTarget=!0,this.setFoveation(l),c=null,a=await i.requestReferenceSpace(o),ht.setContext(i),ht.start(),n.isPresenting=!0,n.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(i!==null)return i.environmentBlendMode},this.getDepthTexture=function(){return v.getDepthTexture()};function j(B){for(let Y=0;Y<B.removed.length;Y++){const it=B.removed[Y],$=S.indexOf(it);$>=0&&(S[$]=null,E[$].disconnect(it))}for(let Y=0;Y<B.added.length;Y++){const it=B.added[Y];let $=S.indexOf(it);if($===-1){for(let mt=0;mt<E.length;mt++)if(mt>=S.length){S.push(it),$=mt;break}else if(S[mt]===null){S[mt]=it,$=mt;break}if($===-1)break}const ot=E[$];ot&&ot.connect(it)}}const Z=new U,nt=new U;function W(B,Y,it){Z.setFromMatrixPosition(Y.matrixWorld),nt.setFromMatrixPosition(it.matrixWorld);const $=Z.distanceTo(nt),ot=Y.projectionMatrix.elements,mt=it.projectionMatrix.elements,St=ot[14]/(ot[10]-1),Lt=ot[14]/(ot[10]+1),Ct=(ot[9]+1)/ot[5],Vt=(ot[9]-1)/ot[5],P=(ot[8]-1)/ot[0],Qt=(mt[8]+1)/mt[0],Dt=St*P,It=St*Qt,yt=$/(-P+Qt),Xt=yt*-P;if(Y.matrixWorld.decompose(B.position,B.quaternion,B.scale),B.translateX(Xt),B.translateZ(yt),B.matrixWorld.compose(B.position,B.quaternion,B.scale),B.matrixWorldInverse.copy(B.matrixWorld).invert(),ot[10]===-1)B.projectionMatrix.copy(Y.projectionMatrix),B.projectionMatrixInverse.copy(Y.projectionMatrixInverse);else{const Mt=St+yt,T=Lt+yt,_=Dt-Xt,z=It+($-Xt),Q=Ct*Lt/T*Mt,et=Vt*Lt/T*Mt;B.projectionMatrix.makePerspective(_,z,Q,et,Mt,T),B.projectionMatrixInverse.copy(B.projectionMatrix).invert()}}function ct(B,Y){Y===null?B.matrixWorld.copy(B.matrix):B.matrixWorld.multiplyMatrices(Y.matrixWorld,B.matrix),B.matrixWorldInverse.copy(B.matrixWorld).invert()}this.updateCamera=function(B){if(i===null)return;let Y=B.near,it=B.far;v.texture!==null&&(v.depthNear>0&&(Y=v.depthNear),v.depthFar>0&&(it=v.depthFar)),M.near=I.near=w.near=Y,M.far=I.far=w.far=it,(D!==M.near||k!==M.far)&&(i.updateRenderState({depthNear:M.near,depthFar:M.far}),D=M.near,k=M.far),w.layers.mask=B.layers.mask|2,I.layers.mask=B.layers.mask|4,M.layers.mask=w.layers.mask|I.layers.mask;const $=B.parent,ot=M.cameras;ct(M,$);for(let mt=0;mt<ot.length;mt++)ct(ot[mt],$);ot.length===2?W(M,w,I):M.projectionMatrix.copy(w.projectionMatrix),L(B,M,$)};function L(B,Y,it){it===null?B.matrix.copy(Y.matrixWorld):(B.matrix.copy(it.matrixWorld),B.matrix.invert(),B.matrix.multiply(Y.matrixWorld)),B.matrix.decompose(B.position,B.quaternion,B.scale),B.updateMatrixWorld(!0),B.projectionMatrix.copy(Y.projectionMatrix),B.projectionMatrixInverse.copy(Y.projectionMatrixInverse),B.isPerspectiveCamera&&(B.fov=na*2*Math.atan(1/B.projectionMatrix.elements[5]),B.zoom=1)}this.getCamera=function(){return M},this.getFoveation=function(){if(!(d===null&&m===null))return l},this.setFoveation=function(B){l=B,d!==null&&(d.fixedFoveation=B),m!==null&&m.fixedFoveation!==void 0&&(m.fixedFoveation=B)},this.hasDepthSensing=function(){return v.texture!==null},this.getDepthSensingMesh=function(){return v.getMesh(M)};let C=null;function rt(B,Y){if(h=Y.getViewerPose(c||a),g=Y,h!==null){const it=h.views;m!==null&&(t.setRenderTargetFramebuffer(A,m.framebuffer),t.setRenderTarget(A));let $=!1;it.length!==M.cameras.length&&(M.cameras.length=0,$=!0);for(let mt=0;mt<it.length;mt++){const St=it[mt];let Lt=null;if(m!==null)Lt=m.getViewport(St);else{const Vt=u.getViewSubImage(d,St);Lt=Vt.viewport,mt===0&&(t.setRenderTargetTextures(A,Vt.colorTexture,d.ignoreDepthValues?void 0:Vt.depthStencilTexture),t.setRenderTarget(A))}let Ct=y[mt];Ct===void 0&&(Ct=new De,Ct.layers.enable(mt),Ct.viewport=new ae,y[mt]=Ct),Ct.matrix.fromArray(St.transform.matrix),Ct.matrix.decompose(Ct.position,Ct.quaternion,Ct.scale),Ct.projectionMatrix.fromArray(St.projectionMatrix),Ct.projectionMatrixInverse.copy(Ct.projectionMatrix).invert(),Ct.viewport.set(Lt.x,Lt.y,Lt.width,Lt.height),mt===0&&(M.matrix.copy(Ct.matrix),M.matrix.decompose(M.position,M.quaternion,M.scale)),$===!0&&M.cameras.push(Ct)}const ot=i.enabledFeatures;if(ot&&ot.includes("depth-sensing")){const mt=u.getDepthInformation(it[0]);mt&&mt.isValid&&mt.texture&&v.init(t,mt,i.renderState)}}for(let it=0;it<E.length;it++){const $=S[it],ot=E[it];$!==null&&ot!==void 0&&ot.update($,Y,c||a)}C&&C(B,Y),Y.detectedPlanes&&n.dispatchEvent({type:"planesdetected",data:Y}),g=null}const ht=new cl;ht.setAnimationLoop(rt),this.setAnimationLoop=function(B){C=B},this.dispose=function(){}}}const Rn=new qe,Cp=new re;function Rp(r,t){function e(p,f){p.matrixAutoUpdate===!0&&p.updateMatrix(),f.value.copy(p.matrix)}function n(p,f){f.color.getRGB(p.fogColor.value,al(r)),f.isFog?(p.fogNear.value=f.near,p.fogFar.value=f.far):f.isFogExp2&&(p.fogDensity.value=f.density)}function i(p,f,A,E,S){f.isMeshBasicMaterial||f.isMeshLambertMaterial?s(p,f):f.isMeshToonMaterial?(s(p,f),u(p,f)):f.isMeshPhongMaterial?(s(p,f),h(p,f)):f.isMeshStandardMaterial?(s(p,f),d(p,f),f.isMeshPhysicalMaterial&&m(p,f,S)):f.isMeshMatcapMaterial?(s(p,f),g(p,f)):f.isMeshDepthMaterial?s(p,f):f.isMeshDistanceMaterial?(s(p,f),v(p,f)):f.isMeshNormalMaterial?s(p,f):f.isLineBasicMaterial?(a(p,f),f.isLineDashedMaterial&&o(p,f)):f.isPointsMaterial?l(p,f,A,E):f.isSpriteMaterial?c(p,f):f.isShadowMaterial?(p.color.value.copy(f.color),p.opacity.value=f.opacity):f.isShaderMaterial&&(f.uniformsNeedUpdate=!1)}function s(p,f){p.opacity.value=f.opacity,f.color&&p.diffuse.value.copy(f.color),f.emissive&&p.emissive.value.copy(f.emissive).multiplyScalar(f.emissiveIntensity),f.map&&(p.map.value=f.map,e(f.map,p.mapTransform)),f.alphaMap&&(p.alphaMap.value=f.alphaMap,e(f.alphaMap,p.alphaMapTransform)),f.bumpMap&&(p.bumpMap.value=f.bumpMap,e(f.bumpMap,p.bumpMapTransform),p.bumpScale.value=f.bumpScale,f.side===Ee&&(p.bumpScale.value*=-1)),f.normalMap&&(p.normalMap.value=f.normalMap,e(f.normalMap,p.normalMapTransform),p.normalScale.value.copy(f.normalScale),f.side===Ee&&p.normalScale.value.negate()),f.displacementMap&&(p.displacementMap.value=f.displacementMap,e(f.displacementMap,p.displacementMapTransform),p.displacementScale.value=f.displacementScale,p.displacementBias.value=f.displacementBias),f.emissiveMap&&(p.emissiveMap.value=f.emissiveMap,e(f.emissiveMap,p.emissiveMapTransform)),f.specularMap&&(p.specularMap.value=f.specularMap,e(f.specularMap,p.specularMapTransform)),f.alphaTest>0&&(p.alphaTest.value=f.alphaTest);const A=t.get(f),E=A.envMap,S=A.envMapRotation;E&&(p.envMap.value=E,Rn.copy(S),Rn.x*=-1,Rn.y*=-1,Rn.z*=-1,E.isCubeTexture&&E.isRenderTargetTexture===!1&&(Rn.y*=-1,Rn.z*=-1),p.envMapRotation.value.setFromMatrix4(Cp.makeRotationFromEuler(Rn)),p.flipEnvMap.value=E.isCubeTexture&&E.isRenderTargetTexture===!1?-1:1,p.reflectivity.value=f.reflectivity,p.ior.value=f.ior,p.refractionRatio.value=f.refractionRatio),f.lightMap&&(p.lightMap.value=f.lightMap,p.lightMapIntensity.value=f.lightMapIntensity,e(f.lightMap,p.lightMapTransform)),f.aoMap&&(p.aoMap.value=f.aoMap,p.aoMapIntensity.value=f.aoMapIntensity,e(f.aoMap,p.aoMapTransform))}function a(p,f){p.diffuse.value.copy(f.color),p.opacity.value=f.opacity,f.map&&(p.map.value=f.map,e(f.map,p.mapTransform))}function o(p,f){p.dashSize.value=f.dashSize,p.totalSize.value=f.dashSize+f.gapSize,p.scale.value=f.scale}function l(p,f,A,E){p.diffuse.value.copy(f.color),p.opacity.value=f.opacity,p.size.value=f.size*A,p.scale.value=E*.5,f.map&&(p.map.value=f.map,e(f.map,p.uvTransform)),f.alphaMap&&(p.alphaMap.value=f.alphaMap,e(f.alphaMap,p.alphaMapTransform)),f.alphaTest>0&&(p.alphaTest.value=f.alphaTest)}function c(p,f){p.diffuse.value.copy(f.color),p.opacity.value=f.opacity,p.rotation.value=f.rotation,f.map&&(p.map.value=f.map,e(f.map,p.mapTransform)),f.alphaMap&&(p.alphaMap.value=f.alphaMap,e(f.alphaMap,p.alphaMapTransform)),f.alphaTest>0&&(p.alphaTest.value=f.alphaTest)}function h(p,f){p.specular.value.copy(f.specular),p.shininess.value=Math.max(f.shininess,1e-4)}function u(p,f){f.gradientMap&&(p.gradientMap.value=f.gradientMap)}function d(p,f){p.metalness.value=f.metalness,f.metalnessMap&&(p.metalnessMap.value=f.metalnessMap,e(f.metalnessMap,p.metalnessMapTransform)),p.roughness.value=f.roughness,f.roughnessMap&&(p.roughnessMap.value=f.roughnessMap,e(f.roughnessMap,p.roughnessMapTransform)),f.envMap&&(p.envMapIntensity.value=f.envMapIntensity)}function m(p,f,A){p.ior.value=f.ior,f.sheen>0&&(p.sheenColor.value.copy(f.sheenColor).multiplyScalar(f.sheen),p.sheenRoughness.value=f.sheenRoughness,f.sheenColorMap&&(p.sheenColorMap.value=f.sheenColorMap,e(f.sheenColorMap,p.sheenColorMapTransform)),f.sheenRoughnessMap&&(p.sheenRoughnessMap.value=f.sheenRoughnessMap,e(f.sheenRoughnessMap,p.sheenRoughnessMapTransform))),f.clearcoat>0&&(p.clearcoat.value=f.clearcoat,p.clearcoatRoughness.value=f.clearcoatRoughness,f.clearcoatMap&&(p.clearcoatMap.value=f.clearcoatMap,e(f.clearcoatMap,p.clearcoatMapTransform)),f.clearcoatRoughnessMap&&(p.clearcoatRoughnessMap.value=f.clearcoatRoughnessMap,e(f.clearcoatRoughnessMap,p.clearcoatRoughnessMapTransform)),f.clearcoatNormalMap&&(p.clearcoatNormalMap.value=f.clearcoatNormalMap,e(f.clearcoatNormalMap,p.clearcoatNormalMapTransform),p.clearcoatNormalScale.value.copy(f.clearcoatNormalScale),f.side===Ee&&p.clearcoatNormalScale.value.negate())),f.dispersion>0&&(p.dispersion.value=f.dispersion),f.iridescence>0&&(p.iridescence.value=f.iridescence,p.iridescenceIOR.value=f.iridescenceIOR,p.iridescenceThicknessMinimum.value=f.iridescenceThicknessRange[0],p.iridescenceThicknessMaximum.value=f.iridescenceThicknessRange[1],f.iridescenceMap&&(p.iridescenceMap.value=f.iridescenceMap,e(f.iridescenceMap,p.iridescenceMapTransform)),f.iridescenceThicknessMap&&(p.iridescenceThicknessMap.value=f.iridescenceThicknessMap,e(f.iridescenceThicknessMap,p.iridescenceThicknessMapTransform))),f.transmission>0&&(p.transmission.value=f.transmission,p.transmissionSamplerMap.value=A.texture,p.transmissionSamplerSize.value.set(A.width,A.height),f.transmissionMap&&(p.transmissionMap.value=f.transmissionMap,e(f.transmissionMap,p.transmissionMapTransform)),p.thickness.value=f.thickness,f.thicknessMap&&(p.thicknessMap.value=f.thicknessMap,e(f.thicknessMap,p.thicknessMapTransform)),p.attenuationDistance.value=f.attenuationDistance,p.attenuationColor.value.copy(f.attenuationColor)),f.anisotropy>0&&(p.anisotropyVector.value.set(f.anisotropy*Math.cos(f.anisotropyRotation),f.anisotropy*Math.sin(f.anisotropyRotation)),f.anisotropyMap&&(p.anisotropyMap.value=f.anisotropyMap,e(f.anisotropyMap,p.anisotropyMapTransform))),p.specularIntensity.value=f.specularIntensity,p.specularColor.value.copy(f.specularColor),f.specularColorMap&&(p.specularColorMap.value=f.specularColorMap,e(f.specularColorMap,p.specularColorMapTransform)),f.specularIntensityMap&&(p.specularIntensityMap.value=f.specularIntensityMap,e(f.specularIntensityMap,p.specularIntensityMapTransform))}function g(p,f){f.matcap&&(p.matcap.value=f.matcap)}function v(p,f){const A=t.get(f).light;p.referencePosition.value.setFromMatrixPosition(A.matrixWorld),p.nearDistance.value=A.shadow.camera.near,p.farDistance.value=A.shadow.camera.far}return{refreshFogUniforms:n,refreshMaterialUniforms:i}}function Pp(r,t,e,n){let i={},s={},a=[];const o=r.getParameter(r.MAX_UNIFORM_BUFFER_BINDINGS);function l(A,E){const S=E.program;n.uniformBlockBinding(A,S)}function c(A,E){let S=i[A.id];S===void 0&&(g(A),S=h(A),i[A.id]=S,A.addEventListener("dispose",p));const R=E.program;n.updateUBOMapping(A,R);const b=t.render.frame;s[A.id]!==b&&(d(A),s[A.id]=b)}function h(A){const E=u();A.__bindingPointIndex=E;const S=r.createBuffer(),R=A.__size,b=A.usage;return r.bindBuffer(r.UNIFORM_BUFFER,S),r.bufferData(r.UNIFORM_BUFFER,R,b),r.bindBuffer(r.UNIFORM_BUFFER,null),r.bindBufferBase(r.UNIFORM_BUFFER,E,S),S}function u(){for(let A=0;A<o;A++)if(a.indexOf(A)===-1)return a.push(A),A;return console.error("THREE.WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function d(A){const E=i[A.id],S=A.uniforms,R=A.__cache;r.bindBuffer(r.UNIFORM_BUFFER,E);for(let b=0,w=S.length;b<w;b++){const I=Array.isArray(S[b])?S[b]:[S[b]];for(let y=0,M=I.length;y<M;y++){const D=I[y];if(m(D,b,y,R)===!0){const k=D.__offset,V=Array.isArray(D.value)?D.value:[D.value];let K=0;for(let j=0;j<V.length;j++){const Z=V[j],nt=v(Z);typeof Z=="number"||typeof Z=="boolean"?(D.__data[0]=Z,r.bufferSubData(r.UNIFORM_BUFFER,k+K,D.__data)):Z.isMatrix3?(D.__data[0]=Z.elements[0],D.__data[1]=Z.elements[1],D.__data[2]=Z.elements[2],D.__data[3]=0,D.__data[4]=Z.elements[3],D.__data[5]=Z.elements[4],D.__data[6]=Z.elements[5],D.__data[7]=0,D.__data[8]=Z.elements[6],D.__data[9]=Z.elements[7],D.__data[10]=Z.elements[8],D.__data[11]=0):(Z.toArray(D.__data,K),K+=nt.storage/Float32Array.BYTES_PER_ELEMENT)}r.bufferSubData(r.UNIFORM_BUFFER,k,D.__data)}}}r.bindBuffer(r.UNIFORM_BUFFER,null)}function m(A,E,S,R){const b=A.value,w=E+"_"+S;if(R[w]===void 0)return typeof b=="number"||typeof b=="boolean"?R[w]=b:R[w]=b.clone(),!0;{const I=R[w];if(typeof b=="number"||typeof b=="boolean"){if(I!==b)return R[w]=b,!0}else if(I.equals(b)===!1)return I.copy(b),!0}return!1}function g(A){const E=A.uniforms;let S=0;const R=16;for(let w=0,I=E.length;w<I;w++){const y=Array.isArray(E[w])?E[w]:[E[w]];for(let M=0,D=y.length;M<D;M++){const k=y[M],V=Array.isArray(k.value)?k.value:[k.value];for(let K=0,j=V.length;K<j;K++){const Z=V[K],nt=v(Z),W=S%R,ct=W%nt.boundary,L=W+ct;S+=ct,L!==0&&R-L<nt.storage&&(S+=R-L),k.__data=new Float32Array(nt.storage/Float32Array.BYTES_PER_ELEMENT),k.__offset=S,S+=nt.storage}}}const b=S%R;return b>0&&(S+=R-b),A.__size=S,A.__cache={},this}function v(A){const E={boundary:0,storage:0};return typeof A=="number"||typeof A=="boolean"?(E.boundary=4,E.storage=4):A.isVector2?(E.boundary=8,E.storage=8):A.isVector3||A.isColor?(E.boundary=16,E.storage=12):A.isVector4?(E.boundary=16,E.storage=16):A.isMatrix3?(E.boundary=48,E.storage=48):A.isMatrix4?(E.boundary=64,E.storage=64):A.isTexture?console.warn("THREE.WebGLRenderer: Texture samplers can not be part of an uniforms group."):console.warn("THREE.WebGLRenderer: Unsupported uniform value type.",A),E}function p(A){const E=A.target;E.removeEventListener("dispose",p);const S=a.indexOf(E.__bindingPointIndex);a.splice(S,1),r.deleteBuffer(i[E.id]),delete i[E.id],delete s[E.id]}function f(){for(const A in i)r.deleteBuffer(i[A]);a=[],i={},s={}}return{bind:l,update:c,dispose:f}}class Lp{constructor(t={}){const{canvas:e=vc(),context:n=null,depth:i=!0,stencil:s=!1,alpha:a=!1,antialias:o=!1,premultipliedAlpha:l=!0,preserveDrawingBuffer:c=!1,powerPreference:h="default",failIfMajorPerformanceCaveat:u=!1,reverseDepthBuffer:d=!1}=t;this.isWebGLRenderer=!0;let m;if(n!==null){if(typeof WebGLRenderingContext<"u"&&n instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");m=n.getContextAttributes().alpha}else m=a;const g=new Uint32Array(4),v=new Int32Array(4);let p=null,f=null;const A=[],E=[];this.domElement=e,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this._outputColorSpace=Pe,this.toneMapping=xn,this.toneMappingExposure=1;const S=this;let R=!1,b=0,w=0,I=null,y=-1,M=null;const D=new ae,k=new ae;let V=null;const K=new kt(0);let j=0,Z=e.width,nt=e.height,W=1,ct=null,L=null;const C=new ae(0,0,Z,nt),rt=new ae(0,0,Z,nt);let ht=!1;const B=new pa;let Y=!1,it=!1;const $=new re,ot=new re,mt=new U,St=new ae,Lt={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let Ct=!1;function Vt(){return I===null?W:1}let P=n;function Qt(x,F){return e.getContext(x,F)}try{const x={alpha:!0,depth:i,stencil:s,antialias:o,premultipliedAlpha:l,preserveDrawingBuffer:c,powerPreference:h,failIfMajorPerformanceCaveat:u};if("setAttribute"in e&&e.setAttribute("data-engine",`three.js r${sa}`),e.addEventListener("webglcontextlost",tt,!1),e.addEventListener("webglcontextrestored",gt,!1),e.addEventListener("webglcontextcreationerror",ft,!1),P===null){const F="webgl2";if(P=Qt(F,x),P===null)throw Qt(F)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(x){throw console.error("THREE.WebGLRenderer: "+x.message),x}let Dt,It,yt,Xt,Mt,T,_,z,Q,et,J,Et,ut,_t,Ht,st,vt,Pt,Ut,xt,Wt,zt,te,N;function dt(){Dt=new Nd(P),Dt.init(),zt=new Sp(P,Dt),It=new Rd(P,Dt,t,zt),yt=new vp(P,Dt),It.reverseDepthBuffer&&d&&yt.buffers.depth.setReversed(!0),Xt=new Bd(P),Mt=new ip,T=new Mp(P,Dt,yt,Mt,It,zt,Xt),_=new Ld(S),z=new Ud(S),Q=new Xc(P),te=new wd(P,Q),et=new Fd(P,Q,Xt,te),J=new Gd(P,et,Q,Xt),Ut=new zd(P,It,T),st=new Pd(Mt),Et=new np(S,_,z,Dt,It,te,st),ut=new Rp(S,Mt),_t=new sp,Ht=new up(Dt),Pt=new Ad(S,_,z,yt,J,m,l),vt=new gp(S,J,It),N=new Pp(P,Xt,It,yt),xt=new Cd(P,Dt,Xt),Wt=new Od(P,Dt,Xt),Xt.programs=Et.programs,S.capabilities=It,S.extensions=Dt,S.properties=Mt,S.renderLists=_t,S.shadowMap=vt,S.state=yt,S.info=Xt}dt();const X=new wp(S,P);this.xr=X,this.getContext=function(){return P},this.getContextAttributes=function(){return P.getContextAttributes()},this.forceContextLoss=function(){const x=Dt.get("WEBGL_lose_context");x&&x.loseContext()},this.forceContextRestore=function(){const x=Dt.get("WEBGL_lose_context");x&&x.restoreContext()},this.getPixelRatio=function(){return W},this.setPixelRatio=function(x){x!==void 0&&(W=x,this.setSize(Z,nt,!1))},this.getSize=function(x){return x.set(Z,nt)},this.setSize=function(x,F,G=!0){if(X.isPresenting){console.warn("THREE.WebGLRenderer: Can't change size while VR device is presenting.");return}Z=x,nt=F,e.width=Math.floor(x*W),e.height=Math.floor(F*W),G===!0&&(e.style.width=x+"px",e.style.height=F+"px"),this.setViewport(0,0,x,F)},this.getDrawingBufferSize=function(x){return x.set(Z*W,nt*W).floor()},this.setDrawingBufferSize=function(x,F,G){Z=x,nt=F,W=G,e.width=Math.floor(x*G),e.height=Math.floor(F*G),this.setViewport(0,0,x,F)},this.getCurrentViewport=function(x){return x.copy(D)},this.getViewport=function(x){return x.copy(C)},this.setViewport=function(x,F,G,H){x.isVector4?C.set(x.x,x.y,x.z,x.w):C.set(x,F,G,H),yt.viewport(D.copy(C).multiplyScalar(W).round())},this.getScissor=function(x){return x.copy(rt)},this.setScissor=function(x,F,G,H){x.isVector4?rt.set(x.x,x.y,x.z,x.w):rt.set(x,F,G,H),yt.scissor(k.copy(rt).multiplyScalar(W).round())},this.getScissorTest=function(){return ht},this.setScissorTest=function(x){yt.setScissorTest(ht=x)},this.setOpaqueSort=function(x){ct=x},this.setTransparentSort=function(x){L=x},this.getClearColor=function(x){return x.copy(Pt.getClearColor())},this.setClearColor=function(){Pt.setClearColor.apply(Pt,arguments)},this.getClearAlpha=function(){return Pt.getClearAlpha()},this.setClearAlpha=function(){Pt.setClearAlpha.apply(Pt,arguments)},this.clear=function(x=!0,F=!0,G=!0){let H=0;if(x){let O=!1;if(I!==null){const at=I.texture.format;O=at===ua||at===ha||at===ca}if(O){const at=I.texture.type,pt=at===on||at===Bn||at===Oi||at===di||at===oa||at===la,Tt=Pt.getClearColor(),bt=Pt.getClearAlpha(),Nt=Tt.r,Ot=Tt.g,At=Tt.b;pt?(g[0]=Nt,g[1]=Ot,g[2]=At,g[3]=bt,P.clearBufferuiv(P.COLOR,0,g)):(v[0]=Nt,v[1]=Ot,v[2]=At,v[3]=bt,P.clearBufferiv(P.COLOR,0,v))}else H|=P.COLOR_BUFFER_BIT}F&&(H|=P.DEPTH_BUFFER_BIT),G&&(H|=P.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),P.clear(H)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){e.removeEventListener("webglcontextlost",tt,!1),e.removeEventListener("webglcontextrestored",gt,!1),e.removeEventListener("webglcontextcreationerror",ft,!1),_t.dispose(),Ht.dispose(),Mt.dispose(),_.dispose(),z.dispose(),J.dispose(),te.dispose(),N.dispose(),Et.dispose(),X.dispose(),X.removeEventListener("sessionstart",ya),X.removeEventListener("sessionend",Ea),En.stop()};function tt(x){x.preventDefault(),console.log("THREE.WebGLRenderer: Context Lost."),R=!0}function gt(){console.log("THREE.WebGLRenderer: Context Restored."),R=!1;const x=Xt.autoReset,F=vt.enabled,G=vt.autoUpdate,H=vt.needsUpdate,O=vt.type;dt(),Xt.autoReset=x,vt.enabled=F,vt.autoUpdate=G,vt.needsUpdate=H,vt.type=O}function ft(x){console.error("THREE.WebGLRenderer: A WebGL context could not be created. Reason: ",x.statusMessage)}function Ft(x){const F=x.target;F.removeEventListener("dispose",Ft),se(F)}function se(x){pe(x),Mt.remove(x)}function pe(x){const F=Mt.get(x).programs;F!==void 0&&(F.forEach(function(G){Et.releaseProgram(G)}),x.isShaderMaterial&&Et.releaseShaderCache(x))}this.renderBufferDirect=function(x,F,G,H,O,at){F===null&&(F=Lt);const pt=O.isMesh&&O.matrixWorld.determinant()<0,Tt=El(x,F,G,H,O);yt.setMaterial(H,pt);let bt=G.index,Nt=1;if(H.wireframe===!0){if(bt=et.getWireframeAttribute(G),bt===void 0)return;Nt=2}const Ot=G.drawRange,At=G.attributes.position;let qt=Ot.start*Nt,ee=(Ot.start+Ot.count)*Nt;at!==null&&(qt=Math.max(qt,at.start*Nt),ee=Math.min(ee,(at.start+at.count)*Nt)),bt!==null?(qt=Math.max(qt,0),ee=Math.min(ee,bt.count)):At!=null&&(qt=Math.max(qt,0),ee=Math.min(ee,At.count));const ne=ee-qt;if(ne<0||ne===1/0)return;te.setup(O,H,Tt,G,bt);let ye,$t=xt;if(bt!==null&&(ye=Q.get(bt),$t=Wt,$t.setIndex(ye)),O.isMesh)H.wireframe===!0?(yt.setLineWidth(H.wireframeLinewidth*Vt()),$t.setMode(P.LINES)):$t.setMode(P.TRIANGLES);else if(O.isLine){let Rt=H.linewidth;Rt===void 0&&(Rt=1),yt.setLineWidth(Rt*Vt()),O.isLineSegments?$t.setMode(P.LINES):O.isLineLoop?$t.setMode(P.LINE_LOOP):$t.setMode(P.LINE_STRIP)}else O.isPoints?$t.setMode(P.POINTS):O.isSprite&&$t.setMode(P.TRIANGLES);if(O.isBatchedMesh)if(O._multiDrawInstances!==null)$t.renderMultiDrawInstances(O._multiDrawStarts,O._multiDrawCounts,O._multiDrawCount,O._multiDrawInstances);else if(Dt.get("WEBGL_multi_draw"))$t.renderMultiDraw(O._multiDrawStarts,O._multiDrawCounts,O._multiDrawCount);else{const Rt=O._multiDrawStarts,Ze=O._multiDrawCounts,Zt=O._multiDrawCount,Ne=bt?Q.get(bt).bytesPerElement:1,Gn=Mt.get(H).currentProgram.getUniforms();for(let Te=0;Te<Zt;Te++)Gn.setValue(P,"_gl_DrawID",Te),$t.render(Rt[Te]/Ne,Ze[Te])}else if(O.isInstancedMesh)$t.renderInstances(qt,ne,O.count);else if(G.isInstancedBufferGeometry){const Rt=G._maxInstanceCount!==void 0?G._maxInstanceCount:1/0,Ze=Math.min(G.instanceCount,Rt);$t.renderInstances(qt,ne,Ze)}else $t.render(qt,ne)};function Kt(x,F,G){x.transparent===!0&&x.side===Ge&&x.forceSinglePass===!1?(x.side=Ee,x.needsUpdate=!0,Xi(x,F,G),x.side=Sn,x.needsUpdate=!0,Xi(x,F,G),x.side=Ge):Xi(x,F,G)}this.compile=function(x,F,G=null){G===null&&(G=x),f=Ht.get(G),f.init(F),E.push(f),G.traverseVisible(function(O){O.isLight&&O.layers.test(F.layers)&&(f.pushLight(O),O.castShadow&&f.pushShadow(O))}),x!==G&&x.traverseVisible(function(O){O.isLight&&O.layers.test(F.layers)&&(f.pushLight(O),O.castShadow&&f.pushShadow(O))}),f.setupLights();const H=new Set;return x.traverse(function(O){if(!(O.isMesh||O.isPoints||O.isLine||O.isSprite))return;const at=O.material;if(at)if(Array.isArray(at))for(let pt=0;pt<at.length;pt++){const Tt=at[pt];Kt(Tt,G,O),H.add(Tt)}else Kt(at,G,O),H.add(at)}),E.pop(),f=null,H},this.compileAsync=function(x,F,G=null){const H=this.compile(x,F,G);return new Promise(O=>{function at(){if(H.forEach(function(pt){Mt.get(pt).currentProgram.isReady()&&H.delete(pt)}),H.size===0){O(x);return}setTimeout(at,10)}Dt.get("KHR_parallel_shader_compile")!==null?at():setTimeout(at,10)})};let Ue=null;function $e(x){Ue&&Ue(x)}function ya(){En.stop()}function Ea(){En.start()}const En=new cl;En.setAnimationLoop($e),typeof self<"u"&&En.setContext(self),this.setAnimationLoop=function(x){Ue=x,X.setAnimationLoop(x),x===null?En.stop():En.start()},X.addEventListener("sessionstart",ya),X.addEventListener("sessionend",Ea),this.render=function(x,F){if(F!==void 0&&F.isCamera!==!0){console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(R===!0)return;if(x.matrixWorldAutoUpdate===!0&&x.updateMatrixWorld(),F.parent===null&&F.matrixWorldAutoUpdate===!0&&F.updateMatrixWorld(),X.enabled===!0&&X.isPresenting===!0&&(X.cameraAutoUpdate===!0&&X.updateCamera(F),F=X.getCamera()),x.isScene===!0&&x.onBeforeRender(S,x,F,I),f=Ht.get(x,E.length),f.init(F),E.push(f),ot.multiplyMatrices(F.projectionMatrix,F.matrixWorldInverse),B.setFromProjectionMatrix(ot),it=this.localClippingEnabled,Y=st.init(this.clippingPlanes,it),p=_t.get(x,A.length),p.init(),A.push(p),X.enabled===!0&&X.isPresenting===!0){const at=S.xr.getDepthSensingMesh();at!==null&&Lr(at,F,-1/0,S.sortObjects)}Lr(x,F,0,S.sortObjects),p.finish(),S.sortObjects===!0&&p.sort(ct,L),Ct=X.enabled===!1||X.isPresenting===!1||X.hasDepthSensing()===!1,Ct&&Pt.addToRenderList(p,x),this.info.render.frame++,Y===!0&&st.beginShadows();const G=f.state.shadowsArray;vt.render(G,x,F),Y===!0&&st.endShadows(),this.info.autoReset===!0&&this.info.reset();const H=p.opaque,O=p.transmissive;if(f.setupLights(),F.isArrayCamera){const at=F.cameras;if(O.length>0)for(let pt=0,Tt=at.length;pt<Tt;pt++){const bt=at[pt];ba(H,O,x,bt)}Ct&&Pt.render(x);for(let pt=0,Tt=at.length;pt<Tt;pt++){const bt=at[pt];Ta(p,x,bt,bt.viewport)}}else O.length>0&&ba(H,O,x,F),Ct&&Pt.render(x),Ta(p,x,F);I!==null&&(T.updateMultisampleRenderTarget(I),T.updateRenderTargetMipmap(I)),x.isScene===!0&&x.onAfterRender(S,x,F),te.resetDefaultState(),y=-1,M=null,E.pop(),E.length>0?(f=E[E.length-1],Y===!0&&st.setGlobalState(S.clippingPlanes,f.state.camera)):f=null,A.pop(),A.length>0?p=A[A.length-1]:p=null};function Lr(x,F,G,H){if(x.visible===!1)return;if(x.layers.test(F.layers)){if(x.isGroup)G=x.renderOrder;else if(x.isLOD)x.autoUpdate===!0&&x.update(F);else if(x.isLight)f.pushLight(x),x.castShadow&&f.pushShadow(x);else if(x.isSprite){if(!x.frustumCulled||B.intersectsSprite(x)){H&&St.setFromMatrixPosition(x.matrixWorld).applyMatrix4(ot);const pt=J.update(x),Tt=x.material;Tt.visible&&p.push(x,pt,Tt,G,St.z,null)}}else if((x.isMesh||x.isLine||x.isPoints)&&(!x.frustumCulled||B.intersectsObject(x))){const pt=J.update(x),Tt=x.material;if(H&&(x.boundingSphere!==void 0?(x.boundingSphere===null&&x.computeBoundingSphere(),St.copy(x.boundingSphere.center)):(pt.boundingSphere===null&&pt.computeBoundingSphere(),St.copy(pt.boundingSphere.center)),St.applyMatrix4(x.matrixWorld).applyMatrix4(ot)),Array.isArray(Tt)){const bt=pt.groups;for(let Nt=0,Ot=bt.length;Nt<Ot;Nt++){const At=bt[Nt],qt=Tt[At.materialIndex];qt&&qt.visible&&p.push(x,pt,qt,G,St.z,At)}}else Tt.visible&&p.push(x,pt,Tt,G,St.z,null)}}const at=x.children;for(let pt=0,Tt=at.length;pt<Tt;pt++)Lr(at[pt],F,G,H)}function Ta(x,F,G,H){const O=x.opaque,at=x.transmissive,pt=x.transparent;f.setupLightsView(G),Y===!0&&st.setGlobalState(S.clippingPlanes,G),H&&yt.viewport(D.copy(H)),O.length>0&&Wi(O,F,G),at.length>0&&Wi(at,F,G),pt.length>0&&Wi(pt,F,G),yt.buffers.depth.setTest(!0),yt.buffers.depth.setMask(!0),yt.buffers.color.setMask(!0),yt.setPolygonOffset(!1)}function ba(x,F,G,H){if((G.isScene===!0?G.overrideMaterial:null)!==null)return;f.state.transmissionRenderTarget[H.id]===void 0&&(f.state.transmissionRenderTarget[H.id]=new zn(1,1,{generateMipmaps:!0,type:Dt.has("EXT_color_buffer_half_float")||Dt.has("EXT_color_buffer_float")?Vi:on,minFilter:Fn,samples:4,stencilBuffer:s,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:Yt.workingColorSpace}));const at=f.state.transmissionRenderTarget[H.id],pt=H.viewport||D;at.setSize(pt.z,pt.w);const Tt=S.getRenderTarget();S.setRenderTarget(at),S.getClearColor(K),j=S.getClearAlpha(),j<1&&S.setClearColor(16777215,.5),S.clear(),Ct&&Pt.render(G);const bt=S.toneMapping;S.toneMapping=xn;const Nt=H.viewport;if(H.viewport!==void 0&&(H.viewport=void 0),f.setupLightsView(H),Y===!0&&st.setGlobalState(S.clippingPlanes,H),Wi(x,G,H),T.updateMultisampleRenderTarget(at),T.updateRenderTargetMipmap(at),Dt.has("WEBGL_multisampled_render_to_texture")===!1){let Ot=!1;for(let At=0,qt=F.length;At<qt;At++){const ee=F[At],ne=ee.object,ye=ee.geometry,$t=ee.material,Rt=ee.group;if($t.side===Ge&&ne.layers.test(H.layers)){const Ze=$t.side;$t.side=Ee,$t.needsUpdate=!0,Aa(ne,G,H,ye,$t,Rt),$t.side=Ze,$t.needsUpdate=!0,Ot=!0}}Ot===!0&&(T.updateMultisampleRenderTarget(at),T.updateRenderTargetMipmap(at))}S.setRenderTarget(Tt),S.setClearColor(K,j),Nt!==void 0&&(H.viewport=Nt),S.toneMapping=bt}function Wi(x,F,G){const H=F.isScene===!0?F.overrideMaterial:null;for(let O=0,at=x.length;O<at;O++){const pt=x[O],Tt=pt.object,bt=pt.geometry,Nt=H===null?pt.material:H,Ot=pt.group;Tt.layers.test(G.layers)&&Aa(Tt,F,G,bt,Nt,Ot)}}function Aa(x,F,G,H,O,at){x.onBeforeRender(S,F,G,H,O,at),x.modelViewMatrix.multiplyMatrices(G.matrixWorldInverse,x.matrixWorld),x.normalMatrix.getNormalMatrix(x.modelViewMatrix),O.onBeforeRender(S,F,G,H,x,at),O.transparent===!0&&O.side===Ge&&O.forceSinglePass===!1?(O.side=Ee,O.needsUpdate=!0,S.renderBufferDirect(G,F,H,O,x,at),O.side=Sn,O.needsUpdate=!0,S.renderBufferDirect(G,F,H,O,x,at),O.side=Ge):S.renderBufferDirect(G,F,H,O,x,at),x.onAfterRender(S,F,G,H,O,at)}function Xi(x,F,G){F.isScene!==!0&&(F=Lt);const H=Mt.get(x),O=f.state.lights,at=f.state.shadowsArray,pt=O.state.version,Tt=Et.getParameters(x,O.state,at,F,G),bt=Et.getProgramCacheKey(Tt);let Nt=H.programs;H.environment=x.isMeshStandardMaterial?F.environment:null,H.fog=F.fog,H.envMap=(x.isMeshStandardMaterial?z:_).get(x.envMap||H.environment),H.envMapRotation=H.environment!==null&&x.envMap===null?F.environmentRotation:x.envMapRotation,Nt===void 0&&(x.addEventListener("dispose",Ft),Nt=new Map,H.programs=Nt);let Ot=Nt.get(bt);if(Ot!==void 0){if(H.currentProgram===Ot&&H.lightsStateVersion===pt)return Ca(x,Tt),Ot}else Tt.uniforms=Et.getUniforms(x),x.onBeforeCompile(Tt,S),Ot=Et.acquireProgram(Tt,bt),Nt.set(bt,Ot),H.uniforms=Tt.uniforms;const At=H.uniforms;return(!x.isShaderMaterial&&!x.isRawShaderMaterial||x.clipping===!0)&&(At.clippingPlanes=st.uniform),Ca(x,Tt),H.needsLights=bl(x),H.lightsStateVersion=pt,H.needsLights&&(At.ambientLightColor.value=O.state.ambient,At.lightProbe.value=O.state.probe,At.directionalLights.value=O.state.directional,At.directionalLightShadows.value=O.state.directionalShadow,At.spotLights.value=O.state.spot,At.spotLightShadows.value=O.state.spotShadow,At.rectAreaLights.value=O.state.rectArea,At.ltc_1.value=O.state.rectAreaLTC1,At.ltc_2.value=O.state.rectAreaLTC2,At.pointLights.value=O.state.point,At.pointLightShadows.value=O.state.pointShadow,At.hemisphereLights.value=O.state.hemi,At.directionalShadowMap.value=O.state.directionalShadowMap,At.directionalShadowMatrix.value=O.state.directionalShadowMatrix,At.spotShadowMap.value=O.state.spotShadowMap,At.spotLightMatrix.value=O.state.spotLightMatrix,At.spotLightMap.value=O.state.spotLightMap,At.pointShadowMap.value=O.state.pointShadowMap,At.pointShadowMatrix.value=O.state.pointShadowMatrix),H.currentProgram=Ot,H.uniformsList=null,Ot}function wa(x){if(x.uniformsList===null){const F=x.currentProgram.getUniforms();x.uniformsList=yr.seqWithValue(F.seq,x.uniforms)}return x.uniformsList}function Ca(x,F){const G=Mt.get(x);G.outputColorSpace=F.outputColorSpace,G.batching=F.batching,G.batchingColor=F.batchingColor,G.instancing=F.instancing,G.instancingColor=F.instancingColor,G.instancingMorph=F.instancingMorph,G.skinning=F.skinning,G.morphTargets=F.morphTargets,G.morphNormals=F.morphNormals,G.morphColors=F.morphColors,G.morphTargetsCount=F.morphTargetsCount,G.numClippingPlanes=F.numClippingPlanes,G.numIntersection=F.numClipIntersection,G.vertexAlphas=F.vertexAlphas,G.vertexTangents=F.vertexTangents,G.toneMapping=F.toneMapping}function El(x,F,G,H,O){F.isScene!==!0&&(F=Lt),T.resetTextureUnits();const at=F.fog,pt=H.isMeshStandardMaterial?F.environment:null,Tt=I===null?S.outputColorSpace:I.isXRRenderTarget===!0?I.texture.colorSpace:mi,bt=(H.isMeshStandardMaterial?z:_).get(H.envMap||pt),Nt=H.vertexColors===!0&&!!G.attributes.color&&G.attributes.color.itemSize===4,Ot=!!G.attributes.tangent&&(!!H.normalMap||H.anisotropy>0),At=!!G.morphAttributes.position,qt=!!G.morphAttributes.normal,ee=!!G.morphAttributes.color;let ne=xn;H.toneMapped&&(I===null||I.isXRRenderTarget===!0)&&(ne=S.toneMapping);const ye=G.morphAttributes.position||G.morphAttributes.normal||G.morphAttributes.color,$t=ye!==void 0?ye.length:0,Rt=Mt.get(H),Ze=f.state.lights;if(Y===!0&&(it===!0||x!==M)){const Ce=x===M&&H.id===y;st.setState(H,x,Ce)}let Zt=!1;H.version===Rt.__version?(Rt.needsLights&&Rt.lightsStateVersion!==Ze.state.version||Rt.outputColorSpace!==Tt||O.isBatchedMesh&&Rt.batching===!1||!O.isBatchedMesh&&Rt.batching===!0||O.isBatchedMesh&&Rt.batchingColor===!0&&O.colorTexture===null||O.isBatchedMesh&&Rt.batchingColor===!1&&O.colorTexture!==null||O.isInstancedMesh&&Rt.instancing===!1||!O.isInstancedMesh&&Rt.instancing===!0||O.isSkinnedMesh&&Rt.skinning===!1||!O.isSkinnedMesh&&Rt.skinning===!0||O.isInstancedMesh&&Rt.instancingColor===!0&&O.instanceColor===null||O.isInstancedMesh&&Rt.instancingColor===!1&&O.instanceColor!==null||O.isInstancedMesh&&Rt.instancingMorph===!0&&O.morphTexture===null||O.isInstancedMesh&&Rt.instancingMorph===!1&&O.morphTexture!==null||Rt.envMap!==bt||H.fog===!0&&Rt.fog!==at||Rt.numClippingPlanes!==void 0&&(Rt.numClippingPlanes!==st.numPlanes||Rt.numIntersection!==st.numIntersection)||Rt.vertexAlphas!==Nt||Rt.vertexTangents!==Ot||Rt.morphTargets!==At||Rt.morphNormals!==qt||Rt.morphColors!==ee||Rt.toneMapping!==ne||Rt.morphTargetsCount!==$t)&&(Zt=!0):(Zt=!0,Rt.__version=H.version);let Ne=Rt.currentProgram;Zt===!0&&(Ne=Xi(H,F,O));let Gn=!1,Te=!1,Mi=!1;const ie=Ne.getUniforms(),We=Rt.uniforms;if(yt.useProgram(Ne.program)&&(Gn=!0,Te=!0,Mi=!0),H.id!==y&&(y=H.id,Te=!0),Gn||M!==x){yt.buffers.depth.getReversed()?($.copy(x.projectionMatrix),Mc($),Sc($),ie.setValue(P,"projectionMatrix",$)):ie.setValue(P,"projectionMatrix",x.projectionMatrix),ie.setValue(P,"viewMatrix",x.matrixWorldInverse);const cn=ie.map.cameraPosition;cn!==void 0&&cn.setValue(P,mt.setFromMatrixPosition(x.matrixWorld)),It.logarithmicDepthBuffer&&ie.setValue(P,"logDepthBufFC",2/(Math.log(x.far+1)/Math.LN2)),(H.isMeshPhongMaterial||H.isMeshToonMaterial||H.isMeshLambertMaterial||H.isMeshBasicMaterial||H.isMeshStandardMaterial||H.isShaderMaterial)&&ie.setValue(P,"isOrthographic",x.isOrthographicCamera===!0),M!==x&&(M=x,Te=!0,Mi=!0)}if(O.isSkinnedMesh){ie.setOptional(P,O,"bindMatrix"),ie.setOptional(P,O,"bindMatrixInverse");const Ce=O.skeleton;Ce&&(Ce.boneTexture===null&&Ce.computeBoneTexture(),ie.setValue(P,"boneTexture",Ce.boneTexture,T))}O.isBatchedMesh&&(ie.setOptional(P,O,"batchingTexture"),ie.setValue(P,"batchingTexture",O._matricesTexture,T),ie.setOptional(P,O,"batchingIdTexture"),ie.setValue(P,"batchingIdTexture",O._indirectTexture,T),ie.setOptional(P,O,"batchingColorTexture"),O._colorsTexture!==null&&ie.setValue(P,"batchingColorTexture",O._colorsTexture,T));const Si=G.morphAttributes;if((Si.position!==void 0||Si.normal!==void 0||Si.color!==void 0)&&Ut.update(O,G,Ne),(Te||Rt.receiveShadow!==O.receiveShadow)&&(Rt.receiveShadow=O.receiveShadow,ie.setValue(P,"receiveShadow",O.receiveShadow)),H.isMeshGouraudMaterial&&H.envMap!==null&&(We.envMap.value=bt,We.flipEnvMap.value=bt.isCubeTexture&&bt.isRenderTargetTexture===!1?-1:1),H.isMeshStandardMaterial&&H.envMap===null&&F.environment!==null&&(We.envMapIntensity.value=F.environmentIntensity),Te&&(ie.setValue(P,"toneMappingExposure",S.toneMappingExposure),Rt.needsLights&&Tl(We,Mi),at&&H.fog===!0&&ut.refreshFogUniforms(We,at),ut.refreshMaterialUniforms(We,H,W,nt,f.state.transmissionRenderTarget[x.id]),yr.upload(P,wa(Rt),We,T)),H.isShaderMaterial&&H.uniformsNeedUpdate===!0&&(yr.upload(P,wa(Rt),We,T),H.uniformsNeedUpdate=!1),H.isSpriteMaterial&&ie.setValue(P,"center",O.center),ie.setValue(P,"modelViewMatrix",O.modelViewMatrix),ie.setValue(P,"normalMatrix",O.normalMatrix),ie.setValue(P,"modelMatrix",O.matrixWorld),H.isShaderMaterial||H.isRawShaderMaterial){const Ce=H.uniformsGroups;for(let cn=0,hn=Ce.length;cn<hn;cn++){const Ra=Ce[cn];N.update(Ra,Ne),N.bind(Ra,Ne)}}return Ne}function Tl(x,F){x.ambientLightColor.needsUpdate=F,x.lightProbe.needsUpdate=F,x.directionalLights.needsUpdate=F,x.directionalLightShadows.needsUpdate=F,x.pointLights.needsUpdate=F,x.pointLightShadows.needsUpdate=F,x.spotLights.needsUpdate=F,x.spotLightShadows.needsUpdate=F,x.rectAreaLights.needsUpdate=F,x.hemisphereLights.needsUpdate=F}function bl(x){return x.isMeshLambertMaterial||x.isMeshToonMaterial||x.isMeshPhongMaterial||x.isMeshStandardMaterial||x.isShadowMaterial||x.isShaderMaterial&&x.lights===!0}this.getActiveCubeFace=function(){return b},this.getActiveMipmapLevel=function(){return w},this.getRenderTarget=function(){return I},this.setRenderTargetTextures=function(x,F,G){Mt.get(x.texture).__webglTexture=F,Mt.get(x.depthTexture).__webglTexture=G;const H=Mt.get(x);H.__hasExternalTextures=!0,H.__autoAllocateDepthBuffer=G===void 0,H.__autoAllocateDepthBuffer||Dt.has("WEBGL_multisampled_render_to_texture")===!0&&(console.warn("THREE.WebGLRenderer: Render-to-texture extension was disabled because an external texture was provided"),H.__useRenderToTexture=!1)},this.setRenderTargetFramebuffer=function(x,F){const G=Mt.get(x);G.__webglFramebuffer=F,G.__useDefaultFramebuffer=F===void 0},this.setRenderTarget=function(x,F=0,G=0){I=x,b=F,w=G;let H=!0,O=null,at=!1,pt=!1;if(x){const bt=Mt.get(x);if(bt.__useDefaultFramebuffer!==void 0)yt.bindFramebuffer(P.FRAMEBUFFER,null),H=!1;else if(bt.__webglFramebuffer===void 0)T.setupRenderTarget(x);else if(bt.__hasExternalTextures)T.rebindTextures(x,Mt.get(x.texture).__webglTexture,Mt.get(x.depthTexture).__webglTexture);else if(x.depthBuffer){const At=x.depthTexture;if(bt.__boundDepthTexture!==At){if(At!==null&&Mt.has(At)&&(x.width!==At.image.width||x.height!==At.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");T.setupDepthRenderbuffer(x)}}const Nt=x.texture;(Nt.isData3DTexture||Nt.isDataArrayTexture||Nt.isCompressedArrayTexture)&&(pt=!0);const Ot=Mt.get(x).__webglFramebuffer;x.isWebGLCubeRenderTarget?(Array.isArray(Ot[F])?O=Ot[F][G]:O=Ot[F],at=!0):x.samples>0&&T.useMultisampledRTT(x)===!1?O=Mt.get(x).__webglMultisampledFramebuffer:Array.isArray(Ot)?O=Ot[G]:O=Ot,D.copy(x.viewport),k.copy(x.scissor),V=x.scissorTest}else D.copy(C).multiplyScalar(W).floor(),k.copy(rt).multiplyScalar(W).floor(),V=ht;if(yt.bindFramebuffer(P.FRAMEBUFFER,O)&&H&&yt.drawBuffers(x,O),yt.viewport(D),yt.scissor(k),yt.setScissorTest(V),at){const bt=Mt.get(x.texture);P.framebufferTexture2D(P.FRAMEBUFFER,P.COLOR_ATTACHMENT0,P.TEXTURE_CUBE_MAP_POSITIVE_X+F,bt.__webglTexture,G)}else if(pt){const bt=Mt.get(x.texture),Nt=F||0;P.framebufferTextureLayer(P.FRAMEBUFFER,P.COLOR_ATTACHMENT0,bt.__webglTexture,G||0,Nt)}y=-1},this.readRenderTargetPixels=function(x,F,G,H,O,at,pt){if(!(x&&x.isWebGLRenderTarget)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let Tt=Mt.get(x).__webglFramebuffer;if(x.isWebGLCubeRenderTarget&&pt!==void 0&&(Tt=Tt[pt]),Tt){yt.bindFramebuffer(P.FRAMEBUFFER,Tt);try{const bt=x.texture,Nt=bt.format,Ot=bt.type;if(!It.textureFormatReadable(Nt)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!It.textureTypeReadable(Ot)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}F>=0&&F<=x.width-H&&G>=0&&G<=x.height-O&&P.readPixels(F,G,H,O,zt.convert(Nt),zt.convert(Ot),at)}finally{const bt=I!==null?Mt.get(I).__webglFramebuffer:null;yt.bindFramebuffer(P.FRAMEBUFFER,bt)}}},this.readRenderTargetPixelsAsync=async function(x,F,G,H,O,at,pt){if(!(x&&x.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let Tt=Mt.get(x).__webglFramebuffer;if(x.isWebGLCubeRenderTarget&&pt!==void 0&&(Tt=Tt[pt]),Tt){const bt=x.texture,Nt=bt.format,Ot=bt.type;if(!It.textureFormatReadable(Nt))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!It.textureTypeReadable(Ot))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");if(F>=0&&F<=x.width-H&&G>=0&&G<=x.height-O){yt.bindFramebuffer(P.FRAMEBUFFER,Tt);const At=P.createBuffer();P.bindBuffer(P.PIXEL_PACK_BUFFER,At),P.bufferData(P.PIXEL_PACK_BUFFER,at.byteLength,P.STREAM_READ),P.readPixels(F,G,H,O,zt.convert(Nt),zt.convert(Ot),0);const qt=I!==null?Mt.get(I).__webglFramebuffer:null;yt.bindFramebuffer(P.FRAMEBUFFER,qt);const ee=P.fenceSync(P.SYNC_GPU_COMMANDS_COMPLETE,0);return P.flush(),await xc(P,ee,4),P.bindBuffer(P.PIXEL_PACK_BUFFER,At),P.getBufferSubData(P.PIXEL_PACK_BUFFER,0,at),P.deleteBuffer(At),P.deleteSync(ee),at}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")}},this.copyFramebufferToTexture=function(x,F=null,G=0){x.isTexture!==!0&&(Pi("WebGLRenderer: copyFramebufferToTexture function signature has changed."),F=arguments[0]||null,x=arguments[1]);const H=Math.pow(2,-G),O=Math.floor(x.image.width*H),at=Math.floor(x.image.height*H),pt=F!==null?F.x:0,Tt=F!==null?F.y:0;T.setTexture2D(x,0),P.copyTexSubImage2D(P.TEXTURE_2D,G,0,0,pt,Tt,O,at),yt.unbindTexture()},this.copyTextureToTexture=function(x,F,G=null,H=null,O=0){x.isTexture!==!0&&(Pi("WebGLRenderer: copyTextureToTexture function signature has changed."),H=arguments[0]||null,x=arguments[1],F=arguments[2],O=arguments[3]||0,G=null);let at,pt,Tt,bt,Nt,Ot,At,qt,ee;const ne=x.isCompressedTexture?x.mipmaps[O]:x.image;G!==null?(at=G.max.x-G.min.x,pt=G.max.y-G.min.y,Tt=G.isBox3?G.max.z-G.min.z:1,bt=G.min.x,Nt=G.min.y,Ot=G.isBox3?G.min.z:0):(at=ne.width,pt=ne.height,Tt=ne.depth||1,bt=0,Nt=0,Ot=0),H!==null?(At=H.x,qt=H.y,ee=H.z):(At=0,qt=0,ee=0);const ye=zt.convert(F.format),$t=zt.convert(F.type);let Rt;F.isData3DTexture?(T.setTexture3D(F,0),Rt=P.TEXTURE_3D):F.isDataArrayTexture||F.isCompressedArrayTexture?(T.setTexture2DArray(F,0),Rt=P.TEXTURE_2D_ARRAY):(T.setTexture2D(F,0),Rt=P.TEXTURE_2D),P.pixelStorei(P.UNPACK_FLIP_Y_WEBGL,F.flipY),P.pixelStorei(P.UNPACK_PREMULTIPLY_ALPHA_WEBGL,F.premultiplyAlpha),P.pixelStorei(P.UNPACK_ALIGNMENT,F.unpackAlignment);const Ze=P.getParameter(P.UNPACK_ROW_LENGTH),Zt=P.getParameter(P.UNPACK_IMAGE_HEIGHT),Ne=P.getParameter(P.UNPACK_SKIP_PIXELS),Gn=P.getParameter(P.UNPACK_SKIP_ROWS),Te=P.getParameter(P.UNPACK_SKIP_IMAGES);P.pixelStorei(P.UNPACK_ROW_LENGTH,ne.width),P.pixelStorei(P.UNPACK_IMAGE_HEIGHT,ne.height),P.pixelStorei(P.UNPACK_SKIP_PIXELS,bt),P.pixelStorei(P.UNPACK_SKIP_ROWS,Nt),P.pixelStorei(P.UNPACK_SKIP_IMAGES,Ot);const Mi=x.isDataArrayTexture||x.isData3DTexture,ie=F.isDataArrayTexture||F.isData3DTexture;if(x.isRenderTargetTexture||x.isDepthTexture){const We=Mt.get(x),Si=Mt.get(F),Ce=Mt.get(We.__renderTarget),cn=Mt.get(Si.__renderTarget);yt.bindFramebuffer(P.READ_FRAMEBUFFER,Ce.__webglFramebuffer),yt.bindFramebuffer(P.DRAW_FRAMEBUFFER,cn.__webglFramebuffer);for(let hn=0;hn<Tt;hn++)Mi&&P.framebufferTextureLayer(P.READ_FRAMEBUFFER,P.COLOR_ATTACHMENT0,Mt.get(x).__webglTexture,O,Ot+hn),x.isDepthTexture?(ie&&P.framebufferTextureLayer(P.DRAW_FRAMEBUFFER,P.COLOR_ATTACHMENT0,Mt.get(F).__webglTexture,O,ee+hn),P.blitFramebuffer(bt,Nt,at,pt,At,qt,at,pt,P.DEPTH_BUFFER_BIT,P.NEAREST)):ie?P.copyTexSubImage3D(Rt,O,At,qt,ee+hn,bt,Nt,at,pt):P.copyTexSubImage2D(Rt,O,At,qt,ee+hn,bt,Nt,at,pt);yt.bindFramebuffer(P.READ_FRAMEBUFFER,null),yt.bindFramebuffer(P.DRAW_FRAMEBUFFER,null)}else ie?x.isDataTexture||x.isData3DTexture?P.texSubImage3D(Rt,O,At,qt,ee,at,pt,Tt,ye,$t,ne.data):F.isCompressedArrayTexture?P.compressedTexSubImage3D(Rt,O,At,qt,ee,at,pt,Tt,ye,ne.data):P.texSubImage3D(Rt,O,At,qt,ee,at,pt,Tt,ye,$t,ne):x.isDataTexture?P.texSubImage2D(P.TEXTURE_2D,O,At,qt,at,pt,ye,$t,ne.data):x.isCompressedTexture?P.compressedTexSubImage2D(P.TEXTURE_2D,O,At,qt,ne.width,ne.height,ye,ne.data):P.texSubImage2D(P.TEXTURE_2D,O,At,qt,at,pt,ye,$t,ne);P.pixelStorei(P.UNPACK_ROW_LENGTH,Ze),P.pixelStorei(P.UNPACK_IMAGE_HEIGHT,Zt),P.pixelStorei(P.UNPACK_SKIP_PIXELS,Ne),P.pixelStorei(P.UNPACK_SKIP_ROWS,Gn),P.pixelStorei(P.UNPACK_SKIP_IMAGES,Te),O===0&&F.generateMipmaps&&P.generateMipmap(Rt),yt.unbindTexture()},this.copyTextureToTexture3D=function(x,F,G=null,H=null,O=0){return x.isTexture!==!0&&(Pi("WebGLRenderer: copyTextureToTexture3D function signature has changed."),G=arguments[0]||null,H=arguments[1]||null,x=arguments[2],F=arguments[3],O=arguments[4]||0),Pi('WebGLRenderer: copyTextureToTexture3D function has been deprecated. Use "copyTextureToTexture" instead.'),this.copyTextureToTexture(x,F,G,H,O)},this.initRenderTarget=function(x){Mt.get(x).__webglFramebuffer===void 0&&T.setupRenderTarget(x)},this.initTexture=function(x){x.isCubeTexture?T.setTextureCube(x,0):x.isData3DTexture?T.setTexture3D(x,0):x.isDataArrayTexture||x.isCompressedArrayTexture?T.setTexture2DArray(x,0):T.setTexture2D(x,0),yt.unbindTexture()},this.resetState=function(){b=0,w=0,I=null,yt.reset(),te.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return rn}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(t){this._outputColorSpace=t;const e=this.getContext();e.drawingBufferColorspace=Yt._getDrawingBufferColorSpace(t),e.unpackColorSpace=Yt._getUnpackColorSpace()}}class Dp extends fe{constructor(){super(),this.isScene=!0,this.type="Scene",this.background=null,this.environment=null,this.fog=null,this.backgroundBlurriness=0,this.backgroundIntensity=1,this.backgroundRotation=new qe,this.environmentIntensity=1,this.environmentRotation=new qe,this.overrideMaterial=null,typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}copy(t,e){return super.copy(t,e),t.background!==null&&(this.background=t.background.clone()),t.environment!==null&&(this.environment=t.environment.clone()),t.fog!==null&&(this.fog=t.fog.clone()),this.backgroundBlurriness=t.backgroundBlurriness,this.backgroundIntensity=t.backgroundIntensity,this.backgroundRotation.copy(t.backgroundRotation),this.environmentIntensity=t.environmentIntensity,this.environmentRotation.copy(t.environmentRotation),t.overrideMaterial!==null&&(this.overrideMaterial=t.overrideMaterial.clone()),this.matrixAutoUpdate=t.matrixAutoUpdate,this}toJSON(t){const e=super.toJSON(t);return this.fog!==null&&(e.object.fog=this.fog.toJSON()),this.backgroundBlurriness>0&&(e.object.backgroundBlurriness=this.backgroundBlurriness),this.backgroundIntensity!==1&&(e.object.backgroundIntensity=this.backgroundIntensity),e.object.backgroundRotation=this.backgroundRotation.toArray(),this.environmentIntensity!==1&&(e.object.environmentIntensity=this.environmentIntensity),e.object.environmentRotation=this.environmentRotation.toArray(),e}}class Ip{constructor(t,e){this.isInterleavedBuffer=!0,this.array=t,this.stride=e,this.count=t!==void 0?t.length/e:0,this.usage=ea,this.updateRanges=[],this.version=0,this.uuid=Mn()}onUploadCallback(){}set needsUpdate(t){t===!0&&this.version++}setUsage(t){return this.usage=t,this}addUpdateRange(t,e){this.updateRanges.push({start:t,count:e})}clearUpdateRanges(){this.updateRanges.length=0}copy(t){return this.array=new t.array.constructor(t.array),this.count=t.count,this.stride=t.stride,this.usage=t.usage,this}copyAt(t,e,n){t*=this.stride,n*=e.stride;for(let i=0,s=this.stride;i<s;i++)this.array[t+i]=e.array[n+i];return this}set(t,e=0){return this.array.set(t,e),this}clone(t){t.arrayBuffers===void 0&&(t.arrayBuffers={}),this.array.buffer._uuid===void 0&&(this.array.buffer._uuid=Mn()),t.arrayBuffers[this.array.buffer._uuid]===void 0&&(t.arrayBuffers[this.array.buffer._uuid]=this.array.slice(0).buffer);const e=new this.array.constructor(t.arrayBuffers[this.array.buffer._uuid]),n=new this.constructor(e,this.stride);return n.setUsage(this.usage),n}onUpload(t){return this.onUploadCallback=t,this}toJSON(t){return t.arrayBuffers===void 0&&(t.arrayBuffers={}),this.array.buffer._uuid===void 0&&(this.array.buffer._uuid=Mn()),t.arrayBuffers[this.array.buffer._uuid]===void 0&&(t.arrayBuffers[this.array.buffer._uuid]=Array.from(new Uint32Array(this.array.buffer))),{uuid:this.uuid,buffer:this.array.buffer._uuid,type:this.array.constructor.name,stride:this.stride}}}const ve=new U;class br{constructor(t,e,n,i=!1){this.isInterleavedBufferAttribute=!0,this.name="",this.data=t,this.itemSize=e,this.offset=n,this.normalized=i}get count(){return this.data.count}get array(){return this.data.array}set needsUpdate(t){this.data.needsUpdate=t}applyMatrix4(t){for(let e=0,n=this.data.count;e<n;e++)ve.fromBufferAttribute(this,e),ve.applyMatrix4(t),this.setXYZ(e,ve.x,ve.y,ve.z);return this}applyNormalMatrix(t){for(let e=0,n=this.count;e<n;e++)ve.fromBufferAttribute(this,e),ve.applyNormalMatrix(t),this.setXYZ(e,ve.x,ve.y,ve.z);return this}transformDirection(t){for(let e=0,n=this.count;e<n;e++)ve.fromBufferAttribute(this,e),ve.transformDirection(t),this.setXYZ(e,ve.x,ve.y,ve.z);return this}getComponent(t,e){let n=this.array[t*this.data.stride+this.offset+e];return this.normalized&&(n=Ye(n,this.array)),n}setComponent(t,e,n){return this.normalized&&(n=jt(n,this.array)),this.data.array[t*this.data.stride+this.offset+e]=n,this}setX(t,e){return this.normalized&&(e=jt(e,this.array)),this.data.array[t*this.data.stride+this.offset]=e,this}setY(t,e){return this.normalized&&(e=jt(e,this.array)),this.data.array[t*this.data.stride+this.offset+1]=e,this}setZ(t,e){return this.normalized&&(e=jt(e,this.array)),this.data.array[t*this.data.stride+this.offset+2]=e,this}setW(t,e){return this.normalized&&(e=jt(e,this.array)),this.data.array[t*this.data.stride+this.offset+3]=e,this}getX(t){let e=this.data.array[t*this.data.stride+this.offset];return this.normalized&&(e=Ye(e,this.array)),e}getY(t){let e=this.data.array[t*this.data.stride+this.offset+1];return this.normalized&&(e=Ye(e,this.array)),e}getZ(t){let e=this.data.array[t*this.data.stride+this.offset+2];return this.normalized&&(e=Ye(e,this.array)),e}getW(t){let e=this.data.array[t*this.data.stride+this.offset+3];return this.normalized&&(e=Ye(e,this.array)),e}setXY(t,e,n){return t=t*this.data.stride+this.offset,this.normalized&&(e=jt(e,this.array),n=jt(n,this.array)),this.data.array[t+0]=e,this.data.array[t+1]=n,this}setXYZ(t,e,n,i){return t=t*this.data.stride+this.offset,this.normalized&&(e=jt(e,this.array),n=jt(n,this.array),i=jt(i,this.array)),this.data.array[t+0]=e,this.data.array[t+1]=n,this.data.array[t+2]=i,this}setXYZW(t,e,n,i,s){return t=t*this.data.stride+this.offset,this.normalized&&(e=jt(e,this.array),n=jt(n,this.array),i=jt(i,this.array),s=jt(s,this.array)),this.data.array[t+0]=e,this.data.array[t+1]=n,this.data.array[t+2]=i,this.data.array[t+3]=s,this}clone(t){if(t===void 0){console.log("THREE.InterleavedBufferAttribute.clone(): Cloning an interleaved buffer attribute will de-interleave buffer data.");const e=[];for(let n=0;n<this.count;n++){const i=n*this.data.stride+this.offset;for(let s=0;s<this.itemSize;s++)e.push(this.data.array[i+s])}return new Me(new this.array.constructor(e),this.itemSize,this.normalized)}else return t.interleavedBuffers===void 0&&(t.interleavedBuffers={}),t.interleavedBuffers[this.data.uuid]===void 0&&(t.interleavedBuffers[this.data.uuid]=this.data.clone(t)),new br(t.interleavedBuffers[this.data.uuid],this.itemSize,this.offset,this.normalized)}toJSON(t){if(t===void 0){console.log("THREE.InterleavedBufferAttribute.toJSON(): Serializing an interleaved buffer attribute will de-interleave buffer data.");const e=[];for(let n=0;n<this.count;n++){const i=n*this.data.stride+this.offset;for(let s=0;s<this.itemSize;s++)e.push(this.data.array[i+s])}return{itemSize:this.itemSize,type:this.array.constructor.name,array:e,normalized:this.normalized}}else return t.interleavedBuffers===void 0&&(t.interleavedBuffers={}),t.interleavedBuffers[this.data.uuid]===void 0&&(t.interleavedBuffers[this.data.uuid]=this.data.toJSON(t)),{isInterleavedBufferAttribute:!0,itemSize:this.itemSize,data:this.data.uuid,offset:this.offset,normalized:this.normalized}}}class ga extends vi{static get type(){return"SpriteMaterial"}constructor(t){super(),this.isSpriteMaterial=!0,this.color=new kt(16777215),this.map=null,this.alphaMap=null,this.rotation=0,this.sizeAttenuation=!0,this.transparent=!0,this.fog=!0,this.setValues(t)}copy(t){return super.copy(t),this.color.copy(t.color),this.map=t.map,this.alphaMap=t.alphaMap,this.rotation=t.rotation,this.sizeAttenuation=t.sizeAttenuation,this.fog=t.fog,this}}let ei;const Ai=new U,ni=new U,ii=new U,ri=new wt,wi=new wt,gl=new re,fr=new U,Ci=new U,pr=new U,Co=new wt,ls=new wt,Ro=new wt;class _l extends fe{constructor(t=new ga){if(super(),this.isSprite=!0,this.type="Sprite",ei===void 0){ei=new we;const e=new Float32Array([-.5,-.5,0,0,0,.5,-.5,0,1,0,.5,.5,0,1,1,-.5,.5,0,0,1]),n=new Ip(e,5);ei.setIndex([0,1,2,0,2,3]),ei.setAttribute("position",new br(n,3,0,!1)),ei.setAttribute("uv",new br(n,2,3,!1))}this.geometry=ei,this.material=t,this.center=new wt(.5,.5)}raycast(t,e){t.camera===null&&console.error('THREE.Sprite: "Raycaster.camera" needs to be set in order to raycast against sprites.'),ni.setFromMatrixScale(this.matrixWorld),gl.copy(t.camera.matrixWorld),this.modelViewMatrix.multiplyMatrices(t.camera.matrixWorldInverse,this.matrixWorld),ii.setFromMatrixPosition(this.modelViewMatrix),t.camera.isPerspectiveCamera&&this.material.sizeAttenuation===!1&&ni.multiplyScalar(-ii.z);const n=this.material.rotation;let i,s;n!==0&&(s=Math.cos(n),i=Math.sin(n));const a=this.center;mr(fr.set(-.5,-.5,0),ii,a,ni,i,s),mr(Ci.set(.5,-.5,0),ii,a,ni,i,s),mr(pr.set(.5,.5,0),ii,a,ni,i,s),Co.set(0,0),ls.set(1,0),Ro.set(1,1);let o=t.ray.intersectTriangle(fr,Ci,pr,!1,Ai);if(o===null&&(mr(Ci.set(-.5,.5,0),ii,a,ni,i,s),ls.set(0,1),o=t.ray.intersectTriangle(fr,pr,Ci,!1,Ai),o===null))return;const l=t.ray.origin.distanceTo(Ai);l<t.near||l>t.far||e.push({distance:l,point:Ai.clone(),uv:Ie.getInterpolation(Ai,fr,Ci,pr,Co,ls,Ro,new wt),face:null,object:this})}copy(t,e){return super.copy(t,e),t.center!==void 0&&this.center.copy(t.center),this.material=t.material,this}}function mr(r,t,e,n,i,s){ri.subVectors(r,e).addScalar(.5).multiply(n),i!==void 0?(wi.x=s*ri.x-i*ri.y,wi.y=i*ri.x+s*ri.y):wi.copy(ri),r.copy(t),r.x+=wi.x,r.y+=wi.y,r.applyMatrix4(gl)}class _a extends Se{constructor(t,e,n,i,s,a,o,l,c){super(t,e,n,i,s,a,o,l,c),this.isCanvasTexture=!0,this.needsUpdate=!0}}class ln{constructor(){this.type="Curve",this.arcLengthDivisions=200}getPoint(){return console.warn("THREE.Curve: .getPoint() not implemented."),null}getPointAt(t,e){const n=this.getUtoTmapping(t);return this.getPoint(n,e)}getPoints(t=5){const e=[];for(let n=0;n<=t;n++)e.push(this.getPoint(n/t));return e}getSpacedPoints(t=5){const e=[];for(let n=0;n<=t;n++)e.push(this.getPointAt(n/t));return e}getLength(){const t=this.getLengths();return t[t.length-1]}getLengths(t=this.arcLengthDivisions){if(this.cacheArcLengths&&this.cacheArcLengths.length===t+1&&!this.needsUpdate)return this.cacheArcLengths;this.needsUpdate=!1;const e=[];let n,i=this.getPoint(0),s=0;e.push(0);for(let a=1;a<=t;a++)n=this.getPoint(a/t),s+=n.distanceTo(i),e.push(s),i=n;return this.cacheArcLengths=e,e}updateArcLengths(){this.needsUpdate=!0,this.getLengths()}getUtoTmapping(t,e){const n=this.getLengths();let i=0;const s=n.length;let a;e?a=e:a=t*n[s-1];let o=0,l=s-1,c;for(;o<=l;)if(i=Math.floor(o+(l-o)/2),c=n[i]-a,c<0)o=i+1;else if(c>0)l=i-1;else{l=i;break}if(i=l,n[i]===a)return i/(s-1);const h=n[i],d=n[i+1]-h,m=(a-h)/d;return(i+m)/(s-1)}getTangent(t,e){let i=t-1e-4,s=t+1e-4;i<0&&(i=0),s>1&&(s=1);const a=this.getPoint(i),o=this.getPoint(s),l=e||(a.isVector2?new wt:new U);return l.copy(o).sub(a).normalize(),l}getTangentAt(t,e){const n=this.getUtoTmapping(t);return this.getTangent(n,e)}computeFrenetFrames(t,e){const n=new U,i=[],s=[],a=[],o=new U,l=new re;for(let m=0;m<=t;m++){const g=m/t;i[m]=this.getTangentAt(g,new U)}s[0]=new U,a[0]=new U;let c=Number.MAX_VALUE;const h=Math.abs(i[0].x),u=Math.abs(i[0].y),d=Math.abs(i[0].z);h<=c&&(c=h,n.set(1,0,0)),u<=c&&(c=u,n.set(0,1,0)),d<=c&&n.set(0,0,1),o.crossVectors(i[0],n).normalize(),s[0].crossVectors(i[0],o),a[0].crossVectors(i[0],s[0]);for(let m=1;m<=t;m++){if(s[m]=s[m-1].clone(),a[m]=a[m-1].clone(),o.crossVectors(i[m-1],i[m]),o.length()>Number.EPSILON){o.normalize();const g=Math.acos(_e(i[m-1].dot(i[m]),-1,1));s[m].applyMatrix4(l.makeRotationAxis(o,g))}a[m].crossVectors(i[m],s[m])}if(e===!0){let m=Math.acos(_e(s[0].dot(s[t]),-1,1));m/=t,i[0].dot(o.crossVectors(s[0],s[t]))>0&&(m=-m);for(let g=1;g<=t;g++)s[g].applyMatrix4(l.makeRotationAxis(i[g],m*g)),a[g].crossVectors(i[g],s[g])}return{tangents:i,normals:s,binormals:a}}clone(){return new this.constructor().copy(this)}copy(t){return this.arcLengthDivisions=t.arcLengthDivisions,this}toJSON(){const t={metadata:{version:4.6,type:"Curve",generator:"Curve.toJSON"}};return t.arcLengthDivisions=this.arcLengthDivisions,t.type=this.type,t}fromJSON(t){return this.arcLengthDivisions=t.arcLengthDivisions,this}}class vl extends ln{constructor(t=0,e=0,n=1,i=1,s=0,a=Math.PI*2,o=!1,l=0){super(),this.isEllipseCurve=!0,this.type="EllipseCurve",this.aX=t,this.aY=e,this.xRadius=n,this.yRadius=i,this.aStartAngle=s,this.aEndAngle=a,this.aClockwise=o,this.aRotation=l}getPoint(t,e=new wt){const n=e,i=Math.PI*2;let s=this.aEndAngle-this.aStartAngle;const a=Math.abs(s)<Number.EPSILON;for(;s<0;)s+=i;for(;s>i;)s-=i;s<Number.EPSILON&&(a?s=0:s=i),this.aClockwise===!0&&!a&&(s===i?s=-i:s=s-i);const o=this.aStartAngle+t*s;let l=this.aX+this.xRadius*Math.cos(o),c=this.aY+this.yRadius*Math.sin(o);if(this.aRotation!==0){const h=Math.cos(this.aRotation),u=Math.sin(this.aRotation),d=l-this.aX,m=c-this.aY;l=d*h-m*u+this.aX,c=d*u+m*h+this.aY}return n.set(l,c)}copy(t){return super.copy(t),this.aX=t.aX,this.aY=t.aY,this.xRadius=t.xRadius,this.yRadius=t.yRadius,this.aStartAngle=t.aStartAngle,this.aEndAngle=t.aEndAngle,this.aClockwise=t.aClockwise,this.aRotation=t.aRotation,this}toJSON(){const t=super.toJSON();return t.aX=this.aX,t.aY=this.aY,t.xRadius=this.xRadius,t.yRadius=this.yRadius,t.aStartAngle=this.aStartAngle,t.aEndAngle=this.aEndAngle,t.aClockwise=this.aClockwise,t.aRotation=this.aRotation,t}fromJSON(t){return super.fromJSON(t),this.aX=t.aX,this.aY=t.aY,this.xRadius=t.xRadius,this.yRadius=t.yRadius,this.aStartAngle=t.aStartAngle,this.aEndAngle=t.aEndAngle,this.aClockwise=t.aClockwise,this.aRotation=t.aRotation,this}}class Up extends vl{constructor(t,e,n,i,s,a){super(t,e,n,n,i,s,a),this.isArcCurve=!0,this.type="ArcCurve"}}function va(){let r=0,t=0,e=0,n=0;function i(s,a,o,l){r=s,t=o,e=-3*s+3*a-2*o-l,n=2*s-2*a+o+l}return{initCatmullRom:function(s,a,o,l,c){i(a,o,c*(o-s),c*(l-a))},initNonuniformCatmullRom:function(s,a,o,l,c,h,u){let d=(a-s)/c-(o-s)/(c+h)+(o-a)/h,m=(o-a)/h-(l-a)/(h+u)+(l-o)/u;d*=h,m*=h,i(a,o,d,m)},calc:function(s){const a=s*s,o=a*s;return r+t*s+e*a+n*o}}}const gr=new U,cs=new va,hs=new va,us=new va;class xl extends ln{constructor(t=[],e=!1,n="centripetal",i=.5){super(),this.isCatmullRomCurve3=!0,this.type="CatmullRomCurve3",this.points=t,this.closed=e,this.curveType=n,this.tension=i}getPoint(t,e=new U){const n=e,i=this.points,s=i.length,a=(s-(this.closed?0:1))*t;let o=Math.floor(a),l=a-o;this.closed?o+=o>0?0:(Math.floor(Math.abs(o)/s)+1)*s:l===0&&o===s-1&&(o=s-2,l=1);let c,h;this.closed||o>0?c=i[(o-1)%s]:(gr.subVectors(i[0],i[1]).add(i[0]),c=gr);const u=i[o%s],d=i[(o+1)%s];if(this.closed||o+2<s?h=i[(o+2)%s]:(gr.subVectors(i[s-1],i[s-2]).add(i[s-1]),h=gr),this.curveType==="centripetal"||this.curveType==="chordal"){const m=this.curveType==="chordal"?.5:.25;let g=Math.pow(c.distanceToSquared(u),m),v=Math.pow(u.distanceToSquared(d),m),p=Math.pow(d.distanceToSquared(h),m);v<1e-4&&(v=1),g<1e-4&&(g=v),p<1e-4&&(p=v),cs.initNonuniformCatmullRom(c.x,u.x,d.x,h.x,g,v,p),hs.initNonuniformCatmullRom(c.y,u.y,d.y,h.y,g,v,p),us.initNonuniformCatmullRom(c.z,u.z,d.z,h.z,g,v,p)}else this.curveType==="catmullrom"&&(cs.initCatmullRom(c.x,u.x,d.x,h.x,this.tension),hs.initCatmullRom(c.y,u.y,d.y,h.y,this.tension),us.initCatmullRom(c.z,u.z,d.z,h.z,this.tension));return n.set(cs.calc(l),hs.calc(l),us.calc(l)),n}copy(t){super.copy(t),this.points=[];for(let e=0,n=t.points.length;e<n;e++){const i=t.points[e];this.points.push(i.clone())}return this.closed=t.closed,this.curveType=t.curveType,this.tension=t.tension,this}toJSON(){const t=super.toJSON();t.points=[];for(let e=0,n=this.points.length;e<n;e++){const i=this.points[e];t.points.push(i.toArray())}return t.closed=this.closed,t.curveType=this.curveType,t.tension=this.tension,t}fromJSON(t){super.fromJSON(t),this.points=[];for(let e=0,n=t.points.length;e<n;e++){const i=t.points[e];this.points.push(new U().fromArray(i))}return this.closed=t.closed,this.curveType=t.curveType,this.tension=t.tension,this}}function Po(r,t,e,n,i){const s=(n-t)*.5,a=(i-e)*.5,o=r*r,l=r*o;return(2*e-2*n+s+a)*l+(-3*e+3*n-2*s-a)*o+s*r+e}function Np(r,t){const e=1-r;return e*e*t}function Fp(r,t){return 2*(1-r)*r*t}function Op(r,t){return r*r*t}function Ii(r,t,e,n){return Np(r,t)+Fp(r,e)+Op(r,n)}function Bp(r,t){const e=1-r;return e*e*e*t}function zp(r,t){const e=1-r;return 3*e*e*r*t}function Gp(r,t){return 3*(1-r)*r*r*t}function Vp(r,t){return r*r*r*t}function Ui(r,t,e,n,i){return Bp(r,t)+zp(r,e)+Gp(r,n)+Vp(r,i)}class Hp extends ln{constructor(t=new wt,e=new wt,n=new wt,i=new wt){super(),this.isCubicBezierCurve=!0,this.type="CubicBezierCurve",this.v0=t,this.v1=e,this.v2=n,this.v3=i}getPoint(t,e=new wt){const n=e,i=this.v0,s=this.v1,a=this.v2,o=this.v3;return n.set(Ui(t,i.x,s.x,a.x,o.x),Ui(t,i.y,s.y,a.y,o.y)),n}copy(t){return super.copy(t),this.v0.copy(t.v0),this.v1.copy(t.v1),this.v2.copy(t.v2),this.v3.copy(t.v3),this}toJSON(){const t=super.toJSON();return t.v0=this.v0.toArray(),t.v1=this.v1.toArray(),t.v2=this.v2.toArray(),t.v3=this.v3.toArray(),t}fromJSON(t){return super.fromJSON(t),this.v0.fromArray(t.v0),this.v1.fromArray(t.v1),this.v2.fromArray(t.v2),this.v3.fromArray(t.v3),this}}class kp extends ln{constructor(t=new U,e=new U,n=new U,i=new U){super(),this.isCubicBezierCurve3=!0,this.type="CubicBezierCurve3",this.v0=t,this.v1=e,this.v2=n,this.v3=i}getPoint(t,e=new U){const n=e,i=this.v0,s=this.v1,a=this.v2,o=this.v3;return n.set(Ui(t,i.x,s.x,a.x,o.x),Ui(t,i.y,s.y,a.y,o.y),Ui(t,i.z,s.z,a.z,o.z)),n}copy(t){return super.copy(t),this.v0.copy(t.v0),this.v1.copy(t.v1),this.v2.copy(t.v2),this.v3.copy(t.v3),this}toJSON(){const t=super.toJSON();return t.v0=this.v0.toArray(),t.v1=this.v1.toArray(),t.v2=this.v2.toArray(),t.v3=this.v3.toArray(),t}fromJSON(t){return super.fromJSON(t),this.v0.fromArray(t.v0),this.v1.fromArray(t.v1),this.v2.fromArray(t.v2),this.v3.fromArray(t.v3),this}}class Wp extends ln{constructor(t=new wt,e=new wt){super(),this.isLineCurve=!0,this.type="LineCurve",this.v1=t,this.v2=e}getPoint(t,e=new wt){const n=e;return t===1?n.copy(this.v2):(n.copy(this.v2).sub(this.v1),n.multiplyScalar(t).add(this.v1)),n}getPointAt(t,e){return this.getPoint(t,e)}getTangent(t,e=new wt){return e.subVectors(this.v2,this.v1).normalize()}getTangentAt(t,e){return this.getTangent(t,e)}copy(t){return super.copy(t),this.v1.copy(t.v1),this.v2.copy(t.v2),this}toJSON(){const t=super.toJSON();return t.v1=this.v1.toArray(),t.v2=this.v2.toArray(),t}fromJSON(t){return super.fromJSON(t),this.v1.fromArray(t.v1),this.v2.fromArray(t.v2),this}}class Ml extends ln{constructor(t=new U,e=new U){super(),this.isLineCurve3=!0,this.type="LineCurve3",this.v1=t,this.v2=e}getPoint(t,e=new U){const n=e;return t===1?n.copy(this.v2):(n.copy(this.v2).sub(this.v1),n.multiplyScalar(t).add(this.v1)),n}getPointAt(t,e){return this.getPoint(t,e)}getTangent(t,e=new U){return e.subVectors(this.v2,this.v1).normalize()}getTangentAt(t,e){return this.getTangent(t,e)}copy(t){return super.copy(t),this.v1.copy(t.v1),this.v2.copy(t.v2),this}toJSON(){const t=super.toJSON();return t.v1=this.v1.toArray(),t.v2=this.v2.toArray(),t}fromJSON(t){return super.fromJSON(t),this.v1.fromArray(t.v1),this.v2.fromArray(t.v2),this}}class Xp extends ln{constructor(t=new wt,e=new wt,n=new wt){super(),this.isQuadraticBezierCurve=!0,this.type="QuadraticBezierCurve",this.v0=t,this.v1=e,this.v2=n}getPoint(t,e=new wt){const n=e,i=this.v0,s=this.v1,a=this.v2;return n.set(Ii(t,i.x,s.x,a.x),Ii(t,i.y,s.y,a.y)),n}copy(t){return super.copy(t),this.v0.copy(t.v0),this.v1.copy(t.v1),this.v2.copy(t.v2),this}toJSON(){const t=super.toJSON();return t.v0=this.v0.toArray(),t.v1=this.v1.toArray(),t.v2=this.v2.toArray(),t}fromJSON(t){return super.fromJSON(t),this.v0.fromArray(t.v0),this.v1.fromArray(t.v1),this.v2.fromArray(t.v2),this}}class Sl extends ln{constructor(t=new U,e=new U,n=new U){super(),this.isQuadraticBezierCurve3=!0,this.type="QuadraticBezierCurve3",this.v0=t,this.v1=e,this.v2=n}getPoint(t,e=new U){const n=e,i=this.v0,s=this.v1,a=this.v2;return n.set(Ii(t,i.x,s.x,a.x),Ii(t,i.y,s.y,a.y),Ii(t,i.z,s.z,a.z)),n}copy(t){return super.copy(t),this.v0.copy(t.v0),this.v1.copy(t.v1),this.v2.copy(t.v2),this}toJSON(){const t=super.toJSON();return t.v0=this.v0.toArray(),t.v1=this.v1.toArray(),t.v2=this.v2.toArray(),t}fromJSON(t){return super.fromJSON(t),this.v0.fromArray(t.v0),this.v1.fromArray(t.v1),this.v2.fromArray(t.v2),this}}class Yp extends ln{constructor(t=[]){super(),this.isSplineCurve=!0,this.type="SplineCurve",this.points=t}getPoint(t,e=new wt){const n=e,i=this.points,s=(i.length-1)*t,a=Math.floor(s),o=s-a,l=i[a===0?a:a-1],c=i[a],h=i[a>i.length-2?i.length-1:a+1],u=i[a>i.length-3?i.length-1:a+2];return n.set(Po(o,l.x,c.x,h.x,u.x),Po(o,l.y,c.y,h.y,u.y)),n}copy(t){super.copy(t),this.points=[];for(let e=0,n=t.points.length;e<n;e++){const i=t.points[e];this.points.push(i.clone())}return this}toJSON(){const t=super.toJSON();t.points=[];for(let e=0,n=this.points.length;e<n;e++){const i=this.points[e];t.points.push(i.toArray())}return t}fromJSON(t){super.fromJSON(t),this.points=[];for(let e=0,n=t.points.length;e<n;e++){const i=t.points[e];this.points.push(new wt().fromArray(i))}return this}}var qp=Object.freeze({__proto__:null,ArcCurve:Up,CatmullRomCurve3:xl,CubicBezierCurve:Hp,CubicBezierCurve3:kp,EllipseCurve:vl,LineCurve:Wp,LineCurve3:Ml,QuadraticBezierCurve:Xp,QuadraticBezierCurve3:Sl,SplineCurve:Yp});class xa extends we{constructor(t=1,e=1,n=1,i=32,s=1,a=!1,o=0,l=Math.PI*2){super(),this.type="CylinderGeometry",this.parameters={radiusTop:t,radiusBottom:e,height:n,radialSegments:i,heightSegments:s,openEnded:a,thetaStart:o,thetaLength:l};const c=this;i=Math.floor(i),s=Math.floor(s);const h=[],u=[],d=[],m=[];let g=0;const v=[],p=n/2;let f=0;A(),a===!1&&(t>0&&E(!0),e>0&&E(!1)),this.setIndex(h),this.setAttribute("position",new le(u,3)),this.setAttribute("normal",new le(d,3)),this.setAttribute("uv",new le(m,2));function A(){const S=new U,R=new U;let b=0;const w=(e-t)/n;for(let I=0;I<=s;I++){const y=[],M=I/s,D=M*(e-t)+t;for(let k=0;k<=i;k++){const V=k/i,K=V*l+o,j=Math.sin(K),Z=Math.cos(K);R.x=D*j,R.y=-M*n+p,R.z=D*Z,u.push(R.x,R.y,R.z),S.set(j,w,Z).normalize(),d.push(S.x,S.y,S.z),m.push(V,1-M),y.push(g++)}v.push(y)}for(let I=0;I<i;I++)for(let y=0;y<s;y++){const M=v[y][I],D=v[y+1][I],k=v[y+1][I+1],V=v[y][I+1];(t>0||y!==0)&&(h.push(M,D,V),b+=3),(e>0||y!==s-1)&&(h.push(D,k,V),b+=3)}c.addGroup(f,b,0),f+=b}function E(S){const R=g,b=new wt,w=new U;let I=0;const y=S===!0?t:e,M=S===!0?1:-1;for(let k=1;k<=i;k++)u.push(0,p*M,0),d.push(0,M,0),m.push(.5,.5),g++;const D=g;for(let k=0;k<=i;k++){const K=k/i*l+o,j=Math.cos(K),Z=Math.sin(K);w.x=y*Z,w.y=p*M,w.z=y*j,u.push(w.x,w.y,w.z),d.push(0,M,0),b.x=j*.5+.5,b.y=Z*.5*M+.5,m.push(b.x,b.y),g++}for(let k=0;k<i;k++){const V=R+k,K=D+k;S===!0?h.push(K,K+1,V):h.push(K+1,K,V),I+=3}c.addGroup(f,I,S===!0?1:2),f+=I}}copy(t){return super.copy(t),this.parameters=Object.assign({},t.parameters),this}static fromJSON(t){return new xa(t.radiusTop,t.radiusBottom,t.height,t.radialSegments,t.heightSegments,t.openEnded,t.thetaStart,t.thetaLength)}}class Ma extends we{constructor(t=1,e=32,n=16,i=0,s=Math.PI*2,a=0,o=Math.PI){super(),this.type="SphereGeometry",this.parameters={radius:t,widthSegments:e,heightSegments:n,phiStart:i,phiLength:s,thetaStart:a,thetaLength:o},e=Math.max(3,Math.floor(e)),n=Math.max(2,Math.floor(n));const l=Math.min(a+o,Math.PI);let c=0;const h=[],u=new U,d=new U,m=[],g=[],v=[],p=[];for(let f=0;f<=n;f++){const A=[],E=f/n;let S=0;f===0&&a===0?S=.5/e:f===n&&l===Math.PI&&(S=-.5/e);for(let R=0;R<=e;R++){const b=R/e;u.x=-t*Math.cos(i+b*s)*Math.sin(a+E*o),u.y=t*Math.cos(a+E*o),u.z=t*Math.sin(i+b*s)*Math.sin(a+E*o),g.push(u.x,u.y,u.z),d.copy(u).normalize(),v.push(d.x,d.y,d.z),p.push(b+S,1-E),A.push(c++)}h.push(A)}for(let f=0;f<n;f++)for(let A=0;A<e;A++){const E=h[f][A+1],S=h[f][A],R=h[f+1][A],b=h[f+1][A+1];(f!==0||a>0)&&m.push(E,S,b),(f!==n-1||l<Math.PI)&&m.push(S,R,b)}this.setIndex(m),this.setAttribute("position",new le(g,3)),this.setAttribute("normal",new le(v,3)),this.setAttribute("uv",new le(p,2))}copy(t){return super.copy(t),this.parameters=Object.assign({},t.parameters),this}static fromJSON(t){return new Ma(t.radius,t.widthSegments,t.heightSegments,t.phiStart,t.phiLength,t.thetaStart,t.thetaLength)}}class zi extends we{constructor(t=1,e=.4,n=12,i=48,s=Math.PI*2){super(),this.type="TorusGeometry",this.parameters={radius:t,tube:e,radialSegments:n,tubularSegments:i,arc:s},n=Math.floor(n),i=Math.floor(i);const a=[],o=[],l=[],c=[],h=new U,u=new U,d=new U;for(let m=0;m<=n;m++)for(let g=0;g<=i;g++){const v=g/i*s,p=m/n*Math.PI*2;u.x=(t+e*Math.cos(p))*Math.cos(v),u.y=(t+e*Math.cos(p))*Math.sin(v),u.z=e*Math.sin(p),o.push(u.x,u.y,u.z),h.x=t*Math.cos(v),h.y=t*Math.sin(v),d.subVectors(u,h).normalize(),l.push(d.x,d.y,d.z),c.push(g/i),c.push(m/n)}for(let m=1;m<=n;m++)for(let g=1;g<=i;g++){const v=(i+1)*m+g-1,p=(i+1)*(m-1)+g-1,f=(i+1)*(m-1)+g,A=(i+1)*m+g;a.push(v,p,A),a.push(p,f,A)}this.setIndex(a),this.setAttribute("position",new le(o,3)),this.setAttribute("normal",new le(l,3)),this.setAttribute("uv",new le(c,2))}copy(t){return super.copy(t),this.parameters=Object.assign({},t.parameters),this}static fromJSON(t){return new zi(t.radius,t.tube,t.radialSegments,t.tubularSegments,t.arc)}}class Ni extends we{constructor(t=new Sl(new U(-1,-1,0),new U(-1,1,0),new U(1,1,0)),e=64,n=1,i=8,s=!1){super(),this.type="TubeGeometry",this.parameters={path:t,tubularSegments:e,radius:n,radialSegments:i,closed:s};const a=t.computeFrenetFrames(e,s);this.tangents=a.tangents,this.normals=a.normals,this.binormals=a.binormals;const o=new U,l=new U,c=new wt;let h=new U;const u=[],d=[],m=[],g=[];v(),this.setIndex(g),this.setAttribute("position",new le(u,3)),this.setAttribute("normal",new le(d,3)),this.setAttribute("uv",new le(m,2));function v(){for(let E=0;E<e;E++)p(E);p(s===!1?e:0),A(),f()}function p(E){h=t.getPointAt(E/e,h);const S=a.normals[E],R=a.binormals[E];for(let b=0;b<=i;b++){const w=b/i*Math.PI*2,I=Math.sin(w),y=-Math.cos(w);l.x=y*S.x+I*R.x,l.y=y*S.y+I*R.y,l.z=y*S.z+I*R.z,l.normalize(),d.push(l.x,l.y,l.z),o.x=h.x+n*l.x,o.y=h.y+n*l.y,o.z=h.z+n*l.z,u.push(o.x,o.y,o.z)}}function f(){for(let E=1;E<=e;E++)for(let S=1;S<=i;S++){const R=(i+1)*(E-1)+(S-1),b=(i+1)*E+(S-1),w=(i+1)*E+S,I=(i+1)*(E-1)+S;g.push(R,b,I),g.push(b,w,I)}}function A(){for(let E=0;E<=e;E++)for(let S=0;S<=i;S++)c.x=E/e,c.y=S/i,m.push(c.x,c.y)}}copy(t){return super.copy(t),this.parameters=Object.assign({},t.parameters),this}toJSON(){const t=super.toJSON();return t.path=this.parameters.path.toJSON(),t}static fromJSON(t){return new Ni(new qp[t.path.type]().fromJSON(t.path),t.tubularSegments,t.radius,t.radialSegments,t.closed)}}class Di extends vi{static get type(){return"MeshStandardMaterial"}constructor(t){super(),this.isMeshStandardMaterial=!0,this.defines={STANDARD:""},this.color=new kt(16777215),this.roughness=1,this.metalness=0,this.map=null,this.lightMap=null,this.lightMapIntensity=1,this.aoMap=null,this.aoMapIntensity=1,this.emissive=new kt(0),this.emissiveIntensity=1,this.emissiveMap=null,this.bumpMap=null,this.bumpScale=1,this.normalMap=null,this.normalMapType=Jo,this.normalScale=new wt(1,1),this.displacementMap=null,this.displacementScale=1,this.displacementBias=0,this.roughnessMap=null,this.metalnessMap=null,this.alphaMap=null,this.envMap=null,this.envMapRotation=new qe,this.envMapIntensity=1,this.wireframe=!1,this.wireframeLinewidth=1,this.wireframeLinecap="round",this.wireframeLinejoin="round",this.flatShading=!1,this.fog=!0,this.setValues(t)}copy(t){return super.copy(t),this.defines={STANDARD:""},this.color.copy(t.color),this.roughness=t.roughness,this.metalness=t.metalness,this.map=t.map,this.lightMap=t.lightMap,this.lightMapIntensity=t.lightMapIntensity,this.aoMap=t.aoMap,this.aoMapIntensity=t.aoMapIntensity,this.emissive.copy(t.emissive),this.emissiveMap=t.emissiveMap,this.emissiveIntensity=t.emissiveIntensity,this.bumpMap=t.bumpMap,this.bumpScale=t.bumpScale,this.normalMap=t.normalMap,this.normalMapType=t.normalMapType,this.normalScale.copy(t.normalScale),this.displacementMap=t.displacementMap,this.displacementScale=t.displacementScale,this.displacementBias=t.displacementBias,this.roughnessMap=t.roughnessMap,this.metalnessMap=t.metalnessMap,this.alphaMap=t.alphaMap,this.envMap=t.envMap,this.envMapRotation.copy(t.envMapRotation),this.envMapIntensity=t.envMapIntensity,this.wireframe=t.wireframe,this.wireframeLinewidth=t.wireframeLinewidth,this.wireframeLinecap=t.wireframeLinecap,this.wireframeLinejoin=t.wireframeLinejoin,this.flatShading=t.flatShading,this.fog=t.fog,this}}class yl extends fe{constructor(t,e=1){super(),this.isLight=!0,this.type="Light",this.color=new kt(t),this.intensity=e}dispose(){}copy(t,e){return super.copy(t,e),this.color.copy(t.color),this.intensity=t.intensity,this}toJSON(t){const e=super.toJSON(t);return e.object.color=this.color.getHex(),e.object.intensity=this.intensity,this.groundColor!==void 0&&(e.object.groundColor=this.groundColor.getHex()),this.distance!==void 0&&(e.object.distance=this.distance),this.angle!==void 0&&(e.object.angle=this.angle),this.decay!==void 0&&(e.object.decay=this.decay),this.penumbra!==void 0&&(e.object.penumbra=this.penumbra),this.shadow!==void 0&&(e.object.shadow=this.shadow.toJSON()),this.target!==void 0&&(e.object.target=this.target.uuid),e}}const ds=new re,Lo=new U,Do=new U;class $p{constructor(t){this.camera=t,this.intensity=1,this.bias=0,this.normalBias=0,this.radius=1,this.blurSamples=8,this.mapSize=new wt(512,512),this.map=null,this.mapPass=null,this.matrix=new re,this.autoUpdate=!0,this.needsUpdate=!1,this._frustum=new pa,this._frameExtents=new wt(1,1),this._viewportCount=1,this._viewports=[new ae(0,0,1,1)]}getViewportCount(){return this._viewportCount}getFrustum(){return this._frustum}updateMatrices(t){const e=this.camera,n=this.matrix;Lo.setFromMatrixPosition(t.matrixWorld),e.position.copy(Lo),Do.setFromMatrixPosition(t.target.matrixWorld),e.lookAt(Do),e.updateMatrixWorld(),ds.multiplyMatrices(e.projectionMatrix,e.matrixWorldInverse),this._frustum.setFromProjectionMatrix(ds),n.set(.5,0,0,.5,0,.5,0,.5,0,0,.5,.5,0,0,0,1),n.multiply(ds)}getViewport(t){return this._viewports[t]}getFrameExtents(){return this._frameExtents}dispose(){this.map&&this.map.dispose(),this.mapPass&&this.mapPass.dispose()}copy(t){return this.camera=t.camera.clone(),this.intensity=t.intensity,this.bias=t.bias,this.radius=t.radius,this.mapSize.copy(t.mapSize),this}clone(){return new this.constructor().copy(this)}toJSON(){const t={};return this.intensity!==1&&(t.intensity=this.intensity),this.bias!==0&&(t.bias=this.bias),this.normalBias!==0&&(t.normalBias=this.normalBias),this.radius!==1&&(t.radius=this.radius),(this.mapSize.x!==512||this.mapSize.y!==512)&&(t.mapSize=this.mapSize.toArray()),t.camera=this.camera.toJSON(!1).object,delete t.camera.matrix,t}}class Zp extends $p{constructor(){super(new hl(-5,5,5,-5,.5,500)),this.isDirectionalLightShadow=!0}}class Io extends yl{constructor(t,e){super(t,e),this.isDirectionalLight=!0,this.type="DirectionalLight",this.position.copy(fe.DEFAULT_UP),this.updateMatrix(),this.target=new fe,this.shadow=new Zp}dispose(){this.shadow.dispose()}copy(t){return super.copy(t),this.target=t.target.clone(),this.shadow=t.shadow.clone(),this}}class Kp extends yl{constructor(t,e){super(t,e),this.isAmbientLight=!0,this.type="AmbientLight"}}const Uo=new re;class Jp{constructor(t,e,n=0,i=1/0){this.ray=new nl(t,e),this.near=n,this.far=i,this.camera=null,this.layers=new fa,this.params={Mesh:{},Line:{threshold:1},LOD:{},Points:{threshold:1},Sprite:{}}}set(t,e){this.ray.set(t,e)}setFromCamera(t,e){e.isPerspectiveCamera?(this.ray.origin.setFromMatrixPosition(e.matrixWorld),this.ray.direction.set(t.x,t.y,.5).unproject(e).sub(this.ray.origin).normalize(),this.camera=e):e.isOrthographicCamera?(this.ray.origin.set(t.x,t.y,(e.near+e.far)/(e.near-e.far)).unproject(e),this.ray.direction.set(0,0,-1).transformDirection(e.matrixWorld),this.camera=e):console.error("THREE.Raycaster: Unsupported camera type: "+e.type)}setFromXRController(t){return Uo.identity().extractRotation(t.matrixWorld),this.ray.origin.setFromMatrixPosition(t.matrixWorld),this.ray.direction.set(0,0,-1).applyMatrix4(Uo),this}intersectObject(t,e=!0,n=[]){return ra(t,this,n,e),n.sort(No),n}intersectObjects(t,e=!0,n=[]){for(let i=0,s=t.length;i<s;i++)ra(t[i],this,n,e);return n.sort(No),n}}function No(r,t){return r.distance-t.distance}function ra(r,t,e,n){let i=!0;if(r.layers.test(t.layers)&&r.raycast(t,e)===!1&&(i=!1),i===!0&&n===!0){const s=r.children;for(let a=0,o=s.length;a<o;a++)ra(s[a],t,e,!0)}}typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("register",{detail:{revision:sa}}));typeof window<"u"&&(window.__THREE__?console.warn("WARNING: Multiple instances of Three.js being imported."):window.__THREE__=sa);const fs="marble_face_avatars",ze=class ze{static getAll(){try{const t=localStorage.getItem(fs);return t?JSON.parse(t):{}}catch{return{}}}static getAvatar(t){if(!t)return null;const e=t.trim();return ze.getAll()[e]||null}static setAvatar(t,e){if(!t)return;const n=t.trim(),i=ze.getAll();i[n]=e;try{localStorage.setItem(fs,JSON.stringify(i))}catch(s){console.warn("Failed to save avatar to localStorage:",s)}ze.cache.delete(n)}static removeAvatar(t){if(!t)return;const e=t.trim(),n=ze.getAll();delete n[e];try{localStorage.setItem(fs,JSON.stringify(n))}catch(i){console.warn("Failed to update localStorage after avatar removal:",i)}ze.cache.delete(e)}static async processImageBlob(t,e=1.2,n=.43){return new Promise((i,s)=>{const a=new Image,o=URL.createObjectURL(t);a.onload=()=>{URL.revokeObjectURL(o);const l=document.createElement("canvas"),c=160;l.width=c,l.height=c;const h=l.getContext("2d"),d=Math.min(a.width,a.height)/Math.max(.5,Math.min(2.5,e)),m=a.width/2,g=a.height*n;let v=m-d/2,p=g-d/2;v<0&&(v=0),p<0&&(p=0),v+d>a.width&&(v=Math.max(0,a.width-d)),p+d>a.height&&(p=Math.max(0,a.height-d)),h.beginPath(),h.arc(c/2,c/2,c/2-2,0,Math.PI*2),h.closePath(),h.clip(),h.imageSmoothingEnabled=!0,h.imageSmoothingQuality="high",h.drawImage(a,v,p,d,d,0,0,c,c),h.beginPath(),h.arc(c/2,c/2,c/2-2,0,Math.PI*2),h.strokeStyle="rgba(255, 255, 255, 0.4)",h.lineWidth=2,h.stroke();const f=l.toDataURL("image/webp",.9);i(f)},a.onerror=l=>{URL.revokeObjectURL(o),s(l)},a.src=o})}static getTexture(t,e){const n=ze.getAvatar(t);if(!n)return null;const i=ze.cache.get(t);if(i)return i;const s=document.createElement("canvas");s.width=256,s.height=256;const a=s.getContext("2d");a.fillStyle=e,a.fillRect(0,0,256,256);const o=new _a(s),l=new Image;return l.onload=()=>{const c=(h,u,d)=>{a.save(),a.beginPath(),a.arc(h,u,d,0,Math.PI*2),a.fillStyle="#ffffff",a.fill(),a.lineWidth=5,a.strokeStyle="#ffd700",a.stroke(),a.clip(),a.drawImage(l,h-d,u-d,d*2,d*2),a.restore()};c(128,128,75),c(0,128,65),c(256,128,65),o.needsUpdate=!0},l.src=n,ze.cache.set(t,o),o}};q(ze,"cache",new Map);let sn=ze;class jp{constructor(t){q(this,"group");q(this,"sphereMesh");q(this,"selectionRingMesh");q(this,"nameSprite");q(this,"marbleId");q(this,"isSelected",!1);q(this,"lastPos",null);q(this,"marbleColor");q(this,"marbleName");this.marbleId=t.id,this.marbleColor=t.color,this.marbleName=t.name,this.group=new On;const e=.28,n=new Ma(e,28,28),i=sn.getTexture(t.name,t.color),s=new Di({color:i?16777215:new kt(t.color),map:i||null,emissive:i?new kt(3355443):new kt(t.color),emissiveIntensity:i?.2:.35,roughness:.15,metalness:.25});this.sphereMesh=new de(n,s),this.sphereMesh.castShadow=!0,this.group.add(this.sphereMesh);const a=new zi(.38,.025,12,32),o=new Bi({color:16766720,transparent:!0,opacity:.9});this.selectionRingMesh=new de(a,o),this.selectionRingMesh.visible=!1,this.group.add(this.selectionRingMesh),this.nameSprite=this.createNameSprite(t),this.nameSprite.position.set(0,e+.35,0),this.group.add(this.nameSprite)}createNameSprite(t){const e=document.createElement("canvas");e.width=256,e.height=80;const n=e.getContext("2d");n.fillStyle="rgba(15, 20, 26, 0.85)",n.strokeStyle=t.color,n.lineWidth=4;const i=16,s=240,a=64,o=8,l=8;n.beginPath(),n.moveTo(o+i,l),n.arcTo(o+s,l,o+s,l+a,i),n.arcTo(o+s,l+a,o,l+a,i),n.arcTo(o,l+a,o,l,i),n.arcTo(o,l,o+s,l,i),n.closePath(),n.fill(),n.stroke(),n.textAlign="center",n.textBaseline="middle",n.font='bold 28px "Pretendard", "Noto Sans KR", sans-serif',n.fillStyle="#ffffff";const c=t.name.length>8?`${t.name.slice(0,7)}…`:t.name;n.fillText(c,128,40);const h=new _a(e);h.minFilter=Ve;const u=new ga({map:h,depthTest:!0,transparent:!0}),d=new _l(u);return d.scale.set(1.4,.44,1),d.renderOrder=10,d}updateTransform(t,e,n){const i=t.currentAngle,s=e,a=s*Math.sin(i),o=n/2-t.currentY,l=s*Math.cos(i);this.group.position.set(a,o,l);const c=.42,h=Math.sin(i),u=Math.cos(i);this.nameSprite.position.set(h*c,.28+.35,u*c);const d=Math.max(0,Math.min(1,(l/Math.max(.1,s)+1)/2));this.nameSprite.material.opacity=.3+.7*d;const m=this.sphereMesh.material;m&&(m.emissiveIntensity=m.map?.1+.2*d:.15+.35*d);const g=new U(a,o,l);if(this.lastPos&&!t.isFinished&&t.isActive){const v=g.clone().sub(this.lastPos),p=v.length();if(p>.001&&p<1.5){const f=new U(h,0,u).normalize(),A=new U().crossVectors(f,v);if(A.lengthSq()>1e-5){A.normalize();const E=p/.28,S=new _i().setFromAxisAngle(A,E);this.sphereMesh.quaternion.premultiply(S)}}}if(this.lastPos=g,this.isSelected&&this.selectionRingMesh.visible){this.selectionRingMesh.position.set(h*.1,0,u*.1),this.selectionRingMesh.lookAt(h*10,0,u*10);const v=1+.12*Math.sin(Date.now()*.008);this.selectionRingMesh.scale.set(v,v,v)}if(t.isFinished){const v=1+.15*Math.sin(Date.now()*.008);this.sphereMesh.scale.set(v,v,v)}else this.sphereMesh.scale.set(1,1,1)}setSelected(t){this.isSelected=t,this.selectionRingMesh.visible=t}updateAvatarTexture(){const t=sn.getTexture(this.marbleName,this.marbleColor),e=this.sphereMesh.material;t?(e.map=t,e.color.setHex(16777215),e.emissive.setHex(3355443),e.emissiveIntensity=.2,e.needsUpdate=!0):(e.map=null,e.color.set(this.marbleColor),e.emissive.set(this.marbleColor),e.emissiveIntensity=.35,e.needsUpdate=!0)}resetRotation(){this.sphereMesh.quaternion.identity(),this.lastPos=null}destroy(){this.sphereMesh.geometry.dispose(),this.sphereMesh.material.dispose(),this.selectionRingMesh.geometry.dispose(),this.selectionRingMesh.material.dispose(),this.nameSprite.material.dispose()}}const Pn={neon:{name:"neon",ambientColor:2241348,ambientIntensity:1.2,dir1Color:58879,dir1Intensity:1.8,dir2Color:16711807,dir2Intensity:.4,railColor:3718648,railEmissive:165063,railEmissiveIntensity:.6,railRoughness:.2,railMetalness:.8,ringColor:58879,ringEmissive:58879,ringEmissiveIntensity:.5,ringRoughness:.2,ringMetalness:.7,coreColor:527638,coreOpacity:.4,coreRoughness:.35,coreMetalness:.15,bridgeHorizontalColor:65484,bridgeDiagonalColor:16711807},wooden:{name:"wooden",ambientColor:5916210,ambientIntensity:1.6,dir1Color:16772816,dir1Intensity:2,dir2Color:9857088,dir2Intensity:.6,railColor:10513732,railEmissive:4730136,railEmissiveIntensity:.25,railRoughness:.75,railMetalness:.1,ringColor:13938487,ringEmissive:7033628,ringEmissiveIntensity:.4,ringRoughness:.35,ringMetalness:.8,coreColor:3022614,coreOpacity:.7,coreRoughness:.8,coreMetalness:.05,bridgeHorizontalColor:13145688,bridgeDiagonalColor:14711356},space:{name:"space",ambientColor:2298943,ambientIntensity:1.4,dir1Color:3718648,dir1Intensity:1.9,dir2Color:14239471,dir2Intensity:.7,railColor:8490232,railEmissive:5195493,railEmissiveIntensity:.75,railRoughness:.2,railMetalness:.85,ringColor:15485081,ringEmissive:14362487,ringEmissiveIntensity:.7,ringRoughness:.2,ringMetalness:.9,coreColor:198424,coreOpacity:.55,coreRoughness:.2,coreMetalness:.4,bridgeHorizontalColor:440020,bridgeDiagonalColor:11032055}};class Qp{constructor(t,e,n){q(this,"canvas");q(this,"renderer");q(this,"scene");q(this,"camera");q(this,"cylinderGroup");q(this,"ladder");q(this,"runner");q(this,"ambientLight");q(this,"dirLight1");q(this,"dirLight2");q(this,"currentTheme","neon");q(this,"isNeonTrailEnabled",!0);q(this,"trailGroup");q(this,"marbleTrails",new Map);q(this,"marbleMeshes",new Map);q(this,"bridgeMeshes",new Map);q(this,"railMeshes",[]);q(this,"railHitMeshes",[]);q(this,"topRingMesh",null);q(this,"botRingMesh",null);q(this,"goalSprites",[]);q(this,"coreMesh",null);q(this,"onToast");q(this,"selectedMarbleId",null);q(this,"onMarbleSelect");q(this,"isEditMode",!0);q(this,"isDrawingBridge",!1);q(this,"drawStartCol",null);q(this,"drawStartY",0);q(this,"drawPointerStartX",0);q(this,"drawPointerStartY",0);q(this,"previewBridgeMesh",null);q(this,"isDraggingToRotate",!1);q(this,"prevPointerX",0);q(this,"prevPointerY",0);q(this,"isTopView",!1);q(this,"targetPitch",0);q(this,"hasUserManuallyZoomed",!1);q(this,"activePointers",new Map);q(this,"prevPinchDist",null);q(this,"cameraDistance",25.5);q(this,"raycaster",new Jp);q(this,"pointer",new wt);q(this,"goalNames",[]);q(this,"isCameraLocked",!1);this.canvas=t,this.ladder=e,this.runner=n,this.cameraDistance=this.calculateOptimalCameraDistance(),this.renderer=new Lp({canvas:t,antialias:!0,alpha:!0,powerPreference:"high-performance"}),this.renderer.setPixelRatio(Math.min(window.devicePixelRatio,2)),this.renderer.setSize(t.clientWidth,t.clientHeight,!1),this.renderer.toneMapping=zo,this.renderer.toneMappingExposure=1.1,this.scene=new Dp,this.camera=new De(45,t.clientWidth/t.clientHeight,.1,100),this.camera.position.set(0,0,this.cameraDistance);const i=Pn[this.currentTheme];this.ambientLight=new Kp(i.ambientColor,i.ambientIntensity),this.scene.add(this.ambientLight),this.dirLight1=new Io(i.dir1Color,i.dir1Intensity),this.dirLight1.position.set(0,10,12),this.scene.add(this.dirLight1),this.dirLight2=new Io(i.dir2Color,i.dir2Intensity),this.dirLight2.position.set(-5,-5,-8),this.scene.add(this.dirLight2),this.cylinderGroup=new On,this.scene.add(this.cylinderGroup),this.trailGroup=new On,this.cylinderGroup.add(this.trailGroup),this.runner.addEventListener("start",()=>{this.clearTrails()}),this.updateWorkspaceOffset(),this.buildCylinderStructure(),this.attachEvents()}calculateOptimalCameraDistance(){var i,s;const t=((i=this.canvas)==null?void 0:i.clientWidth)||window.innerWidth,e=((s=this.canvas)==null?void 0:s.clientHeight)||window.innerHeight,n=t/e;return t<=768||n<1?29:e<760?27:25.5}toggleTopView(){return this.isTopView=!this.isTopView,this.targetPitch=this.isTopView?Math.PI*.485:0,this.isTopView}toggleCameraLock(){return this.isCameraLocked=!this.isCameraLocked,this.isCameraLocked}setGoalNames(t){this.goalNames=t,this.updateGoalLabels()}buildCylinderStructure(){this.railMeshes.forEach(d=>{this.cylinderGroup.remove(d),d.geometry.dispose(),d.material.dispose()}),this.railMeshes=[],this.railHitMeshes.forEach(d=>{this.cylinderGroup.remove(d),d.geometry.dispose(),d.material.dispose()}),this.railHitMeshes=[],this.coreMesh&&(this.cylinderGroup.remove(this.coreMesh),this.coreMesh.geometry.dispose(),this.coreMesh.material.dispose(),this.coreMesh=null),this.topRingMesh&&(this.cylinderGroup.remove(this.topRingMesh),this.topRingMesh.geometry.dispose(),this.topRingMesh.material.dispose(),this.topRingMesh=null),this.botRingMesh&&(this.cylinderGroup.remove(this.botRingMesh),this.botRingMesh.geometry.dispose(),this.botRingMesh.material.dispose(),this.botRingMesh=null);const t=this.ladder.colCount,e=this.ladder.radiusTop,n=this.ladder.radiusBottom,i=this.ladder.height,s=Pn[this.currentTheme]||Pn.neon,a=.3,o=new xa(Math.max(.2,e-a),Math.max(.2,n-a),i+.1,48,1,!0),l=new Di({color:s.coreColor,roughness:s.coreRoughness,metalness:s.coreMetalness,transparent:!0,opacity:s.coreOpacity,side:Ge});this.coreMesh=new de(o,l),this.coreMesh.position.set(0,0,0),this.cylinderGroup.add(this.coreMesh);for(let d=0;d<t;d++){const m=d/t*Math.PI*2,g=e*Math.sin(m),v=e*Math.cos(m),p=n*Math.sin(m),f=n*Math.cos(m),A=new U(g,i/2,v),E=new U(p,-i/2,f),S=new Ml(A,E),R=new Ni(S,2,.065,8,!1),b=new Di({color:s.railColor,emissive:s.railEmissive,emissiveIntensity:s.railEmissiveIntensity,roughness:s.railRoughness,metalness:s.railMetalness}),w=new de(R,b);w.userData={isRail:!0,colIndex:d},this.cylinderGroup.add(w),this.railMeshes.push(w);const I=new Ni(S,2,.32,8,!1),y=new Bi({transparent:!0,opacity:0,depthWrite:!1}),M=new de(I,y);M.userData={isRail:!0,colIndex:d},this.cylinderGroup.add(M),this.railHitMeshes.push(M)}const c=new zi(e,.08,16,64),h=new Di({color:s.ringColor,emissive:s.ringEmissive,emissiveIntensity:s.ringEmissiveIntensity,roughness:s.ringRoughness,metalness:s.ringMetalness});this.topRingMesh=new de(c,h),this.topRingMesh.rotation.x=Math.PI/2,this.topRingMesh.position.y=i/2,this.cylinderGroup.add(this.topRingMesh);const u=new zi(n,.08,16,64);this.botRingMesh=new de(u,h.clone()),this.botRingMesh.rotation.x=Math.PI/2,this.botRingMesh.position.y=-i/2,this.cylinderGroup.add(this.botRingMesh),this.rebuildBridges(),this.updateGoalLabels(),this.syncMarbleMeshes()}rebuildBridges(){this.bridgeMeshes.forEach(t=>{this.cylinderGroup.remove(t),t.geometry.dispose(),t.material.dispose()}),this.bridgeMeshes.clear();for(const t of this.ladder.bridges){const e=this.createBridgeMesh(t);this.cylinderGroup.add(e),this.bridgeMeshes.set(t.id,e)}}createBridgeMesh(t,e=!1,n=!0){const i=this.ladder.colCount,s=this.ladder.height,a=t.fromCol/i*Math.PI*2;let l=t.toCol/i*Math.PI*2-a;l>Math.PI&&(l-=Math.PI*2),l<-Math.PI&&(l+=Math.PI*2);const c=[],h=16;for(let f=0;f<=h;f++){const A=f/h,E=a+l*A,S=t.fromY+(t.toY-t.fromY)*A,R=s/2-S,b=this.ladder.getRadiusAt(S),w=b*Math.sin(E),I=b*Math.cos(E);c.push(new U(w,R,I))}const u=new xl(c),d=new Ni(u,16,e?.08:.06,8,!1);let m;const g=Pn[this.currentTheme]||Pn.neon;e?m=n?16766720:16724838:m=t.isDiagonal?g.bridgeDiagonalColor:g.bridgeHorizontalColor;const v=new Di({color:m,emissive:m,emissiveIntensity:e?.8:.6,roughness:.3,metalness:.5}),p=new de(d,v);return p.userData={isBridge:!0,bridgeId:t.id},p}updateGoalLabels(){this.goalSprites.forEach(i=>{this.cylinderGroup.remove(i),i.material.dispose()}),this.goalSprites=[];const t=this.ladder.colCount,e=this.ladder.radiusBottom,n=this.ladder.height;for(let i=0;i<t;i++){const s=i/t*Math.PI*2,a=(e+.35)*Math.sin(s),o=(e+.35)*Math.cos(s),l=-n/2-.5,c=this.goalNames[i]||`골 #${i+1}`,h=this.createGoalSprite(c);h.position.set(a,l,o),this.cylinderGroup.add(h),this.goalSprites.push(h)}}createGoalSprite(t){const e=document.createElement("canvas");e.width=256,e.height=80;const n=e.getContext("2d");n.fillStyle="rgba(28, 32, 38, 0.9)",n.strokeStyle="#ffd700",n.lineWidth=4,n.beginPath(),n.roundRect(8,8,240,64,14),n.fill(),n.stroke(),n.textAlign="center",n.textBaseline="middle",n.font='bold 28px "Pretendard", sans-serif',n.fillStyle="#ffd700";const i=t.length>8?`${t.slice(0,7)}…`:t;n.fillText(i,128,40);const s=new _a(e),a=new ga({map:s,depthTest:!0,transparent:!0}),o=new _l(a);return o.scale.set(1.4,.44,1),o}attachEvents(){const t=this.canvas;t.addEventListener("pointerdown",n=>{if(this.activePointers.set(n.pointerId,{x:n.clientX,y:n.clientY}),this.activePointers.size===2){const[a,o]=Array.from(this.activePointers.values());this.prevPinchDist=Math.hypot(a.x-o.x,a.y-o.y),this.isDrawingBridge=!1,this.isDraggingToRotate=!1;return}if(this.activePointers.size>2)return;if(this.updatePointer(n),this.prevPointerX=n.clientX,this.prevPointerY=n.clientY,this.runner.isRunning){const a=this.raycastMarble();a!==null&&this.runner.startSingle(a);return}const i=this.raycastMarble();if(i!==null){this.runner.mode==="individual"?this.runner.startSingle(i):this.selectMarble(i);return}if(!this.runner.isRunning){const a=this.raycastBridge();if(a){this.selectMarble(null),this.ladder.removeBridge(a),Le.playBridgeRemove(),this.rebuildBridges();return}}const s=this.raycastRail();s&&this.isEditMode&&!this.runner.isRunning?(this.selectMarble(null),this.isDrawingBridge=!0,this.drawStartCol=s.colIndex,this.drawStartY=s.ladderY,this.drawPointerStartX=n.clientX,this.drawPointerStartY=n.clientY):(this.selectMarble(null),this.isDraggingToRotate=!0)}),window.addEventListener("pointermove",n=>{if(this.activePointers.has(n.pointerId)&&this.activePointers.set(n.pointerId,{x:n.clientX,y:n.clientY}),this.activePointers.size===2){const[i,s]=Array.from(this.activePointers.values()),a=Math.hypot(i.x-s.x,i.y-s.y);if(this.prevPinchDist!==null){const o=a-this.prevPinchDist;this.hasUserManuallyZoomed=!0,this.cameraDistance=Math.max(10,Math.min(45,this.cameraDistance-o*.04)),this.camera.position.z=this.cameraDistance}this.prevPinchDist=a;return}if(this.updatePointer(n),this.isDrawingBridge&&this.drawStartCol!==null){const i=this.raycastRail(),s=this.ladder.colCount,a=n.clientX-this.drawPointerStartX,o=(this.drawStartCol-1+s)%s,l=(this.drawStartCol+1)%s;let c=a<0?o:l,h=this.drawStartY;if(i)if(this.ladder.isAdjacent(this.drawStartCol,i.colIndex))c=i.colIndex,h=i.ladderY;else if(i.colIndex===this.drawStartCol){const m=n.clientY-this.drawPointerStartY;h=Math.max(.8,Math.min(this.ladder.height-.8,this.drawStartY+m*.015))}else h=i.ladderY;else{const m=n.clientY-this.drawPointerStartY;h=Math.max(.8,Math.min(this.ladder.height-.8,this.drawStartY+m*.015))}const d=!this.ladder.checkBridgeConflict(this.drawStartCol,c,this.drawStartY,h);this.previewBridgeMesh&&(this.cylinderGroup.remove(this.previewBridgeMesh),this.previewBridgeMesh.geometry.dispose(),this.previewBridgeMesh.material.dispose(),this.previewBridgeMesh=null),this.previewBridgeMesh=this.createBridgeMesh({id:"preview",fromCol:this.drawStartCol,toCol:c,fromY:this.drawStartY,toY:h,isDiagonal:Math.abs(this.drawStartY-h)>.15},!0,d),this.cylinderGroup.add(this.previewBridgeMesh)}else if(this.isDraggingToRotate){const i=n.clientX-this.prevPointerX,s=n.clientY-this.prevPointerY;this.cylinderGroup.rotation.y+=i*.008,this.cylinderGroup.rotation.x=Math.max(-Math.PI*.49,Math.min(Math.PI*.49,this.cylinderGroup.rotation.x+s*.006)),this.targetPitch=this.cylinderGroup.rotation.x,this.isTopView=this.targetPitch>1.1,this.prevPointerX=n.clientX,this.prevPointerY=n.clientY}});const e=n=>{var i;if(this.activePointers.delete(n.pointerId),this.activePointers.size<2&&(this.prevPinchDist=null),!(this.activePointers.size>0)){if(this.isDrawingBridge&&this.drawStartCol!==null){const s=this.raycastRail(),a=this.ladder.colCount,o=n.clientX-this.drawPointerStartX,l=(this.drawStartCol-1+a)%a,c=(this.drawStartCol+1)%a;let h=o<0?l:c,u=this.drawStartY;if(s&&this.ladder.isAdjacent(this.drawStartCol,s.colIndex))h=s.colIndex,u=s.ladderY;else{const m=n.clientY-this.drawPointerStartY;u=Math.max(.8,Math.min(this.ladder.height-.8,this.drawStartY+m*.015))}if(Math.abs(o)>=15||s&&s.colIndex!==this.drawStartCol){const m=this.ladder.checkBridgeConflict(this.drawStartCol,h,this.drawStartY,u);m?(i=this.onToast)==null||i.call(this,`⚠️ ${m} (살짝 위/아래로 그려보세요)`):this.ladder.addBridge(this.drawStartCol,h,this.drawStartY,u)&&(Le.playBridgeAdd(),this.rebuildBridges())}this.previewBridgeMesh&&(this.cylinderGroup.remove(this.previewBridgeMesh),this.previewBridgeMesh.geometry.dispose(),this.previewBridgeMesh.material.dispose(),this.previewBridgeMesh=null),this.isDrawingBridge=!1,this.drawStartCol=null}this.isDraggingToRotate=!1}};window.addEventListener("pointerup",e),window.addEventListener("pointercancel",e),t.addEventListener("wheel",n=>{n.preventDefault(),this.hasUserManuallyZoomed=!0,this.cameraDistance=Math.max(10,Math.min(45,this.cameraDistance+n.deltaY*.015)),this.camera.position.z=this.cameraDistance}),window.addEventListener("resize",()=>{this.resize()}),window.addEventListener("paste",async n=>{var a,o,l;if(this.selectedMarbleId===null)return;const i=this.runner.marbles.find(c=>c.id===this.selectedMarbleId);if(!i)return;const s=(a=n.clipboardData)==null?void 0:a.items;if(s)for(let c=0;c<s.length;c++){const h=s[c];if(h.type.indexOf("image")!==-1){const u=h.getAsFile();if(u){n.preventDefault();try{const d=await sn.processImageBlob(u);sn.setAvatar(i.name,d);const m=this.marbleMeshes.get(i.id);m&&m.updateAvatarTexture(),Le.playBridgeAdd(),(o=this.onToast)==null||o.call(this,`📷 [${i.name}] 마블에 얼굴 사진이 등록되었습니다!`)}catch(d){console.warn("Failed to process pasted image:",d),(l=this.onToast)==null||l.call(this,"⚠️ 이미지 처리 중 오류가 발생했습니다.")}break}}}}),window.addEventListener("keydown",n=>{var s,a;const i=(s=document.activeElement)==null?void 0:s.tagName;if(!(i==="INPUT"||i==="TEXTAREA"))if(n.key==="Backspace"||n.key==="Delete"){if(this.selectedMarbleId!==null){const o=this.runner.marbles.find(l=>l.id===this.selectedMarbleId);if(o&&sn.getAvatar(o.name)){sn.removeAvatar(o.name);const l=this.marbleMeshes.get(o.id);l&&l.updateAvatarTexture(),Le.playBridgeRemove(),(a=this.onToast)==null||a.call(this,`🗑️ [${o.name}] 얼굴 사진이 삭제되었습니다.`)}}}else n.key==="Escape"&&this.selectMarble(null)})}updatePointer(t){const e=this.canvas.getBoundingClientRect();this.pointer.x=(t.clientX-e.left)/e.width*2-1,this.pointer.y=-((t.clientY-e.top)/e.height)*2+1}raycastRail(){this.raycaster.setFromCamera(this.pointer,this.camera);const t=this.raycaster.intersectObjects(this.railHitMeshes);if(t.length>0){const e=t.find(o=>{const l=new U;return o.object.getWorldPosition(l),l.z>=-.8})||t[0],n=e.object.userData.colIndex,i=this.ladder.height,s=this.cylinderGroup.worldToLocal(e.point.clone()),a=Math.max(.8,Math.min(i-.8,i/2-s.y));return{colIndex:n,ladderY:a}}return null}raycastBridge(){this.raycaster.setFromCamera(this.pointer,this.camera);const t=Array.from(this.bridgeMeshes.values()),e=this.raycaster.intersectObjects(t);return e.length>0&&(e.find(i=>{const s=new U;return i.object.getWorldPosition(s),s.z>=-.5})||e[0]).object.userData.bridgeId||null}raycastMarble(){this.raycaster.setFromCamera(this.pointer,this.camera);const t=[];this.marbleMeshes.forEach(n=>t.push(n.sphereMesh));const e=this.raycaster.intersectObjects(t);if(e.length>0){const n=e[0].object;for(const[i,s]of this.marbleMeshes.entries())if(s.sphereMesh===n)return i}return null}updateWorkspaceOffset(){const t=this.canvas.clientWidth,e=this.canvas.clientHeight;if(t===0||e===0)return;const n=document.querySelector("#sidebar"),a=window.innerWidth>768&&!(n!=null&&n.classList.contains("collapsed"))?320:0;this.renderer.setSize(t,e,!1),this.camera.aspect=t/e,a>0?this.camera.setViewOffset(t+a,e,a,0,t,e):this.camera.clearViewOffset(),this.camera.updateProjectionMatrix()}resize(){this.updateWorkspaceOffset(),this.hasUserManuallyZoomed||(this.cameraDistance=this.calculateOptimalCameraDistance(),this.camera.position.z=this.cameraDistance)}setTheme(t){if(!Pn[t])return;this.currentTheme=t;const e=Pn[t];this.ambientLight.color.setHex(e.ambientColor),this.ambientLight.intensity=e.ambientIntensity,this.dirLight1.color.setHex(e.dir1Color),this.dirLight1.intensity=e.dir1Intensity,this.dirLight2.color.setHex(e.dir2Color),this.dirLight2.intensity=e.dir2Intensity,this.buildCylinderStructure()}toggleNeonTrail(t){return this.isNeonTrailEnabled=t!==void 0?t:!this.isNeonTrailEnabled,this.trailGroup.visible=this.isNeonTrailEnabled,this.isNeonTrailEnabled}clearTrails(){for(const t of this.marbleTrails.values())t.mesh&&(this.trailGroup.remove(t.mesh),t.mesh.geometry.dispose(),t.mesh.material.dispose());this.marbleTrails.clear()}updateNeonTrails(){if(!this.isNeonTrailEnabled)return;const t=this.ladder.height;for(const e of this.runner.marbles){if(!e.isActive)continue;const n=e.currentAngle,i=this.ladder.getRadiusAt(e.currentY),s=i*Math.sin(n),a=t/2-e.currentY,o=i*Math.cos(n),l=new U(s,a,o);let c=this.marbleTrails.get(e.id);c||(c={points:[l],mesh:null,color:e.color},this.marbleTrails.set(e.id,c));const h=c.points[c.points.length-1],u=l.distanceTo(h);(u>=.07||e.isFinished&&u>.01)&&(c.points.push(l),this.refreshTrailMesh(c))}}refreshTrailMesh(t){const e=t.points,n=e.length;if(n<2)return;const i=new Float32Array(n*2*3),s=new Uint16Array((n-1)*6),a=.048,o=.035;for(let l=0;l<n;l++){const c=e[l],h=Math.atan2(c.x,c.z),u=Math.sin(h),d=Math.cos(h);let m=0,g=-1,v=0;if(l<n-1){const y=e[l+1];m=y.x-c.x,g=y.y-c.y,v=y.z-c.z}else if(l>0){const y=e[l-1];m=c.x-y.x,g=c.y-y.y,v=c.z-y.z}let p=-d*g,f=d*m-u*v,A=u*g;const E=Math.hypot(p,f,A);E>1e-4?(p/=E,f/=E,A/=E):(p=Math.cos(h),f=0,A=-Math.sin(h));const S=c.x+u*o,R=c.y,b=c.z+d*o,w=l*2,I=l*2+1;i[w*3+0]=S+p*a,i[w*3+1]=R+f*a,i[w*3+2]=b+A*a,i[I*3+0]=S-p*a,i[I*3+1]=R-f*a,i[I*3+2]=b-A*a}for(let l=0;l<n-1;l++){const c=l*2,h=l*2+1,u=(l+1)*2,d=(l+1)*2+1,m=l*6;s[m+0]=c,s[m+1]=h,s[m+2]=u,s[m+3]=h,s[m+4]=d,s[m+5]=u}if(t.mesh){const l=t.mesh.geometry;l.setAttribute("position",new Me(i,3)),l.setIndex(new Me(s,1)),l.attributes.position.needsUpdate=!0,l.index&&(l.index.needsUpdate=!0)}else{const l=new we;l.setAttribute("position",new Me(i,3)),l.setIndex(new Me(s,1));const c=new Bi({color:new kt(t.color),side:Ge,transparent:!0,opacity:.85,depthWrite:!1}),h=new de(l,c);h.renderOrder=5,this.trailGroup.add(h),t.mesh=h}}resetView(){this.hasUserManuallyZoomed=!1,this.cameraDistance=this.calculateOptimalCameraDistance(),this.targetPitch=0,this.isTopView=!1,this.cylinderGroup.rotation.set(0,0,0),this.camera.position.set(0,0,this.cameraDistance),this.clearTrails(),this.selectMarble(null);for(const t of this.marbleMeshes.values())t.resetRotation()}selectMarble(t){var n;this.selectedMarbleId=t;for(const[i,s]of this.marbleMeshes.entries())s.setSelected(i===t);const e=t!==null&&this.runner.marbles.find(i=>i.id===t)||null;(n=this.onMarbleSelect)==null||n.call(this,e)}refreshAllAvatars(){for(const t of this.marbleMeshes.values())t.updateAvatarTexture()}update(t){const e=this.ladder.height,n=this.ladder.radiusBottom;if(this.syncMarbleMeshes(),this.updateNeonTrails(),this.goalSprites.forEach(i=>{const s=new U;i.getWorldPosition(s);const a=Math.max(0,Math.min(1,(s.z/(n+.35)+1)/2));i.material.opacity=.45+.55*a}),this.isDraggingToRotate||(this.cylinderGroup.rotation.x+=(this.targetPitch-this.cylinderGroup.rotation.x)*4*t),this.runner.isRunning&&!this.isDraggingToRotate&&!this.isCameraLocked){const i=this.runner.getFocusedMarble();if(i){let a=-i.currentAngle-this.cylinderGroup.rotation.y;a=Math.atan2(Math.sin(a),Math.cos(a));const o=2.6;this.cylinderGroup.rotation.y+=a*Math.min(1,o*t);const l=this.isTopView?0:(e/2-i.currentY)*.28;this.camera.position.y+=(l-this.camera.position.y)*1.8*t;const c=Math.abs(a);c>.06?this.runner.trackingCatchupFactor=.5:c>.02?this.runner.trackingCatchupFactor=.75:this.runner.trackingCatchupFactor=1}}else this.runner.trackingCatchupFactor=1,this.isDraggingToRotate||(this.camera.position.y+=(0-this.camera.position.y)*2*t,this.camera.position.z+=(this.cameraDistance-this.camera.position.z)*3*t);this.renderer.render(this.scene,this.camera)}syncMarbleMeshes(){const t=this.ladder.height,e=new Set(this.runner.marbles.map(n=>n.id));for(const[n,i]of this.marbleMeshes.entries())e.has(n)||(this.cylinderGroup.remove(i.group),i.destroy(),this.marbleMeshes.delete(n));for(const n of this.runner.marbles){let i=this.marbleMeshes.get(n.id);i||(i=new jp(n),this.cylinderGroup.add(i.group),this.marbleMeshes.set(n.id,i)),i.updateTransform(n,this.ladder.getRadiusAt(n.currentY),t)}}}class tm{constructor(){q(this,"player",null);q(this,"isPlaying",!1);q(this,"isMuted",!1);q(this,"isReady",!1);q(this,"hasUserInteracted",!1);q(this,"videoId","tETK474k3PU");q(this,"volume",38);this.loadYouTubeApi(),this.setupInteractionListeners()}loadYouTubeApi(){var e;if(typeof window>"u")return;if((e=window.YT)!=null&&e.Player){this.createPlayer();return}const t=window.onYouTubeIframeAPIReady;if(window.onYouTubeIframeAPIReady=()=>{t&&t(),this.createPlayer()},!document.querySelector('script[src*="youtube.com/iframe_api"]')){const n=document.createElement("script");n.src="https://www.youtube.com/iframe_api";const i=document.getElementsByTagName("script")[0];i!=null&&i.parentNode?i.parentNode.insertBefore(n,i):document.head.appendChild(n)}}createPlayer(){if(!(!document.querySelector("#youtube-bgm-player")||!window.YT))try{this.player=new window.YT.Player("youtube-bgm-player",{height:"100",width:"100",videoId:this.videoId,playerVars:{autoplay:1,loop:1,playlist:this.videoId,controls:0,disablekb:1,fs:0,playsinline:1,rel:0},events:{onReady:e=>{this.isReady=!0,e.target.setVolume(this.volume),this.hasUserInteracted&&!this.isMuted&&(e.target.playVideo(),this.isPlaying=!0)},onStateChange:e=>{var n;e.data===0&&((n=this.player)==null||n.playVideo()),e.data===1&&(this.isPlaying=!0)}}})}catch(e){console.warn("YouTube BGM Player init error:",e)}}setupInteractionListeners(){const t=()=>{this.hasUserInteracted=!0,this.isReady&&!this.isMuted&&!this.isPlaying&&this.play()};window.addEventListener("click",t,{once:!1}),window.addEventListener("pointerdown",t,{once:!1}),window.addEventListener("touchstart",t,{once:!1})}play(){var t;this.isReady&&((t=this.player)!=null&&t.playVideo)&&(this.player.setVolume(this.volume),this.player.playVideo(),this.isPlaying=!0,this.isMuted=!1)}pause(){var t;this.isReady&&((t=this.player)!=null&&t.pauseVideo)&&(this.player.pauseVideo(),this.isPlaying=!1)}toggleMute(){return this.isMuted=!this.isMuted,this.isMuted?this.pause():this.play(),!this.isMuted}setVolume(t){var e;this.volume=Math.max(0,Math.min(100,t)),this.isReady&&((e=this.player)!=null&&e.setVolume)&&this.player.setVolume(this.volume)}}const em=new tm;class Gi{static serialize(t){const e={v:1,n:t.names,g:t.goals,b:t.bridges.map(a=>[a.fromCol,a.toCol,Math.round(a.fromY*100)/100,Math.round(a.toY*100)/100]),t:t.taperRatio!==void 0?Math.round(t.taperRatio*100)/100:1},n=JSON.stringify(e),i=new TextEncoder().encode(n);let s="";for(let a=0;a<i.byteLength;a++)s+=String.fromCharCode(i[a]);return btoa(s)}static deserialize(t){try{const e=t.trim();if(!e)return null;const n=atob(e),i=new Uint8Array(n.length);for(let l=0;l<n.length;l++)i[l]=n.charCodeAt(l);const s=new TextDecoder().decode(i),a=JSON.parse(s);if(!a||!Array.isArray(a.n)||!Array.isArray(a.b))return null;const o=a.b.map((l,c)=>({id:`bridge_shared_${c}_${Date.now()}`,fromCol:l[0],toCol:l[1],fromY:l[2],toY:l[3],isDiagonal:Math.abs(l[2]-l[3])>.15}));return{names:a.n,goals:Array.isArray(a.g)?a.g:[],bridges:o,taperRatio:typeof a.t=="number"?a.t:1}}catch(e){return console.warn("Failed to deserialize ladder URL hash:",e),null}}static getShareUrl(t){const e=Gi.serialize(t),n=new URL(window.location.href);return n.hash=`ladder=${encodeURIComponent(e)}`,n.toString()}static readFromUrlHash(){const t=window.location.hash;if(!(t!=null&&t.includes("ladder=")))return null;const e=t.match(/ladder=([^&]+)/);if(!(e!=null&&e[1]))return null;const n=decodeURIComponent(e[1]);return Gi.deserialize(n)}}var Sa={};(function r(t,e,n,i){var s=!!(t.Worker&&t.Blob&&t.Promise&&t.OffscreenCanvas&&t.OffscreenCanvasRenderingContext2D&&t.HTMLCanvasElement&&t.HTMLCanvasElement.prototype.transferControlToOffscreen&&t.URL&&t.URL.createObjectURL),a=typeof Path2D=="function"&&typeof DOMMatrix=="function",o=(function(){if(!t.OffscreenCanvas)return!1;try{var L=new OffscreenCanvas(1,1),C=L.getContext("2d");C.fillRect(0,0,1,1);var rt=L.transferToImageBitmap();C.createPattern(rt,"no-repeat")}catch{return!1}return!0})();function l(){}function c(L){var C=e.exports.Promise,rt=C!==void 0?C:t.Promise;return typeof rt=="function"?new rt(L):(L(l,l),null)}var h=(function(L,C){return{transform:function(rt){if(L)return rt;if(C.has(rt))return C.get(rt);var ht=new OffscreenCanvas(rt.width,rt.height),B=ht.getContext("2d");return B.drawImage(rt,0,0),C.set(rt,ht),ht},clear:function(){C.clear()}}})(o,new Map),u=(function(){var L=Math.floor(16.666666666666668),C,rt,ht={},B=0;return typeof requestAnimationFrame=="function"&&typeof cancelAnimationFrame=="function"?(C=function(Y){var it=Math.random();return ht[it]=requestAnimationFrame(function $(ot){B===ot||B+L-1<ot?(B=ot,delete ht[it],Y()):ht[it]=requestAnimationFrame($)}),it},rt=function(Y){ht[Y]&&cancelAnimationFrame(ht[Y])}):(C=function(Y){return setTimeout(Y,L)},rt=function(Y){return clearTimeout(Y)}),{frame:C,cancel:rt}})(),d=(function(){var L,C,rt={};function ht(B){function Y(it,$){B.postMessage({options:it||{},callback:$})}B.init=function($){var ot=$.transferControlToOffscreen();B.postMessage({canvas:ot},[ot])},B.fire=function($,ot,mt){if(C)return Y($,null),C;var St=Math.random().toString(36).slice(2);return C=c(function(Lt){function Ct(Vt){Vt.data.callback===St&&(delete rt[St],B.removeEventListener("message",Ct),C=null,h.clear(),mt(),Lt())}B.addEventListener("message",Ct),Y($,St),rt[St]=Ct.bind(null,{data:{callback:St}})}),C},B.reset=function(){B.postMessage({reset:!0});for(var $ in rt)rt[$](),delete rt[$]}}return function(){if(L)return L;if(!n&&s){var B=["var CONFETTI, SIZE = {}, module = {};","("+r.toString()+")(this, module, true, SIZE);","onmessage = function(msg) {","  if (msg.data.options) {","    CONFETTI(msg.data.options).then(function () {","      if (msg.data.callback) {","        postMessage({ callback: msg.data.callback });","      }","    });","  } else if (msg.data.reset) {","    CONFETTI && CONFETTI.reset();","  } else if (msg.data.resize) {","    SIZE.width = msg.data.resize.width;","    SIZE.height = msg.data.resize.height;","  } else if (msg.data.canvas) {","    SIZE.width = msg.data.canvas.width;","    SIZE.height = msg.data.canvas.height;","    CONFETTI = module.exports.create(msg.data.canvas);","  }","}"].join(`
`);try{L=new Worker(URL.createObjectURL(new Blob([B])))}catch(Y){return typeof console<"u"&&typeof console.warn=="function"&&console.warn("🎊 Could not load worker",Y),null}ht(L)}return L}})(),m={particleCount:50,angle:90,spread:45,startVelocity:45,decay:.9,gravity:1,drift:0,ticks:200,x:.5,y:.5,shapes:["square","circle"],zIndex:100,colors:["#26ccff","#a25afd","#ff5e7e","#88ff5a","#fcff42","#ffa62d","#ff36ff"],disableForReducedMotion:!1,scalar:1};function g(L,C){return C?C(L):L}function v(L){return L!=null}function p(L,C,rt){return g(L&&v(L[C])?L[C]:m[C],rt)}function f(L){return L<0?0:Math.floor(L)}function A(L,C){return Math.floor(Math.random()*(C-L))+L}function E(L){return parseInt(L,16)}function S(L){return L.map(R)}function R(L){var C=String(L).replace(/[^0-9a-f]/gi,"");return C.length<6&&(C=C[0]+C[0]+C[1]+C[1]+C[2]+C[2]),{r:E(C.substring(0,2)),g:E(C.substring(2,4)),b:E(C.substring(4,6))}}function b(L){var C=p(L,"origin",Object);return C.x=p(C,"x",Number),C.y=p(C,"y",Number),C}function w(L){L.width=document.documentElement.clientWidth,L.height=document.documentElement.clientHeight}function I(L){var C=L.getBoundingClientRect();L.width=C.width,L.height=C.height}function y(L){var C=document.createElement("canvas");return C.style.position="fixed",C.style.top="0px",C.style.left="0px",C.style.pointerEvents="none",C.style.zIndex=L,C}function M(L,C,rt,ht,B,Y,it,$,ot){L.save(),L.translate(C,rt),L.rotate(Y),L.scale(ht,B),L.arc(0,0,1,it,$,ot),L.restore()}function D(L){var C=L.angle*(Math.PI/180),rt=L.spread*(Math.PI/180);return{x:L.x,y:L.y,wobble:Math.random()*10,wobbleSpeed:Math.min(.11,Math.random()*.1+.05),velocity:L.startVelocity*.5+Math.random()*L.startVelocity,angle2D:-C+(.5*rt-Math.random()*rt),tiltAngle:(Math.random()*(.75-.25)+.25)*Math.PI,color:L.color,shape:L.shape,tick:0,totalTicks:L.ticks,decay:L.decay,drift:L.drift,random:Math.random()+2,tiltSin:0,tiltCos:0,wobbleX:0,wobbleY:0,gravity:L.gravity*3,ovalScalar:.6,scalar:L.scalar,flat:L.flat}}function k(L,C){C.x+=Math.cos(C.angle2D)*C.velocity+C.drift,C.y+=Math.sin(C.angle2D)*C.velocity+C.gravity,C.velocity*=C.decay,C.flat?(C.wobble=0,C.wobbleX=C.x+10*C.scalar,C.wobbleY=C.y+10*C.scalar,C.tiltSin=0,C.tiltCos=0,C.random=1):(C.wobble+=C.wobbleSpeed,C.wobbleX=C.x+10*C.scalar*Math.cos(C.wobble),C.wobbleY=C.y+10*C.scalar*Math.sin(C.wobble),C.tiltAngle+=.1,C.tiltSin=Math.sin(C.tiltAngle),C.tiltCos=Math.cos(C.tiltAngle),C.random=Math.random()+2);var rt=C.tick++/C.totalTicks,ht=C.x+C.random*C.tiltCos,B=C.y+C.random*C.tiltSin,Y=C.wobbleX+C.random*C.tiltCos,it=C.wobbleY+C.random*C.tiltSin;if(L.fillStyle="rgba("+C.color.r+", "+C.color.g+", "+C.color.b+", "+(1-rt)+")",L.beginPath(),a&&C.shape.type==="path"&&typeof C.shape.path=="string"&&Array.isArray(C.shape.matrix))L.fill(nt(C.shape.path,C.shape.matrix,C.x,C.y,Math.abs(Y-ht)*.1,Math.abs(it-B)*.1,Math.PI/10*C.wobble));else if(C.shape.type==="bitmap"){var $=Math.PI/10*C.wobble,ot=Math.abs(Y-ht)*.1,mt=Math.abs(it-B)*.1,St=C.shape.bitmap.width*C.scalar,Lt=C.shape.bitmap.height*C.scalar,Ct=new DOMMatrix([Math.cos($)*ot,Math.sin($)*ot,-Math.sin($)*mt,Math.cos($)*mt,C.x,C.y]);Ct.multiplySelf(new DOMMatrix(C.shape.matrix));var Vt=L.createPattern(h.transform(C.shape.bitmap),"no-repeat");Vt.setTransform(Ct),L.globalAlpha=1-rt,L.fillStyle=Vt,L.fillRect(C.x-St/2,C.y-Lt/2,St,Lt),L.globalAlpha=1}else if(C.shape==="circle")L.ellipse?L.ellipse(C.x,C.y,Math.abs(Y-ht)*C.ovalScalar,Math.abs(it-B)*C.ovalScalar,Math.PI/10*C.wobble,0,2*Math.PI):M(L,C.x,C.y,Math.abs(Y-ht)*C.ovalScalar,Math.abs(it-B)*C.ovalScalar,Math.PI/10*C.wobble,0,2*Math.PI);else if(C.shape==="star")for(var P=Math.PI/2*3,Qt=4*C.scalar,Dt=8*C.scalar,It=C.x,yt=C.y,Xt=5,Mt=Math.PI/Xt;Xt--;)It=C.x+Math.cos(P)*Dt,yt=C.y+Math.sin(P)*Dt,L.lineTo(It,yt),P+=Mt,It=C.x+Math.cos(P)*Qt,yt=C.y+Math.sin(P)*Qt,L.lineTo(It,yt),P+=Mt;else L.moveTo(Math.floor(C.x),Math.floor(C.y)),L.lineTo(Math.floor(C.wobbleX),Math.floor(B)),L.lineTo(Math.floor(Y),Math.floor(it)),L.lineTo(Math.floor(ht),Math.floor(C.wobbleY));return L.closePath(),L.fill(),C.tick<C.totalTicks}function V(L,C,rt,ht,B){var Y=C.slice(),it=L.getContext("2d"),$,ot,mt=c(function(St){function Lt(){$=ot=null,it.clearRect(0,0,ht.width,ht.height),h.clear(),B(),St()}function Ct(){n&&!(ht.width===i.width&&ht.height===i.height)&&(ht.width=L.width=i.width,ht.height=L.height=i.height),!ht.width&&!ht.height&&(rt(L),ht.width=L.width,ht.height=L.height),it.clearRect(0,0,ht.width,ht.height),Y=Y.filter(function(Vt){return k(it,Vt)}),Y.length?$=u.frame(Ct):Lt()}$=u.frame(Ct),ot=Lt});return{addFettis:function(St){return Y=Y.concat(St),mt},canvas:L,promise:mt,reset:function(){$&&u.cancel($),ot&&ot()}}}function K(L,C){var rt=!L,ht=!!p(C||{},"resize"),B=!1,Y=p(C,"disableForReducedMotion",Boolean),it=s&&!!p(C||{},"useWorker"),$=it?d():null,ot=rt?w:I,mt=L&&$?!!L.__confetti_initialized:!1,St=typeof matchMedia=="function"&&matchMedia("(prefers-reduced-motion)").matches,Lt;function Ct(P,Qt,Dt){for(var It=p(P,"particleCount",f),yt=p(P,"angle",Number),Xt=p(P,"spread",Number),Mt=p(P,"startVelocity",Number),T=p(P,"decay",Number),_=p(P,"gravity",Number),z=p(P,"drift",Number),Q=p(P,"colors",S),et=p(P,"ticks",Number),J=p(P,"shapes"),Et=p(P,"scalar"),ut=!!p(P,"flat"),_t=b(P),Ht=It,st=[],vt=L.width*_t.x,Pt=L.height*_t.y;Ht--;)st.push(D({x:vt,y:Pt,angle:yt,spread:Xt,startVelocity:Mt,color:Q[Ht%Q.length],shape:J[A(0,J.length)],ticks:et,decay:T,gravity:_,drift:z,scalar:Et,flat:ut}));return Lt?Lt.addFettis(st):(Lt=V(L,st,ot,Qt,Dt),Lt.promise)}function Vt(P){var Qt=Y||p(P,"disableForReducedMotion",Boolean),Dt=p(P,"zIndex",Number);if(Qt&&St)return c(function(Mt){Mt()});rt&&Lt?L=Lt.canvas:rt&&!L&&(L=y(Dt),document.body.appendChild(L)),ht&&!mt&&ot(L);var It={width:L.width,height:L.height};$&&!mt&&$.init(L),mt=!0,$&&(L.__confetti_initialized=!0);function yt(){if($){var Mt={getBoundingClientRect:function(){if(!rt)return L.getBoundingClientRect()}};ot(Mt),$.postMessage({resize:{width:Mt.width,height:Mt.height}});return}It.width=It.height=null}function Xt(){Lt=null,ht&&(B=!1,t.removeEventListener("resize",yt)),rt&&L&&(document.body.contains(L)&&document.body.removeChild(L),L=null,mt=!1)}return ht&&!B&&(B=!0,t.addEventListener("resize",yt,!1)),$?$.fire(P,It,Xt):Ct(P,It,Xt)}return Vt.reset=function(){$&&$.reset(),Lt&&Lt.reset()},Vt}var j;function Z(){return j||(j=K(null,{useWorker:!0,resize:!0})),j}function nt(L,C,rt,ht,B,Y,it){var $=new Path2D(L),ot=new Path2D;ot.addPath($,new DOMMatrix(C));var mt=new Path2D;return mt.addPath(ot,new DOMMatrix([Math.cos(it)*B,Math.sin(it)*B,-Math.sin(it)*Y,Math.cos(it)*Y,rt,ht])),mt}function W(L){if(!a)throw new Error("path confetti are not supported in this browser");var C,rt;typeof L=="string"?C=L:(C=L.path,rt=L.matrix);var ht=new Path2D(C),B=document.createElement("canvas"),Y=B.getContext("2d");if(!rt){for(var it=1e3,$=it,ot=it,mt=0,St=0,Lt,Ct,Vt=0;Vt<it;Vt+=2)for(var P=0;P<it;P+=2)Y.isPointInPath(ht,Vt,P,"nonzero")&&($=Math.min($,Vt),ot=Math.min(ot,P),mt=Math.max(mt,Vt),St=Math.max(St,P));Lt=mt-$,Ct=St-ot;var Qt=10,Dt=Math.min(Qt/Lt,Qt/Ct);rt=[Dt,0,0,Dt,-Math.round(Lt/2+$)*Dt,-Math.round(Ct/2+ot)*Dt]}return{type:"path",path:C,matrix:rt}}function ct(L){var C,rt=1,ht="#000000",B='"Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Noto Color Emoji", "EmojiOne Color", "Android Emoji", "Twemoji Mozilla", "system emoji", sans-serif';typeof L=="string"?C=L:(C=L.text,rt="scalar"in L?L.scalar:rt,B="fontFamily"in L?L.fontFamily:B,ht="color"in L?L.color:ht);var Y=10*rt,it=""+Y+"px "+B,$=new OffscreenCanvas(Y,Y),ot=$.getContext("2d");ot.font=it;var mt=ot.measureText(C),St=Math.ceil(mt.actualBoundingBoxRight+mt.actualBoundingBoxLeft),Lt=Math.ceil(mt.actualBoundingBoxAscent+mt.actualBoundingBoxDescent),Ct=2,Vt=mt.actualBoundingBoxLeft+Ct,P=mt.actualBoundingBoxAscent+Ct;St+=Ct+Ct,Lt+=Ct+Ct,$=new OffscreenCanvas(St,Lt),ot=$.getContext("2d"),ot.font=it,ot.fillStyle=ht,ot.fillText(C,Vt,P);var Qt=1/rt;return{type:"bitmap",bitmap:$.transferToImageBitmap(),matrix:[Qt,0,0,Qt,-St*Qt/2,-Lt*Qt/2]}}e.exports=function(){return Z().apply(this,arguments)},e.exports.reset=function(){Z().reset()},e.exports.create=K,e.exports.shapeFromPath=W,e.exports.shapeFromText=ct})((function(){return typeof window<"u"?window:typeof self<"u"?self:this||{}})(),Sa,!1);const ps=Sa.exports;Sa.exports.create;class ms{static shoot(){ps({particleCount:80,spread:70,origin:{y:.65},colors:["#00e5ff","#ff007f","#ffd700","#00ff66","#ffffff"]})}static grandFinale(){const t=Date.now()+1500,e=["#00e5ff","#ff007f","#ffd700","#00ff66","#ff9100"];(function n(){ps({particleCount:5,angle:60,spread:55,origin:{x:0},colors:e}),ps({particleCount:5,angle:120,spread:55,origin:{x:1},colors:e}),Date.now()<t&&requestAnimationFrame(n)})()}}function Ri(r){return r.toString().padStart(2,"0")}class Ar{constructor(t){q(this,"targetCanvas");q(this,"mediaRecorder",null);q(this,"videoStream",null);q(this,"chunks",[]);q(this,"selectedMimeType","video/webm");q(this,"fileExtension","webm");this.targetCanvas=t}get isRecording(){var t;return((t=this.mediaRecorder)==null?void 0:t.state)==="recording"}static isSupported(){return typeof HTMLCanvasElement<"u"&&typeof HTMLCanvasElement.prototype.captureStream=="function"&&typeof MediaRecorder<"u"}async start(){if(this.isRecording)return!0;if(!Ar.isSupported())return!1;try{return this.videoStream=this.targetCanvas.captureStream(60),MediaRecorder.isTypeSupported("video/mp4")?(this.selectedMimeType="video/mp4",this.fileExtension="mp4"):MediaRecorder.isTypeSupported("video/webm;codecs=vp9")?(this.selectedMimeType="video/webm;codecs=vp9",this.fileExtension="webm"):(this.selectedMimeType="video/webm",this.fileExtension="webm"),this.mediaRecorder=new MediaRecorder(this.videoStream,{mimeType:this.selectedMimeType,videoBitsPerSecond:6e6}),new Promise(t=>{if(!this.mediaRecorder)return t(!1);this.chunks=[],this.mediaRecorder.ondataavailable=e=>{e.data&&e.data.size>0&&this.chunks.push(e.data)},this.mediaRecorder.onstop=()=>{if(this.chunks.length===0)return;const e=new Blob(this.chunks,{type:this.selectedMimeType}),n=URL.createObjectURL(e),i=document.createElement("a"),s=new Date,a=`${s.getFullYear()}${Ri(s.getMonth()+1)}${Ri(s.getDate())}_${Ri(s.getHours())}${Ri(s.getMinutes())}${Ri(s.getSeconds())}`;i.href=n,i.download=`ladder_match_${a}.${this.fileExtension}`,document.body.appendChild(i),i.click(),i.remove(),setTimeout(()=>URL.revokeObjectURL(n),1e3)},this.mediaRecorder.onstart=()=>{t(!0)},this.mediaRecorder.start()})}catch(t){return console.warn("Failed to start VideoRecorder:",t),!1}}stop(){this.mediaRecorder&&this.mediaRecorder.state==="recording"&&this.mediaRecorder.stop()}}const Fo={"점심 메뉴":{names:"철수, 영희, 민수, 지우, 수빈, 동현",goals:"짜장면, 김치찌개, 돈까스, 햄버거, 쌀국수, 초밥"},"커피 내기":{names:"팀장, 수석, 책임, 선임, 주임, 인턴",goals:"☕ 커피 당첨!, 통과, 통과, 통과, 통과, 통과"},"벌칙 정하기":{names:"참가자1, 참가자2, 참가자3, 참가자4, 참가자5",goals:"노래 부르기, 물 한잔 원샷, 손목 맞기, 다음 판 간식 쏘기, 애교 부리기"},"숫자 1~6":{names:"A, B, C, D, E, F",goals:"1등, 2등, 3등, 4등, 5등, 6등"},"숫자 1~8":{names:"A, B, C, D, E, F, G, H",goals:"1등, 2등, 3등, 4등, 5등, 6등, 7등, 8등"}};class nm{constructor(t,e,n){q(this,"ladder");q(this,"runner");q(this,"scene");q(this,"inNames");q(this,"inGoals");q(this,"sltPreset");q(this,"btnSavePreset");q(this,"btnDeletePreset");q(this,"sltTheme");q(this,"btnToggleTrail");q(this,"btnToggleRecord");q(this,"btnShareUrl");q(this,"btnStartSimul");q(this,"btnModeToggle");q(this,"btnReset");q(this,"btnRandomize");q(this,"btnClearBridges");q(this,"btnToggleEdit");q(this,"btnSound");q(this,"btnBgm");q(this,"btnToggleView");q(this,"btnQuickTopView");q(this,"btnToggleCamLock");q(this,"btnToggleCamLockSidebar");q(this,"sliderDensity");q(this,"sliderTaper");q(this,"valTaper");q(this,"btnResetTaper");q(this,"resultModal");q(this,"resultList");q(this,"btnCopyResult");q(this,"btnNextRoundExclude");q(this,"btnRestartSame");q(this,"btnCloseModal");q(this,"videoRecorder");q(this,"isAutoRecordEnabled",!1);q(this,"activeResults",[]);this.ladder=t,this.runner=e,this.scene=n,this.scene.onToast=s=>this.showToast(s),this.scene.onMarbleSelect=s=>{if(s){const a=!!sn.getAvatar(s.name);this.showToast(a?`👤 [${s.name}] 선택됨! (Ctrl+V로 사진 변경 / Del로 삭제)`:`👤 [${s.name}] 선택됨! 사진 복사 후 Ctrl+V로 붙여넣으세요.`)}},this.initElements(),this.initPresets(),this.bindEvents(),this.loadFromUrlHashIfExists()||this.applyCurrentNamesAndGoals()}initElements(){this.inNames=document.querySelector("#in_names"),this.inGoals=document.querySelector("#in_goals"),this.sltPreset=document.querySelector("#sltPreset"),this.btnSavePreset=document.querySelector("#btnSavePreset"),this.btnDeletePreset=document.querySelector("#btnDeletePreset"),this.sltTheme=document.querySelector("#sltTheme"),this.btnToggleTrail=document.querySelector("#btnToggleTrail"),this.btnToggleRecord=document.querySelector("#btnToggleRecord"),this.btnShareUrl=document.querySelector("#btnShareUrl"),this.btnStartSimul=document.querySelector("#btnStartSimul"),this.btnModeToggle=document.querySelector("#btnModeToggle"),this.btnQuickTopView=document.querySelector("#btnQuickTopView"),this.btnToggleCamLock=document.querySelector("#btnToggleCamLock"),this.btnReset=document.querySelector("#btnReset"),this.btnRandomize=document.querySelector("#btnRandomize"),this.btnClearBridges=document.querySelector("#btnClearBridges"),this.btnToggleEdit=document.querySelector("#btnToggleEdit"),this.btnSound=document.querySelector("#btnSound"),this.btnBgm=document.querySelector("#btnBgm"),this.btnToggleView=document.querySelector("#btnToggleView"),this.btnToggleCamLockSidebar=document.querySelector("#btnToggleCamLockSidebar"),this.sliderDensity=document.querySelector("#sliderDensity"),this.sliderTaper=document.querySelector("#sliderTaper"),this.valTaper=document.querySelector("#valTaper"),this.btnResetTaper=document.querySelector("#btnResetTaper"),this.resultModal=document.querySelector("#resultModal"),this.resultList=document.querySelector("#resultList"),this.btnCopyResult=document.querySelector("#btnCopyResult"),this.btnNextRoundExclude=document.querySelector("#btnNextRoundExclude"),this.btnRestartSame=document.querySelector("#btnRestartSame"),this.btnCloseModal=document.querySelector("#btnCloseModal"),this.videoRecorder=new Ar(this.scene.canvas)}initPresets(){this.refreshPresetDropdown()}getCustomPresets(){try{const t=localStorage.getItem("cylinder_ladder_custom_presets");return t?JSON.parse(t):{}}catch{return{}}}saveCustomPresets(t){localStorage.setItem("cylinder_ladder_custom_presets",JSON.stringify(t))}refreshPresetDropdown(t){this.sltPreset.innerHTML='<option value="">-- 프리셋 선택 --</option>';const e=document.createElement("optgroup");e.label="기본 프리셋",Object.keys(Fo).forEach(s=>{const a=document.createElement("option");a.value=`builtin:${s}`,a.textContent=s,t===`builtin:${s}`&&(a.selected=!0),e.appendChild(a)}),this.sltPreset.appendChild(e);const n=this.getCustomPresets(),i=Object.keys(n);if(i.length>0){const s=document.createElement("optgroup");s.label="내 프리셋",i.forEach(a=>{const o=document.createElement("option");o.value=`custom:${a}`,o.textContent=a,t===`custom:${a}`&&(o.selected=!0),s.appendChild(o)}),this.sltPreset.appendChild(s)}}bindEvents(){var h,u,d,m,g,v,p,f,A,E,S;this.sltPreset.addEventListener("change",()=>{if(this.runner.isRunning){this.showToast("⚠️ 경기가 진행 중일 때는 프리셋을 변경할 수 없습니다.");return}const R=this.sltPreset.value;if(!R)return;let b=null;R.startsWith("builtin:")?b=Fo[R.replace("builtin:","")]:R.startsWith("custom:")&&(b=this.getCustomPresets()[R.replace("custom:","")]),b&&(this.inNames.value=b.names,this.inGoals.value=b.goals,this.applyCurrentNamesAndGoals(),this.showToast(`📋 '${R.split(":")[1]}' 프리셋 적용!`))}),this.btnSavePreset.addEventListener("click",()=>{const R=this.inNames.value.trim(),b=this.inGoals.value.trim();if(!R){this.showToast("참가자 명단을 먼저 입력하세요.");return}const w=prompt("저장할 프리셋 이름을 입력하세요:");if(!(w!=null&&w.trim()))return;const I=w.trim(),y=this.getCustomPresets();y[I]={names:R,goals:b},this.saveCustomPresets(y),this.refreshPresetDropdown(`custom:${I}`),this.showToast(`💾 '${I}' 프리셋이 저장되었습니다.`)}),this.btnDeletePreset.addEventListener("click",()=>{const R=this.sltPreset.value;if(!R){this.showToast("삭제할 프리셋을 선택하세요.");return}if(R.startsWith("builtin:")){this.showToast("기본 프리셋은 삭제할 수 없습니다.");return}const b=R.replace("custom:","");if(confirm(`'${b}' 프리셋을 삭제하시겠습니까?`)){const w=this.getCustomPresets();delete w[b],this.saveCustomPresets(w),this.refreshPresetDropdown(),this.showToast(`🗑️ '${b}' 프리셋이 삭제되었습니다.`)}});let t=null;const e=()=>{this.runner.isRunning||(clearTimeout(t),t=setTimeout(()=>{this.applyCurrentNamesAndGoals()},250))};this.inNames.addEventListener("input",e),this.inGoals.addEventListener("input",e),this.inNames.addEventListener("change",()=>this.applyCurrentNamesAndGoals()),this.inGoals.addEventListener("change",()=>this.applyCurrentNamesAndGoals()),this.btnStartSimul.addEventListener("click",()=>{this.runner.isRunning||(this.applyCurrentNamesAndGoals(),this.runner.startSimultaneous(),this.showToast("🚀 모든 마블 동시 출발!"))}),this.btnModeToggle.addEventListener("click",()=>{this.runner.mode==="simultaneous"?(this.runner.mode="individual",this.btnModeToggle.textContent="🎯 개별 터치 모드 (활성)",this.btnModeToggle.classList.add("active"),this.showToast("💡 원하는 구슬을 직접 클릭/터치하면 해당 구슬만 출발합니다!")):(this.runner.mode="simultaneous",this.btnModeToggle.textContent="🎯 개별 터치 모드로 전환",this.btnModeToggle.classList.remove("active"),this.showToast("🚀 동시 출발 모드로 전환되었습니다."))}),this.btnReset.addEventListener("click",()=>{this.runner.reset(),this.scene.resetView(),this.showToast("🔄 사다리가 리셋되었습니다.")}),this.btnRandomize.addEventListener("click",()=>{if(this.runner.isRunning){this.showToast("⚠️ 경기가 진행 중일 때는 사다리를 변경할 수 없습니다.");return}const R=parseFloat(this.sliderDensity.value);this.ladder.generateRandomBridges(R),this.scene.rebuildBridges(),Le.playBridgeAdd(),this.showToast("🎲 새로운 랜덤 사다리가 생성되었습니다!")}),(h=this.sliderTaper)==null||h.addEventListener("input",()=>{const R=parseFloat(this.sliderTaper.value);this.ladder.setTaperRatio(R),this.scene.buildCylinderStructure();let b="";Math.abs(R-1)<.02?b="1.00x (기본 원통형)":R<.98?b=`${R.toFixed(2)}x (원뿔형: 아래 좁아짐)`:b=`${R.toFixed(2)}x (역원뿔형: 아래 넓어짐)`,this.valTaper&&(this.valTaper.textContent=b)}),(u=this.btnResetTaper)==null||u.addEventListener("click",()=>{this.sliderTaper.value="1.0",this.ladder.setTaperRatio(1),this.scene.buildCylinderStructure(),this.valTaper&&(this.valTaper.textContent="1.00x (기본 원통형)"),this.showToast("📐 원근 비율이 기본(1.0x 원통형)으로 초기화되었습니다.")}),this.btnClearBridges.addEventListener("click",()=>{confirm("사다리의 모든 가로선을 지우시겠습니까?")&&(this.ladder.clearBridges(),this.scene.rebuildBridges(),Le.playBridgeRemove(),this.showToast("🧹 모든 가로선이 제거되었습니다."))}),this.btnToggleEdit.addEventListener("click",()=>{this.scene.isEditMode=!this.scene.isEditMode,this.btnToggleEdit.classList.toggle("active",this.scene.isEditMode),this.btnToggleEdit.textContent=this.scene.isEditMode?"✏️ 그리기: ON":"✏️ 그리기: OFF",this.showToast(this.scene.isEditMode?"✏️ 기둥 사이를 드래그하여 가로/대각선 다리를 그려보세요!":"👀 뷰 모드: 마우스 드래그로 실린더를 360도 회전할 수 있습니다.")}),this.btnSound.addEventListener("click",()=>{Le.isMuted=!Le.isMuted,this.btnSound.textContent=Le.isMuted?"🔇 효과음 OFF":"🔊 효과음 ON",this.showToast(Le.isMuted?"🔇 효과음 음소거":"🔊 효과음 켜짐")}),(d=this.btnBgm)==null||d.addEventListener("click",()=>{const R=em.toggleMute();this.btnBgm.classList.toggle("active",R),this.btnBgm.textContent=R?"🎵 BGM ON":"🔇 BGM OFF",this.showToast(R?"🎵 사다리타기 BGM 재생 중":"🔇 배경음악 음소거")});const n=()=>{const R=this.scene.toggleTopView();this.btnToggleView&&(this.btnToggleView.textContent=R?"📐 뷰: 탑뷰":"📐 뷰: 정면",this.btnToggleView.classList.toggle("active",R)),this.btnQuickTopView&&(this.btnQuickTopView.textContent=R?"📐 정면뷰 전환":"📐 탑뷰 전환",this.btnQuickTopView.classList.toggle("active",R)),this.showToast(R?"📐 시점: 완전 탑뷰 (위에서 내려다보기)":"📐 시점: 정면 뷰")};(m=this.btnToggleView)==null||m.addEventListener("click",n),(g=this.btnQuickTopView)==null||g.addEventListener("click",n);const i=()=>{const R=this.scene.toggleCameraLock();this.btnToggleCamLock&&(this.btnToggleCamLock.textContent=R?"🔒 카메라 고정됨":"🔒 카메라 고정",this.btnToggleCamLock.classList.toggle("active",R)),this.btnToggleCamLockSidebar&&(this.btnToggleCamLockSidebar.textContent=R?"🔒 카메라 고정: ON":"🔒 카메라 고정: OFF (추적 중)",this.btnToggleCamLockSidebar.classList.toggle("active",R)),this.showToast(R?"🔒 카메라 고정: 경기 진행 중 화면이 자동으로 회전하지 않습니다.":"🎥 카메라 추적: 경기 진행 중 1등 마블을 따라 자동 회전합니다.")};(v=this.btnToggleCamLock)==null||v.addEventListener("click",i),(p=this.btnToggleCamLockSidebar)==null||p.addEventListener("click",i),(f=this.sltTheme)==null||f.addEventListener("change",()=>{const R=this.sltTheme.value;this.scene.setTheme(R);const b=R==="wooden"?"클래식 우든 타워":R==="space"?"스페이스 코스믹":"사이버펑크 네온";this.showToast(`🎨 3D 테마: [${b}] 적용!`)}),(A=this.btnToggleTrail)==null||A.addEventListener("click",()=>{const R=this.scene.toggleNeonTrail();this.btnToggleTrail.classList.toggle("active",R),this.btnToggleTrail.textContent=R?"✨ 네온 트레일: ON":"✨ 네온 트레일: OFF",this.showToast(R?"✨ 네온 궤적 라이트 트레일 활성화":"✨ 네온 궤적 트레일 비활성화")}),(E=this.btnToggleRecord)==null||E.addEventListener("click",()=>{if(!Ar.isSupported()){this.showToast("⚠️ 현재 브라우저에서는 Canvas 녹화 API를 지원하지 않습니다.");return}this.isAutoRecordEnabled=!this.isAutoRecordEnabled,this.btnToggleRecord.classList.toggle("active",this.isAutoRecordEnabled),this.btnToggleRecord.textContent=this.isAutoRecordEnabled?"📹 자동 녹화: ON":"📹 자동 녹화: OFF",this.showToast(this.isAutoRecordEnabled?"📹 자동 녹화 활성: 경기 시작 시 자동 녹화되며 완료 시 파일로 다운로드됩니다.":"📹 자동 녹화 꺼짐")}),(S=this.btnShareUrl)==null||S.addEventListener("click",()=>{var I;const R=this.inNames.value.split(/[,\n]/).map(y=>y.trim()).filter(Boolean),b=this.inGoals.value.split(/[,\n]/).map(y=>y.trim()).filter(Boolean),w=Gi.getShareUrl({names:R,goals:b,bridges:this.ladder.bridges,taperRatio:this.ladder.taperRatio});(I=navigator.clipboard)!=null&&I.writeText?navigator.clipboard.writeText(w).then(()=>{this.showToast("🔗 사다리 링크가 복사되었습니다! 친구에게 공유해보세요.")}).catch(()=>{prompt("아래 사다리 링크를 복사하세요:",w)}):prompt("아래 사다리 링크를 복사하세요:",w)}),this.runner.addEventListener("start",()=>{this.isAutoRecordEnabled&&this.videoRecorder.start()}),this.runner.addEventListener("marbleGoal",R=>{if(this.runner.mode==="individual")return;const b=R.detail.marble;ms.shoot();const w=this.getGoalName(b.finalCol);this.showToast(`🏁 ${b.name} ➔ [${w}] 도착!`)}),this.runner.addEventListener("singleFinish",R=>{var D;const b=(D=R.detail)==null?void 0:D.marble,w=this.runner.marbles.filter(k=>k.isFinished).length,y=this.runner.marbles.length-w,M=this.getGoalName(b==null?void 0:b.finalCol);ms.shoot(),y>0&&this.showToast(`🏁 [${(b==null?void 0:b.name)||"마블"}] ➔ [${M}] 도착! (남은 구슬: ${y}개 - 다음 구슬을 터치하세요)`)}),this.runner.addEventListener("allFinish",()=>{this.isAutoRecordEnabled&&this.videoRecorder.isRecording&&(this.videoRecorder.stop(),this.showToast("🎬 경기 녹화 완료! 영상 파일이 곧 다운로드됩니다.")),ms.grandFinale(),setTimeout(()=>{this.showResultModal()},1e3)}),this.btnCopyResult.addEventListener("click",()=>{if(this.activeResults.length===0)return;const R=["[원통형 3D 사다리 게임 추첨 결과]"];this.activeResults.forEach(w=>{R.push(`${w.name} ➔ ${w.goal}`)});const b=R.join(`
`);navigator.clipboard.writeText(b).then(()=>{this.showToast("📋 결과가 클립보드에 복사되었습니다!")})}),this.btnNextRoundExclude.addEventListener("click",()=>{if(this.activeResults.length<=2){this.showToast("남은 참가자가 2명 이하입니다. 더 이상 제외할 수 없습니다.");return}const R=this.activeResults.find(b=>b.goal.includes("당첨")||b.goal.includes("1등")||b.goal.includes("1위")||b.goal.includes("승리")||b.goal.includes("합격")||b.goal.includes("커피")||b.goal.includes("선물")||b.goal.includes("통과"))||this.activeResults[0];this.excludeParticipant(R.name,R.startCol,R.goal)}),this.btnRestartSame.addEventListener("click",()=>{this.closeResultModal(),this.runner.reset(),this.scene.resetView(),this.showToast("🔄 같은 명단으로 다시 시작합니다.")}),this.btnCloseModal.addEventListener("click",()=>{this.closeResultModal()});const s=document.querySelector("#btnToggleSidebar"),a=document.querySelector("#btnCollapseSidebar"),o=document.querySelector("#sidebar"),l=document.querySelector("#app"),c=()=>{window.innerWidth<=768?o==null||o.classList.toggle("open"):(o==null||o.classList.toggle("collapsed"),l==null||l.classList.toggle("sidebar-collapsed"),this.scene.updateWorkspaceOffset())};s==null||s.addEventListener("click",c),a==null||a.addEventListener("click",c),window.addEventListener("resize",()=>{this.scene.updateWorkspaceOffset()})}applyCurrentNamesAndGoals(t=!1){const e=this.inNames.value.split(/[,\n]/).map(a=>a.trim()).filter(Boolean),n=e.length>0?e:["참가자1","참가자2","참가자3","참가자4"],i=this.inGoals.value.split(/[,\n]/).map(a=>a.trim()).filter(Boolean),s=[];for(let a=0;a<n.length;a++)s.push(i[a]||`골 #${a+1}`);if(this.ladder.setColCount(n.length),!t&&this.ladder.bridges.length===0){const a=parseFloat(this.sliderDensity.value);this.ladder.generateRandomBridges(a)}this.scene.setGoalNames(s),this.scene.buildCylinderStructure(),this.runner.setParticipants(n),this.runner.reset(),this.scene.refreshAllAvatars()}loadFromUrlHashIfExists(){const t=Gi.readFromUrlHash();if(!(t!=null&&t.names)||t.names.length===0)return!1;if(this.inNames.value=t.names.join(", "),this.inGoals.value=t.goals.join(", "),t.taperRatio!==void 0&&(this.ladder.setTaperRatio(t.taperRatio),this.sliderTaper&&(this.sliderTaper.value=t.taperRatio.toString()),this.valTaper)){const e=t.taperRatio;let n="";Math.abs(e-1)<.02?n="1.00x (기본 원통형)":e<.98?n=`${e.toFixed(2)}x (원뿔형: 아래 좁아짐)`:n=`${e.toFixed(2)}x (역원뿔형: 아래 넓어짐)`,this.valTaper.textContent=n}return this.ladder.bridges=t.bridges,this.applyCurrentNamesAndGoals(!0),this.scene.rebuildBridges(),this.showToast("🔗 공유받은 사다리를 성공적으로 불러왔습니다!"),!0}getGoalName(t){var n;return t===void 0?"":this.scene&&((n=this.scene.goalNames)!=null&&n[t])?this.scene.goalNames[t]:this.inGoals.value.split(/[,\n]/).map(i=>i.trim()).filter(Boolean)[t]||`골 #${t+1}`}excludeParticipant(t,e,n){const i=this.inNames.value.split(/[,\n]/).map(l=>l.trim()).filter(Boolean);if(i.length<=2){this.showToast("⚠️ 최소 참가자 수는 2명입니다. 더 이상 제외할 수 없습니다.");return}this.ladder.removeColumn(e);const s=i.filter(l=>l!==t);this.inNames.value=s.join(", ");const a=this.inGoals.value.split(/[,\n]/).map(l=>l.trim()).filter(Boolean);if(n){const l=a.indexOf(n);l>=0?a.splice(l,1):a.length>s.length&&a.pop()}else a.length>s.length&&a.pop();this.inGoals.value=a.join(", ");const o=[];for(let l=0;l<s.length;l++)o.push(a[l]||`골 #${l+1}`);this.scene.setGoalNames(o),this.scene.buildCylinderStructure(),this.runner.setParticipants(s),this.runner.reset(),this.closeResultModal(),this.scene.resetView(),this.showToast(`⏭️ [${t}] ➔ [${n||"당첨"}] 제외 완료! (남은 참가자: ${s.length}명)`)}showResultModal(){this.activeResults=[],this.resultList.innerHTML="";const t=Fi.solveAll(this.ladder),e=new Set;let n=!1;for(const i of t){const s=this.runner.marbles.find(o=>o.startCol===i.startCol),a=s!=null&&s.isFinished&&s.finalCol!==void 0?s.finalCol:i.finalCol;if(e.has(a)){n=!0;break}e.add(a)}t.forEach(i=>{const s=this.runner.marbles.find(u=>u.startCol===i.startCol),a=s?s.name:`참가자 ${i.startCol+1}`,o=!n&&s&&s.isFinished&&s.finalCol!==void 0?s.finalCol:i.finalCol,l=this.getGoalName(o);this.activeResults.push({name:a,goal:l,startCol:i.startCol});const c=document.createElement("div");c.className="result-item",c.innerHTML=`
...
//# sourceMappingURL=index-C0M1-Cc5.js.map
